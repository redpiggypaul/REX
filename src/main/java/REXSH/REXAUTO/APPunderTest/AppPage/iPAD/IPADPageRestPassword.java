 ...
 */
public class IPADPageRestPassword extends IOSPageTemplate {
    ...
    public IPADPageRestPassword(IOSDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public IPADPageRestPassword(IOSDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public IPADPageRestPassword(String theFile, IOSDriver theD, Log theLogger) throws Exception {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            IPADPageRestPassword x = new IPADPageRestPassword("/PageXML/AND/loginPage.xml", driver, null);

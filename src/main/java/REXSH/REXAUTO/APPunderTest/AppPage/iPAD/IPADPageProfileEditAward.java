 ...
 */
public class IPADPageProfileEditAward extends IPADPageTemplate {
    ...
    public IPADPageProfileEditAward(IOSDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public IPADPageProfileEditAward(IOSDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public IPADPageProfileEditAward(String theFile, IOSDriver theD, Log theLogger) throws Exception {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            IPADPageProfileEditAward x = new IPADPageProfileEditAward("/PageXML/AND/loginPage.xml", driver, null);

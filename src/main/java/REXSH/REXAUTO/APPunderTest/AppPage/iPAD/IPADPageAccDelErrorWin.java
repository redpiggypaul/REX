 ...
 */
public class IPADPageAccDelErrorWin extends IOSPageTemplate {
    ...
    private static String logSpace4thisPage = " --- IPADPageAccDelErrorWin --";
    ...
    public IPADPageAccDelErrorWin(IOSDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public IPADPageAccDelErrorWin(IOSDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public IPADPageAccDelErrorWin(String theFile, IOSDriver theD, Log theLogger) throws Exception {
    ...
    public HashMap<String, By> getByMap(IOSDriver driver) {
        ...
        result.clear();
        By tempElement = null;
        System.out.println(logSpace4thisPage + "xxxxxx ------ Check the driver in IPADPageAccDelErrorWin . getByMap(IOSDriver driver)   : " + driver.toString());
    ...
    public HashMap<String, By> getByMap(IOSDriver driver, HashMap<String, ElementMapping> eleMap) {
        ...
        result.clear();
        By tempElement = null;
        System.out.println(logSpace4thisPage + "xxxxxx ------ Check the driver in IPADPageAccDelErrorWin . getByMap (IOSDriver driver, HashMap<String, ElementMapping> eleMap)  : " + driver.toString());
    ...
    public String btnOperationRoute(IOSDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperationRoute in IPADPageAccDelErrorWin has been called ~~~ +++");
    ...
    public String checkAbnormalElement(IOSDriver driver, String eleName) throws REXException {
        System.out.println("    +++ ~~~ The checkAbnormalElement in IPADPageAccDelErrorWin has been called ~~~ +++");
    ...
    public void btnOperation(IOSDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperation in IPADPageAccDelErrorWin has been called ~~~ +++");
    ...
    public void textOperation(IOSDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperationn in IPADPageAccDelErrorWin has been called ~~~ +++");
    ...
    public String getElementContent(IOSDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The getElementContent in IPADPageAccDelErrorWin has been called ~~~ +++");
        String eleType = null;
        String eleText = null;
        String eleStr = null;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            IPADPageAccDelErrorWin x = new IPADPageAccDelErrorWin("/PageXML/AND/loginPage.xml", driver, null);

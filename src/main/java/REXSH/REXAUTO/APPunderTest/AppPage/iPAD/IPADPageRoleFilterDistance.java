 ...
 */
public class IPADPageRoleFilterDistance extends IPADPageTemplate {
    ...
    public IPADPageRoleFilterDistance(IOSDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public IPADPageRoleFilterDistance(IOSDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public IPADPageRoleFilterDistance(String theFile, IOSDriver theD, Log theLogger) throws Exception {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            IPADPageRoleFilterDistance x = new IPADPageRoleFilterDistance("/PageXML/AND/loginPage.xml", driver, null);

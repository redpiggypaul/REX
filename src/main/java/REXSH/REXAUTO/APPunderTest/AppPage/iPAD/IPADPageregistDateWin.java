 ...
 */
public class IPADPageregistDateWin extends IOSPageTemplate {
    ...
    public IPADPageregistDateWin(IOSDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public IPADPageregistDateWin(IOSDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public IPADPageregistDateWin(String theFile, IOSDriver theD, Log theLogger) throws Exception {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            IPADPageregistDateWin x = new IPADPageregistDateWin("/PageXML/AND/bProfileEditPublication.xml", driver, null);

 ...
 */
public class IPADPageProfileEditLanguage extends IPADPageTemplate {
    ...
    public IPADPageProfileEditLanguage(IOSDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public IPADPageProfileEditLanguage(IOSDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public IPADPageProfileEditLanguage(String theFile, IOSDriver theD, Log theLogger) throws Exception {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            IPADPageProfileEditLanguage x = new IPADPageProfileEditLanguage("/PageXML/AND/loginPage.xml", driver, null);

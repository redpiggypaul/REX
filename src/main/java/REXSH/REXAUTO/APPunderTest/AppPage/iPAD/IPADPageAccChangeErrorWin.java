 ...
 */
public class IPADPageAccChangeErrorWin extends IPADPageTemplate {
    ...
    public IPADPageAccChangeErrorWin(IOSDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public IPADPageAccChangeErrorWin(IOSDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public IPADPageAccChangeErrorWin(String theFile, IOSDriver theD, Log theLogger) throws Exception {
    ...
    public String checkAbnormalElement(IOSDriver driver, String eleName) throws REXException {
        System.out.println("    +++ ~~~ The checkAbnormalElement in IOSPageAccChangeErrorWin has been called ~~~ +++");
    ...
    public void textOperation(IOSDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperationn in IOSPageAccChangeErrorWin has been called ~~~ +++");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            IPADPageAccChangeErrorWin x = new IPADPageAccChangeErrorWin("/PageXML/AND/loginPage.xml", driver, null);

 ...
 */
public class IPADPageSearch4Role extends IPADPageTemplate {
    ...
    public IPADPageSearch4Role(IOSDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public IPADPageSearch4Role(IOSDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public IPADPageSearch4Role(String theFile, IOSDriver theD, Log theLogger) throws Exception {
    ...
    */
    ...
    public String boxSearchClickOperation(IOSDriver driver, String eleName) throws Exception {
        String result = null;
        System.out.println("    +++ ~~~ The boxSearchClickOperation in IPADPageSearch4Role has been called ~~~ +++");
        String eleType = null;
        ...
        if (!eleType.equalsIgnoreCase("xpath") || !eleLocStr.contains(":REX")) {
            throw new XMLException("CellItem in IPADPageSearch4Role is incorrect ! ");
        } else {
            Class tempClassType = Class.forName(String.valueOf(new StringBuffer("REXSH.REXAUTO.APPunderTest.AppPage.iPAD.").append("IPADPage").append(subBoxClass)));
            ...
            for (int ind = 1; ind < 6; ind++) {
                ...
                try {
                    ...
                    throw new PageTitleException("Step : " + eleName + " Error, IPADPageSearch4Role , no result found");
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            IPADPageSearch4Role x = new IPADPageSearch4Role("/PageXML/AND/loginPage.xml", driver, null);

 ...
 */
public class IPADPageProfileEditClearWin extends IPADPageTemplate {
    ...
    public IPADPageProfileEditClearWin(IOSDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public IPADPageProfileEditClearWin(IOSDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public IPADPageProfileEditClearWin(String theFile, IOSDriver theD, Log theLogger) throws Exception {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            IPADPageProfileEditClearWin x = new IPADPageProfileEditClearWin("/PageXML/AND/loginPage.xml", driver, null);

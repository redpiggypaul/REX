 ...
 */
public class IPADPageAddTaxiEntry extends IPADPageTemplate {
    protected String fileName = "AddTaxiEntry.json";
    ...
    private String dateWin = "ExpenseDateWin";
    ...
    private static String logSpace4thisPage = " --- IPADPageAddTaxiEntryn --";
    ...
    public IPADPageAddTaxiEntry(IOSDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public IPADPageAddTaxiEntry(IOSDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public IPADPageAddTaxiEntry(String theFile, IOSDriver theD, Log theLogger) throws Exception {
    ...
    public HashMap<String, By> getByMap(IOSDriver driver) {
        ...
        result.clear();
        By tempElement = null;
        System.out.println(logSpace4thisPage + "xxxxxx ------ Check the driver in IPADPageAddTaxiEntryn . getByMap(IOSDriver driver)   : " + driver.toString());
    ...
    public HashMap<String, By> getByMap(IOSDriver driver, HashMap<String, ElementMapping> eleMap) {
        ...
        result.clear();
        By tempElement = null;
        System.out.println(logSpace4thisPage + "xxxxxx ------ Check the driver in IPADPageAddTaxiEntryn . getByMap (IOSDriver driver, HashMap<String, ElementMapping> eleMap)  : " + driver.toString());
    ...
    public String btnOperationRoute(IOSDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperationRoute in IPADPageAddTaxiEntryn has been called ~~~ +++");
    ...
    public void btnOperation(IOSDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperation in IPADPageAddTaxiEntryn has been called ~~~ +++");
    ...
    public String getElementContent(IOSDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The getElementContent in IPADPageAddTaxiEntryn has been called ~~~ +++");
        boolean movecheckdisable = this.content.getFlag4MoveCheck();
        boolean moveable = this.content.getMoveable();
        boolean localMoveable = false;
        String result = null;
        ...
        if(eleName.startsWith("entryAmountCheck"))
        {
            result = finicalCheckDeleteZeroAndSymbol(result);
        }
        return result;
    }

    public String textOperationWithSaveInput(IOSDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperationWithSaveInputn in IPADPageAddTaxiEntryn has been called ~~~ +++");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            IPADPageAddTaxiEntry x = new IPADPageAddTaxiEntry("/PageXML/AND/loginPage.xml", driver, null);

 ...
 */
public class IPADPageRoleFilterTravel extends IPADPageTemplate {
    ...
    public IPADPageRoleFilterTravel(IOSDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public IPADPageRoleFilterTravel(IOSDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public IPADPageRoleFilterTravel(String theFile, IOSDriver theD, Log theLogger) throws Exception {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            IPADPageRoleFilterTravel x = new IPADPageRoleFilterTravel("/PageXML/AND/loginPage.xml", driver, null);

 ...
 */
public class IPADPageRoleFilterRateRange extends IPADPageTemplate {
    ...
    public IPADPageRoleFilterRateRange(IOSDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public IPADPageRoleFilterRateRange(IOSDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public IPADPageRoleFilterRateRange(String theFile, IOSDriver theD, Log theLogger) throws Exception {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            IPADPageRoleFilterRateRange x = new IPADPageRoleFilterRateRange("/PageXML/AND/loginPage.xml", driver, null);

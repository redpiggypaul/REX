 ...
 */
public class IPADPageYourHistory extends IOSPageTemplate {
    ...
    private static String logSpace4thisPage = " --- IPADPageYourHistory --";
    ...
    public IPADPageYourHistory(IOSDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public IPADPageYourHistory(IOSDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public IPADPageYourHistory(String theFile, IOSDriver theD, Log theLogger) throws Exception {
    ...
    */
    public HashMap<String, By> getByMap(IOSDriver driver) {
        ...
        result.clear();
        By tempElement = null;
        System.out.println(logSpace4thisPage + "xxxxxx ------ Check the driver in IPADPageYourHistory . getByMap(IOSDriver driver)   : " + driver.toString());
    ...
    public HashMap<String, By> getByMap(IOSDriver driver, HashMap<String, ElementMapping> eleMap) {
        ...
        result.clear();
        By tempElement = null;
        System.out.println(logSpace4thisPage + "xxxxxx ------ Check the driver in IPADPageYourHistory . getByMap (IOSDriver driver, HashMap<String, ElementMapping> eleMap)  : " + driver.toString());
    ...
    public String textOperationWithSaveInputOLD(IOSDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperationWithSaveInput in IPADPageYourHistory has been called ~~~ +++");
        ...
        try {
            ...
            System.out.println(logSpace4thisPage + "In IPADPageYourHistory . textOperationWithSaveInput , Other Error appear : " + e.getCause());
            e.printStackTrace();
        } finally {
            return result;
        }
    ...
    public void textOperationOLD(IOSDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperation in IPADPageYourHistory has been called ~~~ +++");
    ...
    public void btnOperation(IOSDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperation in IPADPageYourHistory has been called ~~~ +++");
        if (eleName.startsWith("role")) {
    ...
    public String btnOperationRoute(IOSDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperationRoute in IPADPageYourHistory has been called ~~~ +++");
        if (eleName.startsWith("role")) {
    ...
    public String getElementContent(IOSDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The getElementContent in IPADPageYourHistory has been called ~~~ +++");
    ...
    public String sortElementContent(IOSDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The sortElementContent in IPADPageYourHistory has been called ~~~ +++");
        List<String> tempList = new ArrayList<String>();
        if (eleName.startsWith("role")) {
            String result = "";
            ElementMapping tempEleCon = this.eleContentMap.get(eleName);
    ...
    public String checkAbnormalElement(IOSDriver driver, String eleName) throws REXException {
        System.out.println("    +++ ~~~ The checkAbnormalElement in IPADPageYourHistory has been called ~~~ +++");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            IPADPageYourHistory x = new IPADPageYourHistory("/PageXML/AND/loginPage.xml", driver, null);

 ...
 */
public class IPADPageNaviBar extends IOSPageTemplate {
    ...
    public IPADPageNaviBar(IOSDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public IPADPageNaviBar(IOSDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public IPADPageNaviBar(String theFile, IOSDriver theD, Log theLogger) throws Exception {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            IPADPageNaviBar x = new IPADPageNaviBar("/PageXML/AND/loginPage.xml", driver, null);

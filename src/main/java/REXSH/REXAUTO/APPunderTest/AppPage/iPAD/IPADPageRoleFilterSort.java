 ...
 */
public class IPADPageRoleFilterSort extends IPADPageTemplate {
    ...
    public IPADPageRoleFilterSort(IOSDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public IPADPageRoleFilterSort(IOSDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public IPADPageRoleFilterSort(String theFile, IOSDriver theD, Log theLogger) throws Exception {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            IPADPageRoleFilterSort x = new IPADPageRoleFilterSort("/PageXML/AND/loginPage.xml", driver, null);

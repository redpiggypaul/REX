 ...
 */
public class IPADPageRoleMail extends IOSPageTemplate {
    ...
    public IPADPageRoleMail(IOSDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public IPADPageRoleMail(IOSDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public IPADPageRoleMail(String theFile, IOSDriver theD, Log theLogger) throws Exception {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            IPADPageRoleMail x = new IPADPageRoleMail("/PageXML/AND/loginPage.xml", driver, null);

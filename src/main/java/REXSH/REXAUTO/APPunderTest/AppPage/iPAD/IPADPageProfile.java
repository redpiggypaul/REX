 ...
 */
public class IPADPageProfile extends IPADPageTemplate {
    ...
    public IPADPageProfile(IOSDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public IPADPageProfile(IOSDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public IPADPageProfile(String theFile, IOSDriver theD, Log theLogger) throws Exception {

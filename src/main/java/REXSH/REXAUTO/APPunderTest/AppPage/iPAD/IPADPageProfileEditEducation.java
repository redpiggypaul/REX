 ...
 */
public class IPADPageProfileEditEducation extends IPADPageTemplate {
    ...
    public IPADPageProfileEditEducation(IOSDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public IPADPageProfileEditEducation(IOSDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public IPADPageProfileEditEducation(String theFile, IOSDriver theD, Log theLogger) throws Exception {
    ...
    public String calendarOperation(IOSDriver driver, String eleName) throws Exception {
        String result = null;
        System.out.println("    +++ ~~~ The calendarOperation in IPADPageProfileEditEducation has been called ~~~ +++");
        try {
    ...
    public String calendarOperationDate(IOSDriver driver, String eleName, String tDate) throws Exception {
        String result = null;
        System.out.println("    +++ ~~~ The calendarOperationDate in IPADPageProfileEditEducation has been called ~~~ +++");
        try {
    ...
    public String autoCompleteOperation(IOSDriver driver, String eleName, String extPara) throws Exception {  //TODO
        String result = null;
        System.out.println("    +++ ~~~ The autoCompleteOperation in IPADPageProfileEditEducation has been called ~~~ +++");
        System.out.println(" this time we want to choose the " + extPara + " item ");
        try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            IPADPageProfileEditEducation x = new IPADPageProfileEditEducation("/PageXML/AND/loginPage.xml", driver, null);

 ...
 */
public class IPADPageProfileWorkErrorWin extends IPADPageTemplate {
    ...
    public IPADPageProfileWorkErrorWin(IOSDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public IPADPageProfileWorkErrorWin(IOSDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public IPADPageProfileWorkErrorWin(String theFile, IOSDriver theD, Log theLogger) throws Exception {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            IPADPageProfileWorkErrorWin x = new IPADPageProfileWorkErrorWin("/PageXML/AND/bProfileEditPublication.xml", driver, null);

 ...
 */
public class IPADPageRoleFilter extends IPADPageTemplate {
    ...
    public IPADPageRoleFilter(IOSDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public IPADPageRoleFilter(IOSDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public IPADPageRoleFilter(String theFile, IOSDriver theD, Log theLogger) throws Exception {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            IPADPageRoleFilter x = new IPADPageRoleFilter("/PageXML/AND/bPageProfileEdit.xml", driver, null);

 ...
 */
public class IPADPageProfileMilServiceBranchWin extends IPADPageTemplate {
    ...
    public IPADPageProfileMilServiceBranchWin(IOSDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public IPADPageProfileMilServiceBranchWin(IOSDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public IPADPageProfileMilServiceBranchWin(String theFile, IOSDriver theD, Log theLogger) throws Exception {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            IPADPageProfileMilServiceBranchWin x = new IPADPageProfileMilServiceBranchWin("/PageXML/AND/bProfileEditPublication.xml", driver, null);

...
import REXSH.REXAUTO.Component.PageLoadWait.IOSDriverWaitNOScreen;
...
public abstract class IPADPageTemplate {
    ...
    private static String logSpace4thisPage = " --- IPADPageTemplate --";

    public IPADPageTemplate(IOSDriver theD) throws Exception {
    }

    public IPADPageTemplate(String theFile, IOSDriver theD, Log theLogger) throws Exception {
    }
    ...
    public void moveUPs300(IOSDriver dr) throws Exception {   // fit the page which don't split
        int wide = Integer.parseInt(readProperity.getProValue("IOSscreenWide"));
        int length = Integer.parseInt(readProperity.getProValue("IOSscreenLength"));
        int timeDuration = Integer.parseInt(readProperity.getProValue("screenMoveTimeDuration"));
        try {
    ...
    public void moveUPsPAD(IOSDriver dr) throws Exception {   // fit the page which don't split
        int wide = Integer.parseInt(readProperity.getProValue("IOSscreenWide"));
        int length = Integer.parseInt(readProperity.getProValue("IOSscreenLength"));
        int timeDuration = Integer.parseInt(readProperity.getProValue("screenMoveTimeDuration"));
        try {
    ...
    public void moveUPsPAD(IOSDriver dr, int theY, int theL) throws Exception {   // fit the page which don't split
        int wide = Integer.parseInt(readProperity.getProValue("IOSscreenWide"));
        int length = Integer.parseInt(readProperity.getProValue("IOSscreenLength"));
        int timeDuration = Integer.parseInt(readProperity.getProValue("screenMoveTimeDuration"));
        try {
            ...
            int end_x = wide / 2;
            int start_y = length / 2;
            if (start_y >= theY && start_y <= theY + theL) {
                if (theY <= length / 2) {
                    start_y = theY + theL + 150;
                } else {
                    start_y = theY - 50;
                }
            } else {
    ...
    public boolean loadingCheck(IOSDriver driver, String eleName, HashMap<String, By> extByMap) {
        boolean result = false;
        String loadingInd = null;
        try {
            loadingInd = getContentInBtnFast(driver, eleName, extByMap);
            if (loadingInd.equals("ready")) {
                return true;
            } else if (loadingInd.equals("loading_outer")) {
                return false;
            } else {
                return true;
            }
    ...
    public String getContentInBtnFast(IOSDriver driver, String eleName, HashMap<String, By> extByMap) throws Exception {
        ...
        final By temp = extByMap.get(eleName);
        try {
            if (temp != null) {
                ...
                theResult = xWait.until(
                        new IOSExpectedCondition<WebElement>() {
                            public WebElement apply(IOSDriver driver) {
                                WebElement theX = driver.findElement(temp);
                                //  return theX.getText();
                                return theX;
                            }
                        });
...
/*
    public void textOperation(IOSDriver driver, String eleName, String para1) throws Exception {
        try {
            ...
            System.out.println(logSpace4thisPage + "In IPADPageTemplate . textOperation 3, Other Error appear : " + e.getCause());
            e.printStackTrace();
        }
    ...
    */
    ...
    public void textOperationWithoutClick(IOSDriver driver, String eleName, String para1, HashMap<String, By> inMap, HashMap<String, String> dValueMap) throws Exception {
        String dValue = null;
        IOSElement theResult = null;
        final String localPath = this.path4Log;
        try {
    ...
    public String textOperationStaticLogin(IOSDriver driver, String eleName, String para, HashMap<String, By> inMap, HashMap<String, String> textMap, String extPath) throws Exception {
        ...
        try {
            System.out.println("    +++ ~~~ In the IPADPageTemplate :: textOperationStaticLogin in " + this.getClass().getSimpleName() + " has been called ~~~ +++");
            ...
            System.out.println(logSpace4thisPage + "In IPADPageTemplate . textOperationStaticLogin, Other Error appear : " + e.getCause());
            throw e;
        }
    ...
    public boolean loadingCheckNew(IOSDriver driver, HashMap<String, ElementMapping> extByMap) throws Exception {
        ...
        try {
            ...
            if (localFlag == null) {
                localFlag = new String(readProperity.getProValue("ipad_loading_name"));
                String eType = new String(readProperity.getProValue("ipad_loading_type"));
                String eStr = new String(readProperity.getProValue("ipad_loading_str"));
                String eContent = new String(readProperity.getProValue("ipad_loading_content"));
                String eDvalue = new String(readProperity.getProValue("ipad_loading_dvalue"));
    ...
    public boolean checkElementPresent(IOSDriver driver, String eleName, String eType, String eStr, String eContent, String eDvalue) throws Exception {
        ...
        try {
            ...
            if (tempEle == null) {
                return false;
            } else if (tempEle.getText().equalsIgnoreCase(eContent)) {
                return true;
            } else {
                return false;
            }
    ...
    public boolean checkElementPresent(IOSDriver driver, String eleName, HashMap<String, ElementMapping> eleMap) throws Exception {
        ...
        try {
            ...
            if (tempEle == null) {
                return false;
            } else if (tempEle.getText().equalsIgnoreCase(getElementXMLContent(eleName, eleMap))) {
                return true;
            } else {
                return false;
            }
    ...
    public WebElement getElementFast(IOSDriver driver, String eleName, HashMap<String, ElementMapping> eleMap) throws Exception {
        ...
        try {
            ...
            String theContent = getElementXMLContent(eleName, eleMap);
            IOSDriverWait xWait = new IOSDriverWait(driver, 1, this.path4Log, false);
            theResult = xWait.until(
                    new IOSExpectedCondition<WebElement>() {
                        public WebElement apply(IOSDriver driver) {
    ...
    public String textOperationWithSaveInput(IOSDriver driver, String eleName, String para1, HashMap<String, By> inMap) throws Exception {
        ...
        try {
            ...
            System.out.println(logSpace4thisPage + "In IPADPageTemplate . textOperation 4, Other Error appear : " + e.getCause());
            throw e;
        } finally {
            return result;
        }
    ...
    public String textOperationListWithSaveInput(IOSDriver driver, String eleName, String para1, HashMap<String, By> inMap, String dValuePara) throws Exception {
        ...
        try {
            ...
            System.out.println(logSpace4thisPage + "In IPADPageTemplate . textOperationListWithSaveInput, Other Error appear : " + e.getCause());
            throw e;
        } finally {
            return result;
        }
    ...
    public String getElementContent(IOSDriver driver, String
        ...
        Thread.sleep(1000);
        try {
            System.out.println("    +++ ~~~ In the IPADPageTemplate :: getElementContent ~~~ +++");
            for (Iterator it = inMap.entrySet().iterator(); it.hasNext() && theResult == null; ) {
                final Map.Entry tempContentEntry = (Map.Entry) it.next();
                if (tempContentEntry.getKey().toString().equalsIgnoreCase(eleName)) {
                    IOSDriverWait xWait = new IOSDriverWait(driver, timeOutInSeconds, localPath);
            ...
            System.out.println(logSpace4thisPage + "In IPADPageTemplate :: getElementContent , Other Error appear : " + e.getCause());
            e.printStackTrace();
        }
        if (result == null || result.equals("")) {
            return "emptyContent";
    ...
    public String getElementContent(IOSDriver driver, String
        ...
        int index4item = 1;
        try {
            System.out.println("    +++ ~~~ In the IPADPageTemplate :: getElementContent in " + this.getClass().getSimpleName() + " has been called ~~~ +++");
    ...
    public WebElement findFilteEleListWithSearchHome(IOSDriver driver, final By theKey, int timeValue, String path, String tText) throws Exception {
        ...
        for (; flag4end == false; ) {
            ...
            if (resultlist.size() == 1) {
                WebElement theSingleEle = resultlist.get(0);
                Point tempPero = theSingleEle.getLocation();
                int tPreoX = tempPero.getX();
                int tPreoY = tempPero.getY();
                if ((tPreoY >= theBtY) || tempPero == null || (tPreoY == 0 && tPreoX == 0)) {

                    if (Math.abs(lastY - tPreoY) < 10) {
                        if (theSingleEle.getText().equals(tText)) {
                            theEle = theSingleEle;
                            flag4end = true;
                            break;
                ...
                if ((currentEleNum != 0 && lastEleNum == 0) || (lastEleNum != 0 && currentEleNum != 0)) {
                    ...
                    for (int ind = index4lastEle; ind < resultlist.size(); ind++) {
                        Point tempP = resultlist.get(ind).getLocation();
                        int tempX = tempP.getX();
                        int tempY = tempP.getY();
                        System.out.println("ind " + ind + " : " + resultlist.get(ind).getText());
                        if ((tempY >= theBtY) || tempP == null || (tempY == 0 && tempX == 0)) {
                            if (tempY == 0 && tempX == 0) {
                                if (flag4zero == 0) {
                                    if (ind > 0) {
                                        index4lastEle = ind - 1;
                            ...
                            if (lastY != 0 && Math.abs(tempY - lastY) < 10) {
                                flag4end = true;
                                break;
                            } else if ((flag4zero >= 2) || (tempY >= theBtY)) {
                                lastY = tempY;
                                moveUPsHome(driver);
                                if (index4lastEle != 0) {
                                    ind = index4lastEle;
    ...
    public List<String> getElementContentListMoveDyncIndex(IOSDriver driver, String eleName, String extByStr, String p4L) throws Exception {
        ...
        Thread.sleep(1000);
        try {
            System.out.println("    +++ ~~~ In the IPADPageTemplate :: getElementContentListMoveDyncIndex ~~~ +++");
            boolean flag4end = false;
            int account4empty = 0;
            int account4dup = 0;
            //     ArrayList<String> indexList = getNumList(extByStr);
            //     if (Integer.valueOf(indexList.get(indexList.size() - 1)) >= 4) {
            //        falg4dec = true;
            //    }

            for (int ind = 1; flag4end == false && result.size() < 4; ind++) {
                IOSDriverWait xWait = new IOSDriverWait(driver, timeOutInSeconds, localPath);
               /* final By byStrForEnd = By.xpath((extByStr.substring(0, extByStr.lastIndexOf("[") + 1) + "10" + extByStr.substring(extByStr.lastIndexOf("]"), extByStr.length())).replaceFirst(":REXindex:", String.valueOf(ind)));
                IOSDriverWait xWait = new IOSDriverWait(driver, timeOutInSeconds, localPath);
                try {
                    theendResult =
                            xWait.until(
                                    new IOSExpectedCondition<WebElement>() {
                                        public WebElement apply(IOSDriver driver) {
                                            return driver.findElement(byStrForEnd);
                                        }
                                    });
                } catch (Exception e) {
                    falg4complete = true;
                }
                if (theendResult == null) {
                    falg4complete = true;
                }
                if (falg4complete == true && falg4dec == true) {
                    String tempByStr = extByStr.substring(0, extByStr.lastIndexOf("[") + 1) + (Integer.valueOf(indexList.get(indexList.size() - 1))-1) + extByStr.substring(extByStr.lastIndexOf("]"), extByStr.length());
                    theStrInThisRound = By.xpath(tempByStr.replaceFirst(":REXindex:", String.valueOf(ind)));
                } else {
            ...
            System.out.println(logSpace4thisPage + "In IPADPageTemplate :: getElementContentListMoveDyncIndex , Other Error appear : " + e.getCause());
            e.printStackTrace();
        }
    ...
    public List<String> getElementContentListMove(IOSDriver driver, String
        ...
        Thread.sleep(1000);
        try {
            System.out.println("    +++ ~~~ In the IPADPageTemplate :: getElementContentListMove ~~~ +++");
            boolean flag4end = false;
            int account4empty = 0;
            int account4dup = 0;
            for (Iterator it = inMap.entrySet().iterator(); it.hasNext() && theResult == null; ) {
            ...
            System.out.println(logSpace4thisPage + "In IPADPageTemplate :: getElementContentListMove , Other Error appear : " + e.getCause());
            e.printStackTrace();
        }
        if (result == null || result.size() == 0) {
            return new ArrayList<String>();
...
*/
        ...
        for (; flag4end == false; ) {
            ...
            if (currentEleNum != 0) {
                ...
                for (int ind = index4lastEle; ind < resultlist.size(); ind++) {
                    ...
                    int tempY = tempP.getY();
                    int tempX = tempP.getX();
                    System.out.println("index " + ind + " : " + tempText + " : " + tempX + " : " + tempY);
                    if (resultlist.get(ind).getText().equalsIgnoreCase(tText)) {
                        if (tempY != 0 && tempY <= theBtY && tempX != 0) {
                            theEle = resultlist.get(ind);
                            flag4end = true;
                            id4classname = ind;
                            //   theEle.click();
                        ...
                        if (tempY != lastEleY) {
                            if ((tempY > theBtY) || tempY == 0 || tempX == 0) {
                                if (flag4rightScreen == true) {
                                    flag4zero++;
                                } else {
                                    flag4zero = 0;
                        ...
                        if (tempX != 0) {
                            ...
                            if ((flag4zero > 2) || (tempY >= theBtY && tempX != 0)) {
                                if (ind > 0) {
                                    index4lastEle = ind;
                                } else {
                                    index4lastEle = 0;
               ...
               /*
                for (int ind = index4lastEle; ind < resultlist.size(); ind++) {
                    ...
                    if (resultlist.get(ind).getText().equalsIgnoreCase(tText)) {
                        ...
                        if (tempY >= theBtY && tempP.getX() == 0) {
                            continue;
                        } else if ((tempY >= theBtY) || tempY == 0 && tempP.getX() == 0) {
                            if (resultlist.get(ind).getText().equals(tText)) {
                                flag4unlucky = true;
                            }
                            if (!tempText.toLowerCase().contains("add icon") && (tempY == 0 && tempP.getX() == 0) || (tempP.getX() == 0 && tempText.equals(""))) {
    ...
    //  (driver, titleStr, btnStr, Integer.parseInt(String.valueOf(timeOutInSeconds * 1000)), localPath, titleContent);
    ...
    public void btnOperation(IOSDriver driver, String eleName) throws Exception {
        ...
        WebElement theResult = null;
        try {
            System.out.println("    +++ ~~~ In the IPADPageTemplate ~~~ +++");
            ...
            System.out.println(logSpace4thisPage + "In IPADPageTemplate . btnOperation, Other Error appear : " + e.getCause());
            throw e;
        }
    }
    ...
    public void btnOperation(IOSDriver driver, String eleName, HashMap<String, By> inMap) throws Exception {
        ...
        try {
            ...
            System.out.println(logSpace4thisPage + "In IPADPageTemplate . btnOperation 2, Other Error appear : " + e.getCause());
            throw e;
        }
    }
*/
    ...
    public void testOperation(IOSDriver driver, String theIN) throws REXException {
        WebElement theResult = null;
        try {
            System.out.println("    +++ ~~~ In the IPADPageTemplate ~~~ +++");
        ...
        {
            System.out.println(logSpace4thisPage + "In IPADPageTemplate . testOperation, Other Error appear : " + e.getCause());
            e.printStackTrace();
        }
    }
    ...
    public Object createInstance(Class cType, IOSDriver theD) throws Exception {
        ...
        for (int index = 0; index < consts.length; index++) {
            ...
            //System.out.println("The AndDr class type is : " + ((Class) IOSDriver.class).getSimpleName().toString());
            if (paramsLength == 2) {
...
/*
    public String btnOperation(IOSDriver driver, String eleName, HashMap<String, By> inMap, HashMap<String, ElementMapping> eleMap) throws REXException {
        String result = null;
        try {
            System.out.println("    +++ ~~~ In the IPADPageTemplate :: btnOperation 4 Route in " + this.getClass().getSimpleName() + " has been called ~~~ +++");
            ...
            System.out.println(logSpace4thisPage + "In IPADPageTemplate . btnOperation 4 Route 2, Other Error appear : " + e.getCause());
            e.printStackTrace();
        }
        if (result == null || result.equals("")) {
            return "noRoute";
...
*/
    ...
    public String btnOperation(IOSDriver driver, String eleName, HashMap<String, By> inMap, HashMap<String, ElementMapping> eleMap) throws Exception {
        ...
        final String localPath = this.path4Log;
        try {
            System.out.println("    +++ ~~~ In the IPADPageTemplate :: btnOperation in " + this.getClass().getSimpleName() + " has been called ~~~ +++");
            for (Iterator it = inMap.entrySet().iterator(); it.hasNext() && theResult == null; ) {
                final Map.Entry tempContentEntry = (Map.Entry) it.next();
                if (tempContentEntry.getKey().toString().equalsIgnoreCase(eleName)) {
                    System.out.println(eleName + " :?:" + tempContentEntry.getKey().toString());
        ...
        try {
            ...
            for (Iterator it = inMap.entrySet().iterator(); it.hasNext() && theResult == null; ) {
                ...
                if (tempContentEntry.getKey().toString().equalsIgnoreCase(eleName)) {
                    ...
                    System.out.println("    +++ ~~~ Check the route result : ~~~ +++" + result);
                    System.out.println("For IOS , get the text before click : " + theResult.getText());
                    if (theResult.getText().equals("") || textMap.get(eleName).toString().equalsIgnoreCase(theResult.getText())) {
                        theResult.click();
                        ...
                        System.out.println("Warning, the text content is incorrect!");
                    }
                    if (!result.equals("noRoute") && (result != "") && (result != null)) {
                        Date date = new Date();
                        DateFormat format = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    ...
    public String btnOperationSmart(IOSDriver driver, String eleName, HashMap<String, By> inMap, HashMap<String, ElementMapping> eleMap, HashMap<String, String> textMap, final String tText, String extPath) throws Exception {
        ...
        final String localPath = extPath;
        try {
            System.out.println("    +++ ~~~ In the IPADPageTemplate :: btnOperationSmart in " + this.getClass().getSimpleName() + " has been called ~~~ +++");
            ...
            System.out.println(logSpace4thisPage + "In IPADPageTemplate . btnOperationSmart , Other Error appear : " + e.getCause());
            throw e;
        }
        if (result == null || result.equals("")) {
            return "noRoute";
    ...
    public String btnOperationSmartHome(IOSDriver driver, String eleName, HashMap<String, By> inMap, HashMap<String, ElementMapping> eleMap, HashMap<String, String> textMap, final String tText, String extPath) throws Exception {
        ...
        final String localPath = extPath;
        try {
            System.out.println("    +++ ~~~ In the IPADPageTemplate :: btnOperationSmartHome in " + this.getClass().getSimpleName() + " has been called ~~~ +++");
            ...
            System.out.println(logSpace4thisPage + "In IPADPageTemplate . btnOperationSmartHome , Other Error appear : " + e.getCause());
            throw e;
        }
        if (result == null || result.equals("")) {
            return "noRoute";
    ...
    public String btnOperationIsolateSmart(IOSDriver driver, String eleName, HashMap<String, By> inMap, HashMap<String, ElementMapping> eleMap, HashMap<String, String> textMap, final String tText, String extPath) throws Exception {
        ...
        final String localPath = extPath;
        try {
            System.out.println("    +++ ~~~ In the IPADPageTemplate :: btnOperationIsolateSmart in " + this.getClass().getSimpleName() + " has been called ~~~ +++");
            final By tempEleBy = inMap.get(eleName);
            if (tempEleBy != null) {
                IOSDriverWait xWait = new IOSDriverWait(driver, timeOutInSeconds, localPath);
                theResult = xWait.until(new IOSExpectedCondition<IOSElement>() {
            ...
            System.out.println(logSpace4thisPage + "In IPADPageTemplate . btnOperationIsolateSmart , Other Error appear : " + e.getCause());
            throw e;
        }
        if (result == null || result.equals("")) {
            return "noRoute";
    ...
    public int btnId4ClassNameIsolate(IOSDriver driver, String eleName, String eleType, String eleStr, HashMap<String, By> inMap, HashMap<String, ElementMapping> eleMap,
        ...
        final String localPath = this.path4Log;
        try {
            System.out.println("    +++ ~~~ In the IPADPageTemplate :: btnId4ClassNameIsolate in " + this.getClass().getSimpleName() + " has been called ~~~ +++");
            ...
            System.out.println(logSpace4thisPage + "In IPADPageTemplate . btnId4ClassNameIsolate, Other Error appear : " + e.getCause());
            throw e;
        }
        return resIndex;
    }
    ...
    public String btn4ClassNameCombind(IOSDriver driver, String eleName, String eleType, String eleStr, HashMap<String, By> inMap, HashMap<String, ElementMapping> eleMap,
        ...
        final String localPath = this.path4Log;
        try {
            System.out.println("    +++ ~~~ In the IPADPageTemplate :: btn4ClassNameCombind in " + this.getClass().getSimpleName() + " has been called ~~~ +++");
            if (eleType.equals("classname")) {
                System.out.println(eleName + " :~~~:" + eleType + " :~~~:" + eleStr);
                By temp = By.className(eleStr);
            ...
            System.out.println(logSpace4thisPage + "In IPADPageTemplate . btn4ClassNameCombind, Other Error appear : " + e.getCause());
            throw e;
        }
        if (resIndex != 0) {
            result = checkTheNextPage(eleName, eleMap);
    ...
    //   (driver, eleName, this.byMap, this.eleContentMap, this.content.eleTextContentMap);
    ...
    public String record4XPATHCombind(IOSDriver driver, String eleName, HashMap<String, By> inMap, HashMap<String, ElementMapping> eleMap,
                                      HashMap<String, String> textMap, int startIndex) throws Exception {
        String result = null;
        int resIndex = 0;
        WebElement theResult = null;
        final String localPath = this.path4Log;
        try {
            System.out.println("    +++ ~~~ In the IPADPageTemplate :: record4XPATHCombind in " + this.getClass().getSimpleName() + " has been called ~~~ +++");
            String titleStr = eleMap.get(eleName).getLocatorStr();
            String titleContent = eleMap.get(eleName).getTextContent();
            String btnStr = eleMap.get(eleName + "_record").getLocatorStr();
            theResult = findsameID4XPATH(driver, titleStr, btnStr, Integer.parseInt(String.valueOf(timeOutInSeconds * 1000)), localPath, titleContent, startIndex);
        } catch (Exception e) {
            System.out.println(logSpace4thisPage + "In IPADPageTemplate . record4XPATHCombind, Other Error appear : " + e.getCause());
            throw e;
        }
        if (theResult != null) {
            result = checkTheNextPage(eleName + "_record", eleMap);
            theResult.click();
        }
        if (result == null || result.equals("")) {
            return "noRoute";
    ...
    public String btnOperationStatic(IOSDriver driver, String eleName, HashMap<String, By> inMap, HashMap<String, ElementMapping> eleMap, HashMap<String, String> textMap, String extPath) throws Exception {
        ...
        final String localPath = extPath;
        try {
            System.out.println("    +++ ~~~ In the IPADPageTemplate :: btnOperationStatic in " + this.getClass().getSimpleName() + " has been called ~~~ +++");
            final By tempEleBy = inMap.get(eleName);
            if (tempEleBy != null) {
            ...
            System.out.println(logSpace4thisPage + "In IPADPageTemplate . btnOperationStatic, Other Error appear : " + e.getCause());
            throw e;
        }
        if (result == null || result.equals("")) {
            return "noRoute";
    ...
    public String btnOperationHome(IOSDriver driver, String eleName, HashMap<String, By> inMap, HashMap<String, ElementMapping> eleMap, HashMap<String, String> textMap, String extPath) throws Exception {
        ...
        final String localPath = extPath;
        try {
            System.out.println("    +++ ~~~ In the IPADPageTemplate :: btnOperationHome in " + this.getClass().getSimpleName() + " has been called ~~~ +++");
            final By tempEleBy = inMap.get(eleName);
            if (tempEleBy != null) {
            ...
            System.out.println(logSpace4thisPage + "In IPADPageTemplate . btnOperationHome, Other Error appear : " + e.getCause());
            throw e;
        }
        if (result == null || result.equals("")) {
            return "noRoute";
    ...
    public boolean confirmOperationStatic(IOSDriver driver, String eleName, HashMap<String, By> inMap, HashMap<String, ElementMapping> eleMap, HashMap<String, String> textMap, String extPath) throws Exception {
        ...
        final String localPath = extPath;
        try {
            System.out.println("    +++ ~~~ In the IPADPageTemplate :: confirmOperationStatic in " + this.getClass().getSimpleName() + " has been called ~~~ +++");
            for (Iterator it = inMap.entrySet().iterator(); it.hasNext() && theResult == null; ) {
                final Map.Entry tempContentEntry = (Map.Entry) it.next();
                if (tempContentEntry.getKey().toString().equalsIgnoreCase(eleName)) {
                    System.out.println(eleName + " :?:" + tempContentEntry.getKey().toString());
    ...
    public boolean titleCheck(IOSDriver driver, String eleName, HashMap<String, By> inMap, HashMap<String, ElementMapping> eleMap, HashMap<String, String> textMap, String extPath) throws Exception {
        ...
        final String localPath = extPath;
        try {
            System.out.println("    +++ ~~~ In the IPADPageTemplate :: titleCheck in " + this.getClass().getSimpleName() + " has been called ~~~ +++");
            for (Iterator it = inMap.entrySet().iterator(); it.hasNext() && theResult == null; ) {
                final Map.Entry tempContentEntry = (Map.Entry) it.next();
                if (tempContentEntry.getKey().toString().equalsIgnoreCase(eleName)) {
                    System.out.println(eleName + " :?:" + tempContentEntry.getKey().toString());
    ...
    public String getElementContentStatic(IOSDriver driver, String locatorStr, String locatorType, HashMap<String, By> inMap, HashMap<String, ElementMapping> eleMap, String p4L, int TITLEindex) throws Exception {
        ...
        try {
            ...
            System.out.println("    +++ ~~~ In the IPADPageTemplate :: getElementContentStatic in " + this.getClass().getSimpleName() + " has been called ~~~ +++");
            IOSDriverWait xWait = new IOSDriverWait(driver, timeOutInSeconds, localPath);
            ...
            System.out.println(logSpace4thisPage + "In IPADPageTemplate . getElementContentStatic, Other Error appear : " + e.getCause());
            throw e;
        }
        if (result == null || result.equals("")) {
            return "noRoute";
    ...
    public String textOperationStatic(IOSDriver driver, String eleName, String para, HashMap<String, By> inMap, HashMap<String, String> textMap, String extPath) throws Exception {
        ...
        final String localPath = extPath;
        try {
            System.out.println("    +++ ~~~ In the IPADPageTemplate :: textOperationStatic in " + this.getClass().getSimpleName() + " has been called ~~~ +++");
            for (Iterator it = inMap.entrySet().iterator(); it.hasNext() && theResult == null; ) {
                final Map.Entry tempContentEntry = (Map.Entry) it.next();
                if (tempContentEntry.getKey().toString().equalsIgnoreCase(eleName)) {
                    System.out.println(eleName + " :?:" + tempContentEntry.getKey().toString());
                    ...
                    if (!eleName.contains("phone")) {
                        theResult.clear();
                        Thread.sleep(200);
                        ((IOSElement) theResult).setValue(para);
                    } else {
                        para = new String(para.substring(0, 3) + "-" + para.substring(3, 6) + "-" + para.substring(6, para.length()));
                        theResult.clear();
                        Thread.sleep(200);
                        ((IOSElement) theResult).setValue(para);
                    }
            ...
            System.out.println(logSpace4thisPage + "In IPADPageTemplate . textOperationStatic, Other Error appear : " + e.getCause());
            throw e;
        }
        if (result == null || result.equals("")) {
            return "noRoute";
    ...
    public String textOperationStaticWithValue(IOSDriver driver, String eleName, String para, HashMap<String, By> inMap, HashMap<String, String> textMap, String extPath) throws Exception {
        ...
        final String localPath = extPath;
        try {
            System.out.println("    +++ ~~~ In the IPADPageTemplate :: textOperationStaticWithValue in " + this.getClass().getSimpleName() + " has been called ~~~ +++");
            for (Iterator it = inMap.entrySet().iterator(); it.hasNext() && theResult == null; ) {
                final Map.Entry tempContentEntry = (Map.Entry) it.next();
                if (tempContentEntry.getKey().toString().equalsIgnoreCase(eleName)) {
                    System.out.println(eleName + " :?:" + tempContentEntry.getKey().toString());
            ...
            System.out.println(logSpace4thisPage + "In IPADPageTemplate . textOperationStaticWithValue, Other Error appear : " + e.getCause());
            throw e;
        }
    ...
    public String btnOperationDync(IOSDriver driver, String eleName, HashMap<String, By> inMap, HashMap<String, ElementMapping> eleMap, HashMap<String, String> textMap, Boolean movecheckdisable, Boolean moveable) throws Exception {
        ...
        final String localPath = this.path4Log;
        try {
            System.out.println("    +++ ~~~ In the IPADPageTemplate :: btnOperationDync in " + this.getClass().getSimpleName() + " has been called ~~~ +++");
            for (Iterator it = inMap.entrySet().iterator(); it.hasNext() && theResult == null; ) {
                final Map.Entry tempContentEntry = (Map.Entry) it.next();
                if (tempContentEntry.getKey().toString().equalsIgnoreCase(eleName)) {
                    System.out.println(eleName + " :?:" + tempContentEntry.getKey().toString());
            ...
            System.out.println(logSpace4thisPage + "In IPADPageTemplate . btnOperationDync, Other Error appear : " + e.getCause());
            throw e;
        }
        if (result == null || result.equals("")) {
            return "noRoute";
    ...
    public String calendarOperation(IOSDriver driver, String eleName, HashMap<String, By> inMap, HashMap<String, ElementMapping> eleMap, String p4L) throws Exception {
        String result = null;
        Thread.sleep(1000);
        final String localPath = p4L;
        WebElement theResult = null;
        try {
            System.out.println("    +++ ~~~ In the IPADPageTemplate :: calendarOperation in " + this.getClass().getSimpleName() + " has been called ~~~ +++");
            for (Iterator it = inMap.entrySet().iterator(); it.hasNext() && theResult == null; ) {
                final Map.Entry tempContentEntry = (Map.Entry) it.next();
                if (tempContentEntry.getKey().toString().equalsIgnoreCase(eleName)) {
                    System.out.println(eleName + " :?:" + tempContentEntry.getKey().toString());
            ...
            System.out.println(logSpace4thisPage + "In IPADPageTemplate .calendarOperation, Other Error appear : " + e.getCause());
            throw e;
        }
        if (result == null || result.equals("")) {
            return "noRoute";
    ...
    public String getSingleEleTextGroup(IOSDriver driver, String eleName, HashMap<String, By> inMap) throws
        ...
        try {
            System.out.println("    +++ ~~~ In the IPADPageTemplate ~~~ +++");
            System.out.println("    +++ ~~~ The getSingleEleTextGroup in " + this.getClass().getSimpleName() + " has been called ~~~ +++");
            By eleStr = inMap.get(eleName);
            if (eleStr != null) {
                final By tempBy = eleStr;
                System.out.println(itemName + " :!:");
                IOSDriverWait xWait = new IOSDriverWait(driver, timeOutInSeconds, this.path4Log);
                theResult = xWait.until(
                        new IOSExpectedCondition<WebElement>() {
                            public WebElement apply(IOSDriver driver) {
                                return driver.findElement(tempBy);
                            }
                        });
                if (theResult != null) {
                    result = theResult.getText();
            ...
            System.out.println(logSpace4thisPage + "In IPADPageTemplate . getSingleEleTextGroup , Other Error appear : " + e.getCause());
            e.printStackTrace();
        }
        return result;
    }
    ...
    public String calendarGetTextOperation(IOSDriver driver, String eleName, HashMap<String, By> inMap, HashMap<String, ElementMapping> eleMap, String p4L) throws Exception {
        ...
        final String localPath = p4L;
        try {
            System.out.println("    +++ ~~~ In the IPADPageTemplate :: calendarGetTextOperation in " + this.getClass().getSimpleName() + " has been called ~~~ +++");
            for (Iterator it = inMap.entrySet().iterator(); it.hasNext() && theResult == null; ) {
                final Map.Entry tempContentEntry = (Map.Entry) it.next();
                if (tempContentEntry.getKey().toString().equalsIgnoreCase(eleName)) {
                    System.out.println(eleName + " :?:" + tempContentEntry.getKey().toString());
            ...
            System.out.println(logSpace4thisPage + "In IPADPageTemplate . calendarGetTextOperation, Other Error appear : " + e.getCause());
            throw e;
        }
        if (result == null || result.equals("")) {
            return "";
    ...
    public String dropDownListShow(IOSDriver driver, String eleName, HashMap<String, By> inMap, HashMap<String, ElementMapping> eleMap, final String p4L, HashMap<String, String> dValueMap) throws Exception {
        ...
        try {
            System.out.println("    +++ ~~~ In the IPADPageTemplate :: dropDownListShow in " + this.getClass().getSimpleName() + " has been called ~~~ +++");
            for (Iterator it = inMap.entrySet().iterator(); it.hasNext(); ) {
                final Map.Entry tempContentEntry = (Map.Entry) it.next();
                if (tempContentEntry.getKey().toString().equalsIgnoreCase(eleName)) {
                    System.out.println(eleName + " :?:" + tempContentEntry.getKey().toString());
            ...
            System.out.println(logSpace4thisPage + "In IPADPageTemplate . dropDownListShow, Other Error appear : " + e.getCause());
            e.printStackTrace();
            throw e;
        }
        return result;
    ...
    public String dropDownItemChoose(IOSDriver driver, String preiousText, HashMap<String, By> inMap, HashMap<String, ElementMapping> eleMap, final String p4L) throws Exception {  //TODO
        ...
        final String localPath = p4L;
        try {
            System.out.println("    +++ ~~~ In the IPADPageTemplate :: dropDownItemChoose in " + this.getClass().getSimpleName() + " has been called ~~~ +++");
            for (Iterator it = inMap.entrySet().iterator(); it.hasNext(); ) {
                final Map.Entry tempContentEntry = (Map.Entry) it.next();
            ...
            System.out.println(logSpace4thisPage + "In IPADPageTemplate . dropDownItemChoose, Other Error appear : " + e.getCause());
            throw e;
        }
        return result;
    }
    ...
    public String dropDownItemChooseRoll(IOSDriver driver, String preiousText, HashMap<String, By> inMap, HashMap<String, ElementMapping> eleMap, final String p4L, String eleName) throws Exception {  //TODO
        ...
        final String localPath = p4L;
        try {
            System.out.println("    +++ ~~~ In the IPADPageTemplate :: dropDownItemChooseRoll in " + this.getClass().getSimpleName() + " has been called ~~~ +++");
            for (Iterator it = inMap.entrySet().iterator(); it.hasNext(); ) {
                final Map.Entry tempContentEntry = (Map.Entry) it.next();
            ...
            System.out.println(logSpace4thisPage + "In IPADPageTemplate . dropDownItemChooseRoll, Other Error appear : " + e.getCause());
            throw e;
        }
        return result;
    }
    ...
    public String dropDownItemChooseWithPara(IOSDriver driver, String preiousText, HashMap<String, By> inMap, HashMap<String, ElementMapping> eleMap, final String p4L, String extPara) throws Exception {  //TODO
        ...
        try {
            System.out.println("    +++ ~~~ In the IPADPageTemplate :: dropDownItemChooseWithPara in " + this.getClass().getSimpleName() + " has been called ~~~ +++");
            ...
            System.out.println(logSpace4thisPage + "In IPADPageTemplate . dropDownItemChooseWithPara, Other Error appear : " + e.getCause());
            throw e;
        }
        return result;
    }
    ...
    public String dropDownItemChooseRollWithPara(IOSDriver driver, String preiousText, HashMap<String, By> inMap, HashMap<String, ElementMapping> eleMap, final String p4L, String extPara, String eleName) throws Exception {  //TODO
        ...
        final String localPath = p4L;
        try {
            System.out.println("    +++ ~~~ In the IPADPageTemplate :: dropDownItemChooseRollWithPara in " + this.getClass().getSimpleName() + " has been called ~~~ +++");
            for (Iterator it = inMap.entrySet().iterator(); it.hasNext(); ) {
                final Map.Entry tempContentEntry = (Map.Entry) it.next();
                if (tempContentEntry.getKey().toString().contains(eleName + "_picker")) {
                    System.out.println(eleName + "_picker" + " :?:" + tempContentEntry.getKey().toString());
                    ...
                    if (theResult == null) {
                        ...
                        //      rollItem(driver, preiousText, extPara, theResult);
                        //      result = theResult.getText();
            ...
            System.out.println(logSpace4thisPage + "In IPADPageTemplate . dropDownItemChooseRollWithPara, Other Error appear : " + e.getCause());
            throw e;
        }
        return result;
    }
    ...
    public String singleItemChoose(IOSDriver driver, String preiousText, HashMap<String, By> inMap, HashMap<String, ElementMapping> eleMap, final String p4L) throws Exception {  //TODO
        ...
        final String localPath = p4L;
        try {
            System.out.println("    +++ ~~~ In the IPADPageTemplate :: singleItemChoose in " + this.getClass().getSimpleName() + " has been called ~~~ +++");
            for (Iterator it = inMap.entrySet().iterator(); it.hasNext(); ) {
                final Map.Entry tempContentEntry = (Map.Entry) it.next();
                if (tempContentEntry.getKey().toString().toLowerCase().contains("dropdown_item")) {
                    System.out.println("dropdown_item" + " :?:" + tempContentEntry.getKey().toString());
            ...
            System.out.println(logSpace4thisPage + "In IPADPageTemplate . singleItemChoose, Other Error appear : " + e.getCause());
            throw e;
        }
        return result;
    }
    ...
    public String singleItemChooseWithPara(IOSDriver driver, String preiousText, HashMap<String, By> inMap, HashMap<String, ElementMapping> eleMap, final String p4L, String extPara) throws Exception {  //TODO
        ...
        System.out.println(" this time we want to choose the " + extPara + " item ");
        try {
            System.out.println("    +++ ~~~ In the IPADPageTemplate :: singleItemChooseWithPara in " + this.getClass().getSimpleName() + " has been called ~~~ +++");
            for (Iterator it = inMap.entrySet().iterator(); it.hasNext() && choosedItem == null; ) {
                final Map.Entry tempContentEntry = (Map.Entry) it.next();
            ...
            System.out.println(logSpace4thisPage + "In IPADPageTemplate . singleItemChooseWithPara, Other Error appear : " + e.getCause());
            throw e;
        }
        return result;
    }
    ...
    public String multiItemChoose(IOSDriver driver, String preiousText, HashMap<String, By> inMap, HashMap<String, ElementMapping> eleMap, final String p4L) throws Exception {  //TODO
        ...
        final String localPath = p4L;
        try {
            System.out.println("    +++ ~~~ In the IPADPageTemplate :: multiItemChoose in " + this.getClass().getSimpleName() + " has been called ~~~ +++");
            for (Iterator it = inMap.entrySet().iterator(); it.hasNext(); ) {
                final Map.Entry tempContentEntry = (Map.Entry) it.next();
            ...
            System.out.println(logSpace4thisPage + "In IPADPageTemplate . multiItemChoose, Other Error appear : " + e.getCause());
            throw e;
        }
        return result;
    }
    ...
    public String multiItemChooseWithPara(IOSDriver driver, String preiousText, HashMap<String, By> inMap, HashMap<String, ElementMapping> eleMap, final String p4L, String extPara) throws Exception {  //TODO
        ...
        try {
            ...
            System.out.println("    +++ ~~~ In the IPADPageTemplate :: multiItemChooseWithPara in " + this.getClass().getSimpleName() + " has been called ~~~ +++");
            for (Iterator it = inMap.entrySet().iterator(); it.hasNext() && choosedItem == null; ) {
                final Map.Entry tempContentEntry = (Map.Entry) it.next();
                if (tempContentEntry.getKey().toString().toLowerCase().contains("multi_item")) {
                    System.out.println("multi_item" + " :?:" + tempContentEntry.getKey().toString());
            ...
            System.out.println(logSpace4thisPage + "In IPADPageTemplate . multiItemChooseWithPara, Other Error appear : " + e.getCause());
            throw e;
        }
    ...
    public String searchStart(IOSDriver driver, String eleName, HashMap<String, By> inMap, HashMap<String, ElementMapping> eleMap, final String p4L, String dValue, String extPara) throws Exception {
        ...
        final String localPath = p4L;
        try {
            System.out.println("    +++ ~~~ In the IPADPageTemplate :: searchStart in " + this.getClass().getSimpleName() + " has been called ~~~ +++");
            for (Iterator it = inMap.entrySet().iterator(); it.hasNext() && theResult == null; ) {
                final Map.Entry tempContentEntry = (Map.Entry) it.next();
                if (tempContentEntry.getKey().toString().equalsIgnoreCase(eleName)) {
                    System.out.println(eleName + " :?:" + tempContentEntry.getKey().toString());
            ...
            System.out.println(logSpace4thisPage + "In IPADPageTemplate . searchStart, Other Error appear : " + e.getCause());
            throw e;
        }
        return result;
    }
    ...
    public String autoCompleteStartMAC(IOSDriver driver, String eleName, HashMap<String, By> inMap, HashMap<String, ElementMapping> eleMap, final String p4L, String dValue, String extPara) throws Exception {
        ...
        final String localPath = p4L;
        try {
            System.out.println("    +++ ~~~ In the IPADPageTemplate :: searchStartMAC in " + this.getClass().getSimpleName() + " has been called ~~~ +++");
            for (Iterator it = inMap.entrySet().iterator(); it.hasNext() && theResult == null; ) {
                final Map.Entry tempContentEntry = (Map.Entry) it.next();
                if (tempContentEntry.getKey().toString().equalsIgnoreCase(eleName)) {
                    System.out.println(eleName + " :?:" + tempContentEntry.getKey().toString());
                    ...
                    if ((tempText != "") && (tempText != null)) {
                        ...
                        result = result.append("failedToGetText");
                    }
                }
            }
        } catch (Exception e) {
            System.out.println(logSpace4thisPage + "In IPADPageTemplate . searchStartMAC, Other Error appear : " + e.getCause());
            throw e;
        }
        ...
        try {
            ...
            for (Iterator it = inMap.entrySet().iterator(); it.hasNext() && theResult == null; ) {
                ...
                if (tempContentEntry.getKey().toString().equalsIgnoreCase(eleName)) {
                    ...
                    driver.hideKeyboard("Search");
                /*    By tempSearch = inMap.get("searchBtn");
                    WebElement theSearchBtn = null;
                    if (tempSearch != null) {
                        theSearchBtn = driver.findElement(tempSearch);
                    } else {
                        for (Iterator itx = inMap.entrySet().iterator(); itx.hasNext() && theResult == null; ) {
                            final Map.Entry temp2ContentEntry = (Map.Entry) itx.next();
                            if (temp2ContentEntry.getKey().toString().equalsIgnoreCase(eleName)) {
                                theSearchBtn = driver.findElement((By) tempContentEntry.getValue());
                            }
                        }
                    }


                    //WebElement theSearchBtn = driver.findElement(By.xpath("//UIAApplication[1]/UIAWindow[5]/UIAKeyboard[1]/UIAButton[4]"));
                    if (theSearchBtn != null) {
                        theSearchBtn.click();
                    } else {
                        System.out.println("Failed to locate the Search Btn");
                    }   */
                }
            }
        } catch (Exception e) {
    ...
    public String selectItem(IOSDriver driver, String eleName, HashMap<String, By> inMap, HashMap<String, ElementMapping> eleMap, final String p4L, String extPara, Boolean contentIsolatedClickable) throws Exception {  //TODO
        ...
        System.out.println(" this time we want to choose the " + extPara + " item ");
        try {
            System.out.println("    +++ ~~~ In the IPADPageTemplate :: selectItem in " + this.getClass().getSimpleName() + " has been called ~~~ +++"); // find all items
            for (Iterator it = inMap.entrySet().iterator(); it.hasNext(); ) {
                final Map.Entry tempContentEntry = (Map.Entry) it.next();
                        ...
                        for (int ind = 1; ind <= 10; ind++) {
                            try {
                                ...
                                if (temp4list != null) {
                                    ...
                                    System.out.println("add one searchContent_item");
                                } else {
                                    break;
                                }
                            } catch (Exception e) {
            ...
            System.out.println(logSpace4thisPage + "In IPADPageTemplate . selectItem, Other Error appear : " + e.getCause());
            e.printStackTrace();
            throw e;
        }
    ...
    public String autoCompleteOperationSuper(IOSDriver driver, String
        ...
        System.out.println("    +++ ~~~ The autoCompleteOperationSuper in IPADPageTemplate has been called ~~~ +++");
        try {
            result = absCalendarOpenWin(driver, eleName, inMap, eleMap, p4L);

            Class tempClassType = Class.forName(String.valueOf(new StringBuffer("REXSH.REXAUTO.APPunderTest.AppPage.iPAD.").append("IPADPage").append(autoWin)));
    ...
    public String checkCalendarDate(IOSDriver driver, String eleName, HashMap<String, By> inMap, String p4L) throws Exception {
        ...
        final String localPath = p4L;
        try {
            System.out.println("    +++ ~~~ In the IPADPageTemplate :: checkCalendarDate in " + this.getClass().getSimpleName() + " has been called ~~~ +++");
            for (Iterator it = inMap.entrySet().iterator(); it.hasNext() && theResult == null; ) {
                final Map.Entry tempContentEntry = (Map.Entry) it.next();
                if (tempContentEntry.getKey().toString().equalsIgnoreCase(eleName)) {
                    System.out.println(eleName + " :?:" + tempContentEntry.getKey().toString());
            ...
            System.out.println(logSpace4thisPage + "In IPADPageTemplate . checkCalendarDate , Other Error appear : " + e.getCause());
            throw e;
        }
        return result;
    }
    ...
    public String btnOperationListMatch(IOSDriver driver, String eleName, HashMap<String, By> inMap, HashMap<String, ElementMapping> eleMap, String p4L) throws Exception {
        ...
        final String localPath = p4L;
        try {
            System.out.println("    +++ ~~~ In the IPADPageTemplate :: btnOperationListMatch in " + this.getClass().getSimpleName() + " has been called ~~~ +++");
            for (Iterator it = inMap.entrySet().iterator(); it.hasNext() && theResult == null; ) {
                final Map.Entry tempContentEntry = (Map.Entry) it.next();
                if (tempContentEntry.getKey().toString().equalsIgnoreCase(eleName)) {
                    System.out.println(eleName + " :?:" + tempContentEntry.getKey().toString());
                    ...
                    if (theResult == null) {
                        throw new REXException("Failed to find the element in IPADPageTemplate btnOperationListMatch, Line 2067 ");
            ...
            System.out.println(logSpace4thisPage + "In IPADPageTemplate . btnOperationListMatch, Other Error appear : " + e.getCause());
            throw e;
        }
        if (result == null || result.equals("")) {
            return "noRoute";
    ...
    public String btnOperationAutoIndex(IOSDriver driver, String eleName, HashMap<String, By> inMap, HashMap<String, ElementMapping> eleMap, String p4L) throws Exception {   //TODO
        ...
        try {
            ...
            System.out.println("    +++ ~~~ In the IPADPageTemplate :: btnOperationAutoIndex in " + this.getClass().getSimpleName() + " has been called ~~~ +++");
            ...
            System.out.println(logSpace4thisPage + "In IPADPageTemplate . btnOperationAutoIndex, Other Error appear : " + e.getCause());
            throw e;
        }
        if (result == null || result.equals("")) {
            return "noRoute";
    ...
    public String getElementContentSmart(IOSDriver driver, String locatorStr, String locatorType, HashMap<String, By> inMap, HashMap<String, ElementMapping> eleMap, String p4L, int TITLEindex) throws Exception {
        ...
        int index4item = 1;
        try {
            System.out.println("    +++ ~~~ In the IPADPageTemplate :: getElementContentSmart in " + this.getClass().getSimpleName() + " has been called ~~~ +++");
            ...
            System.out.println(logSpace4thisPage + "In IPADPageTemplate . getElementContentSmart, Other Error appear : " + e.getCause());
            throw e;
        }
        if (result == null || result.equals("")) {
            return "";
    ...
    public String getStaticElementContent(IOSDriver driver, String locatorStr, HashMap<String, By> inMap, HashMap<String, ElementMapping> eleMap, String p4L, int TITLEindex) throws Exception {
        ...
        try {
            ...
            System.out.println(logSpace4thisPage + "In IPADPageTemplate . getStaticElementContent, Other Error appear : " + e.getCause());
            throw e;
        }
        if (result == null || result.equals("")) {
            return "";
    ...
    public String getStaticElementContent_rc(IOSDriver driver, String locatorStr, HashMap<String, By> inMap, HashMap<String, ElementMapping> eleMap, String p4L) throws Exception {
        String result = null;
        String localStr = null;
        Thread.sleep(1000);
        int steprange = 9;
        ...
        List<By> temp = new ArrayList<By>();
        try {
            for (int ind = index4item; (ind <= steprange) && (theResult == null); ind++) {  //  use this part for getstaticelementcontent()
                System.out.println("step ~~~~~~~~~~~~~~~~~~" + ind);
                String newContent2 = new String(rowContent.replaceFirst(":REXrecord:", String.valueOf(ind)));
                final By singleRecord = By.xpath(newContent2);
                System.out.println(newContent2);
                try {
                    theResult = (IOSElement) driver.findElement(singleRecord);
            ...
            System.out.println(logSpace4thisPage + "In IPADPageTemplate . getStaticElementContent_rc, Other Error appear : " + e.getCause());
            throw e;
        }
        if (result == null || result.equals("")) {
            return "";
    ...
    public String autoSearch(IOSDriver driver, String eleName, HashMap<String, By> inMap, HashMap<String, ElementMapping> eleMap, String p4L) throws Exception {
        ...
        final String localPath = p4L;
        try {
            System.out.println("    +++ ~~~ In the IPADPageTemplate :: autoSearch 4 Route in " + this.getClass().getSimpleName() + " has been called ~~~ +++");
            for (Iterator it = inMap.entrySet().iterator(); it.hasNext() && theResult == null; ) {
                final Map.Entry tempContentEntry = (Map.Entry) it.next();
                if (tempContentEntry.getKey().toString().equalsIgnoreCase(eleName)) {
                    IOSDriverWait xWait = new IOSDriverWait(driver, timeOutInSeconds, localPath);
            ...
            System.out.println(logSpace4thisPage + "In IPADPageTemplate . autoSearch , Other Error appear : " + e.getCause());
            throw e;
        }
        if (result == null || result.equals("")) {
            return "noRoute";
    ...
    public String absCalendarOpenWin(IOSDriver driver, String
        ...
        WebElement theResult = null;
        try {
            System.out.println("    +++ ~~~ In the IPADPageTemplate :: absCalendarOperation in " + this.getClass().getSimpleName() + " has been called ~~~ +++");
            ...
            System.out.println(logSpace4thisPage + "In IPADPageTemplate . absCalendarOperation, Other Error appear : " + e.getCause());
            throw e;
        }
        if (result == null || result.equals("")) {
            return "noRoute";
    ...
    public String calendarOperationSuper(IOSDriver driver, String
        ...
        System.out.println("    +++ ~~~ The calendarOperationSuper in IPADPageTemplate has been called ~~~ +++");
        result = absCalendarOpenWin(driver, eleName, inMap, eleMap, p4L);

        Class tempClassType = Class.forName(String.valueOf(new StringBuffer("REXSH.REXAUTO.APPunderTest.AppPage.iPAD.").append("IPADPage").append(dateWin)));
        System.out.println("@@@ tempClassType : " + tempClassType);
        Object tempIns = createInstance(tempClassType, driver);
        Method setMethod = tempClassType.getDeclaredMethod("comPageCheck", new Class[]{IOSDriver.class, String.class, String.class});
    ...
    private IOSElement filterBtnElement(IOSDriver driver, IOSDriverWait xWait, By theByKey, String eleName, HashMap<String, ElementMapping> eleMap, int extindex4path) throws Exception {
        ...
        try {
            ...
            if ((targetXPATH_start != "") && (targetXPATH_end != "")) {
                ...
                // 希望不会出这个问题
                throw new XMLException("in IPADPageTemplate :: filterBtnElement, fork else, the XML file is not correct");
            }
        ...
        try {
            for (; (review != true) && (moveAccount > 0); ) {       // 只要没有到页尾 或者 计数器满就继续找
                ...
                if ((temp.size() == 0) && (temp4his.size() != 0)) {
                    ...
                    // 希望不会出这个问题
                    throw new REXException("in IPADPageTemplate :: filterBtnElementOLD, fork else");
                }
                temp4his.clear();
            ...
            if ((targetXPATH_start != "") && (targetXPATH_end != "")) {
                ...
                // 希望不会出这个问题
                throw new XMLException("in IPADPageTemplate :: filterBtnElementOLD, fork else, the XML file is not correct");
            }
        } catch (Exception e) {
            result = null;
            throw e;
        ...
        try {
            for (; (review != true) && (moveAccount > 0); ) {       // 只要没有到页尾 或者 计数器满就继续找
                ...
                if (temp.size() != temp4his.size()) {  // 长度不一样,自然就是新内容了
                    ...
                    // 希望不会出这个问题
                    throw new REXException("in IPADPageTemplate :: getIndex4BtnElement, fork else");
                }
                if (num4xpath == 0) {
                    temp4his.clear();
                    temp4his.addAll(temp);
        ...
        try {
            for (; (review != true) && (moveAccount > 0); ) {       // 只要没有到页尾 或者 计数器满就继续找
                ...
                if (temp.size() != temp4his.size()) {  // 长度不一样,自然就是新内容了
                    ...
                    // 希望不会出这个问题
                    throw new REXException("in IPADPageTemplate :: filterRecordElement, fork else");
                }
                temp4his.clear();
                temp4his.addAll(temp);
                temp.clear();
            ...
            if ((targetXPATH_start != "") && (targetXPATH_end != "")) {
                ...
                // 希望不会出这个问题
                throw new XMLException("in IPADPageTemplate :: filterRecordElement, fork else, the XML file is not correct");
            }
        } catch (Exception e) {
            result = null;
            throw e;
    ...
    public String btnOperationSearch(IOSDriver driver, String eleName, HashMap<String, By> inMap, HashMap<String, ElementMapping> eleMap, String p4L, int index4xpath) throws Exception {
        ...
        try {
            ...
            System.out.println(logSpace4thisPage + "In IPADPageTemplate . btnOperationSearch, Other Error appear : " + e.getCause());
            throw e;
        }
        if (result == null || result.equals("")) {
...
/*
            ...
            */
            ...
            System.out.println(logSpace4thisPage + "In IPADPageTemplate . isolatedBtnSearchWithIndex, Other Error appear : " + e.getCause());
            throw e;
        }
        if (result == null || result.equals("")) {
            return "noRoute" + "::" + index4xpath;
    ...
    public String isolatedRecordSearchWithLocation(IOSDriver driver, final String eleName, final String recordType, final String recordStr, final HashMap<String, By> inMap, final HashMap<String, ElementMapping> eleMap, String p4L, int ind4xpath, HashMap<String, String> textMap, final String tText, final int index4ClassName, final String comType, final String comStr) throws Exception {
        ...
        try {
            ...
            System.out.println(logSpace4thisPage + "In IPADPageTemplate . isolatedRecordSearchWithLocation, Other Error appear : " + e.getCause());
            throw e;
        }
        if (result == null || result.equals("")) {
            return "noRoute" + "::" + index4xpath;
    ...
    public int getIndex4TitleIndex(IOSDriver driver, String eleName, HashMap<String, By> inMap, HashMap<String, ElementMapping> eleMap, String p4L, int index4xpath) throws REXException, InterruptedException {
        ...
        try {
            ...
            System.out.println(logSpace4thisPage + "In IPADPageTemplate . getIndex4TitleIndex, Other Error appear : " + e.getCause());
            e.printStackTrace();
            throw e;
        } finally {
            return index4xpath;
    ...
    public String rollTheRound(IOSDriver driver, String
        ...
        try {
            System.out.println("    +++ ~~~ In the IPADPageTemplate :: rollTheRound ~~~ +++");
            for (Iterator it = inMap.entrySet().iterator(); it.hasNext() && theResult == null; ) {
                final Map.Entry tempContentEntry = (Map.Entry) it.next();
                if (tempContentEntry.getKey().toString().equalsIgnoreCase(eleName)) {
                    IOSDriverWait xWait = new IOSDriverWait(driver, timeOutInSeconds, localPath);
            ...
            System.out.println(logSpace4thisPage + "In  IPADPageTemplate :: rollTheRound , Other Error appear : " + e.getCause());
            result = "error";
            e.printStackTrace();
        }
        if (result == null || result.equals("")) {
    ...
    public String pressStrTheRound(IOSDriver driver, IOSElement theEntry, String tValue, int roundRange, boolean direction) throws Exception {
        ...
        {
            System.out.println(logSpace4thisPage + "In  IPADPageTemplate :: pressStrTheRound , Other Error appear : " + e.getCause());
            result = "error";
            e.printStackTrace();
        }
    ...
    public boolean rollTheRoundSingle(IOSDriver driver, WebElement thePicker, int roundRange, boolean direction) throws Exception {
        ...
        Dimension theSize = null;
        try {
            System.out.println("    +++ ~~~ In the IPADPageTemplate :: rollTheRoundSingle ~~~ +++");
            ...
            System.out.println(logSpace4thisPage + "In  IPADPageTemplate :: rollTheRoundSingle , Other Error appear : " + e.getCause());
            result = false;
            e.printStackTrace();
        }
        //    if (result == null || result.equals("")) {
    ...
    public List<String> getElementContentList(IOSDriver driver, String
        ...
        Thread.sleep(1000);
        try {
            System.out.println("    +++ ~~~ In the IPADPageTemplate :: getElementContentList ~~~ +++");
            for (Iterator it = inMap.entrySet().iterator(); it.hasNext() && theResult == null; ) {
                final Map.Entry tempContentEntry = (Map.Entry) it.next();
                if (tempContentEntry.getKey().toString().equalsIgnoreCase(eleName)) {
                    IOSDriverWait xWait = new IOSDriverWait(driver, timeOutInSeconds, localPath);
            ...
            System.out.println(logSpace4thisPage + "In  IPADPageTemplate :: getElementContentList , Other Error appear : " + e.getCause());
            e.printStackTrace();
        }
        if (result == null || result.size() == 0) {
            return new ArrayList<String>();
    ...
    public String getElementContentWithSearch(IOSDriver driver, String
        ...
        Thread.sleep(1000);
        try {
            System.out.println("    +++ ~~~ In the IPADPageTemplate :: getElementContentWithSearch ~~~ +++");
            for (Iterator it = inMap.entrySet().iterator(); it.hasNext() && theResult == null; ) {
                final Map.Entry tempContentEntry = (Map.Entry) it.next();
                if (tempContentEntry.getKey().toString().equalsIgnoreCase(eleName)) {
            ...
            System.out.println(logSpace4thisPage + "In  IPADPageTemplate :: getElementContentWithSearch , Other Error appear : " + e.getCause());
            e.printStackTrace();
        }
        if (result == null || result.equals("")) {
            return "emptyContent";
    ...
    public String getElementContent(IOSDriver driver, String
        ...
        try {
            if (flag4search == true) {
                System.out.println("    +++ ~~~ In the IPADPageTemplate :: getElementContent, with search ~~~ +++");
                for (Iterator it = inMap.entrySet().iterator(); it.hasNext(); ) {
                    final Map.Entry tempContentEntry = (Map.Entry) it.next();
                    if (tempContentEntry.getKey().toString().equalsIgnoreCase(eleName)) {
                ...
                System.out.println("    +++ ~~~ In the IPADPageTemplate :: getElementContent, without search ~~~ +++");
                for (Iterator it = inMap.entrySet().iterator(); it.hasNext(); ) {
                    final Map.Entry tempContentEntry = (Map.Entry) it.next();
                    if (tempContentEntry.getKey().toString().equalsIgnoreCase(eleName)) {
    ...
    public String getContentInBtn(IOSDriver driver, String eleName) throws Exception {
        ...
        try {
            ...
            System.out.println(logSpace4thisPage + "In IPADPageTemplate . getContentInBtn , Other Error appear : " + e.getCause());
            e.printStackTrace();
        }
        return theResult;
    }
    ...
    public boolean getSingleEle(IOSDriver driver, String eleName, HashMap<String, By> inMap) throws
        ...
        try {
            ...
            System.out.println(logSpace4thisPage + "In IPADPageTemplate . getSingleEle , Other Error appear : " + e.getCause());
            e.printStackTrace();
        }
        return result;
    }
    ...
    public String getSingleEleText(IOSDriver driver, String eleName, HashMap<String, By> inMap) throws
        ...
        try {
            ...
            System.out.println(logSpace4thisPage + "In IPADPageTemplate . getSingleEleText , Other Error appear : " + e.getCause());
            e.printStackTrace();
        }
        return result;
    }
        ...
        try {
            if (type4check.equals("ready")) {       // ready mode
                ...
                } else if (para4check.equals("title")) // check title for ready mode
                {
                    ...
                    ArrayList<String> temp = this.content.getContentNameList4name(this.eleContentMap, "errorTitle");
                    if (temp.size() != 1) {
                        flag = false;
                        System.out.println("More than 1 errorTitle element found in : " + this.getClass().getSimpleName());
                        System.out.println("Please check the XML file for : " + this.getClass().getSimpleName());
                    } else {
                        flag = true;
                    }
        ...
        try {
            if (type4check.equals("ready")) {       // ready mode
                ...
                } else if (para4check.equals("title")) // check title for ready mode
                {
                    ...
                    ArrayList<String> temp = inContent.getContentNameList4name(inEleContentMap, "errorTitle");
                    if (temp.size() != 1) {
                        flag = false;
                        System.out.println("More than 1 errorTitle element found in : " + this.getClass().getSimpleName());
                        System.out.println("Please check the XML file for : " + this.getClass().getSimpleName());
    ...
    public boolean tableMatch(IOSDriver driver, String
        ...
        for (; flag4loop < 3 && findMatch == false; moveUPwithY(driver, moveGap)) {
            ...
            //   for (WebElement tEle : tempList) {
            //        theRecordList.add((IOSElement) tEle);
        ...
        //    String t1 = "//android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.widget.LinearLayout[1]/android.support.v4.widget.DrawerLayout[1]/android.widget.LinearLayout[1]/android.widget.FrameLayout[2]/android.widget.LinearLayout[1]/android.support.v4.view.ViewPager[1]/android.widget.LinearLayout[1]/android.widget.ScrollView[1]/android.widget.LinearLayout[1]/android.widget.ListView[1]/android.widget.LinearLayout[1]/android.widget.RelativeLayout[2]/android.widget.GridView[1]/android.widget.LinearLayout[1]/android.widget.TextView[1]";
        //   String t2 = "//android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.widget.LinearLayout[1]/android.support.v4.widget.DrawerLayout[1]/android.widget.LinearLayout[1]/android.widget.FrameLayout[2]/android.widget.LinearLayout[1]/android.support.v4.view.ViewPager[1]/android.widget.LinearLayout[1]/android.widget.ScrollView[1]/android.widget.LinearLayout[1]/android.widget.ListView[1]/android.widget.LinearLayout[1]/android.widget.RelativeLayout[2]/android.widget.GridView[1]/android.widget.LinearLayout[1]/android.widget.LinearLayout[1]/android.widget.TextView[1]";

        //  WebElement tt1 = driver.findElement(By.xpath(t1));
        //  System.out.println(tt1.getText());
        //  WebElement tt2 = driver.findElement(By.xpath(t2));

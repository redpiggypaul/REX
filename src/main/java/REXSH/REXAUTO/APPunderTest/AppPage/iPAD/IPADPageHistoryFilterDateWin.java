 ...
 */
public class IPADPageHistoryFilterDateWin extends IPADPageTemplate {
    ...
    private static String logSpace4thisPage = " --- IPADPageHistoryFilterDateWin --";
    ...
    public IPADPageHistoryFilterDateWin(IOSDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public IPADPageHistoryFilterDateWin(IOSDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public IPADPageHistoryFilterDateWin(String theFile, IOSDriver theD, Log theLogger) throws Exception {
    ...
    public String btnOperationRoute(IOSDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperationRoute in IPADPageHistoryFilterDateWin has been called ~~~ +++");
    ...
    public HashMap<String, By> getByMap(IOSDriver driver) {
        ...
        result.clear();
        By tempElement = null;
        System.out.println(logSpace4thisPage + "xxxxxx ------ Check the driver in IPADPageHistoryFilterDateWin . getByMap (IOSDriver driver)  : " + driver.toString());
    ...
    public HashMap<String, By> getByMap(IOSDriver driver, HashMap<String, ElementMapping> eleMap) {
        ...
        result.clear();
        By tempElement = null;
        System.out.println(logSpace4thisPage + "xxxxxx ------ Check the driver in IPADPageHistoryFilterDateWin . getByMap (IOSDriver driver, HashMap<String, ElementMapping> eleMap)  : " + driver.toString());
    ...
    public void btnOperation(IOSDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperation in IPADPageHistoryFilterDateWin has been called ~~~ +++");
    ...
    public void textOperation(IOSDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperation in IPADPageHistoryFilterDateWin has been called ~~~ +++");
    ...
    public String getElementContent(IOSDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The getElementContent in IPADPageHistoryFilterDateWin has been called ~~~ +++");
    ...
    public String textOperationWithSaveInput(IOSDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperationWithSaveInput in IPADPageHistoryFilterDateWin has been called ~~~ +++");
        ...
        try {
            ...
            System.out.println(logSpace4thisPage + "In IPADPageHistoryFilterDateWin . textOperationWithSaveInput , Other Error appear : " + e.getCause());
            e.printStackTrace();
        } finally {
            return result;
        }
    ...
    public void moveUP(IOSDriver dr) throws Exception {
        System.out.println(" moveUP in IPADPageHistoryFilterDateWin ");
        super.moveUPtest(dr);
    }

    public void moveUPall(IOSDriver dr) throws Exception {
        System.out.println(" moveUPall in IPADPageHistoryFilterDateWin ");
        super.moveUPall(dr);
    }

    public void moveDOWN(IOSDriver dr) throws Exception {
        System.out.println(" moveDown in IPADPageHistoryFilterDateWin ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            IPADPageHistoryFilterDateWin x = new IPADPageHistoryFilterDateWin("/PageXML/AND/bProfileEditPublication.xml", driver, null);

 ...
 */
public class IPADPageNaviConfirmWin extends IPADPageTemplate {
    ...
    public IPADPageNaviConfirmWin(IOSDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public IPADPageNaviConfirmWin(IOSDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public IPADPageNaviConfirmWin(String theFile, IOSDriver theD, Log theLogger) throws Exception {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            IPADPageNaviConfirmWin x = new IPADPageNaviConfirmWin("/PageXML/AND/loginPage.xml", driver, null);

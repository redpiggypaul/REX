 ...
 */
public class IPADPageSearchErrorWin extends IPADPageTemplate {
    ...
    public IPADPageSearchErrorWin(IOSDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public IPADPageSearchErrorWin(IOSDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public IPADPageSearchErrorWin(String theFile, IOSDriver theD, Log theLogger) throws Exception {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            IPADPageSearchErrorWin x = new IPADPageSearchErrorWin("/PageXML/AND/loginPage.xml", driver, null);

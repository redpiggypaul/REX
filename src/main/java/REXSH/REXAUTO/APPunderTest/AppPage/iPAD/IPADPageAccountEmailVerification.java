 ...
 */
public class IPADPageAccountEmailVerification extends IOSPageTemplate {
    ...
    public IPADPageAccountEmailVerification(IOSDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public IPADPageAccountEmailVerification(IOSDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public IPADPageAccountEmailVerification(String theFile, IOSDriver theD, Log theLogger) throws Exception {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            IPADPageAccountEmailVerification x = new IPADPageAccountEmailVerification("/PageXML/AND/loginPage.xml", driver, null);

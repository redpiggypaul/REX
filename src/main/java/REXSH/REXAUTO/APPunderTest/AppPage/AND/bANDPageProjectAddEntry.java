 ...
 */
public class bANDPageProjectAddEntry extends bANDPageTemplate {
    protected String fileName = "bAddEntry.json";
    ...
    private static String logSpace4thisPage = " --- bANDPageProjectAddEntry --";
    ...
    public bANDPageProjectAddEntry(AndroidDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public bANDPageProjectAddEntry(AndroidDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public bANDPageProjectAddEntry(String theFile, AndroidDriver theD, Log theLogger) throws Exception {
    ...
    public String btnOperationRoute(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperationRoute in bANDPageProjectAddEntry has been called ~~~ +++");
        try {
    ...
    public String calendarOperation(AndroidDriver driver, String eleName) throws Exception {
        ...
        System.out.println("    +++ ~~~ The calendarOperation in bANDPageProjectAddEntry has been called ~~~ +++");
        try {
    ...
    public String calendarOperationDate(AndroidDriver driver, String eleName, String tDate) throws Exception {
        String result = null;
        System.out.println("    +++ ~~~ The calendarOperationDate in bANDPageProjectAddEntry has been called ~~~ +++");
        try {
    ...
    public String dropDownListOperation(AndroidDriver driver, String eleName) throws Exception {  //TODO
        ...
        System.out.println("    +++ ~~~ The dropDownListOperation in bANDPageProjectAddEntry has been called ~~~ +++");
        try {
    ...
    public String itemListOperation(AndroidDriver driver, String eleName) throws Exception {
        String defaultText = "";
        String dropItemValue = null;
        System.out.println("    +++ ~~~ The itemListOperation in bANDPageProjectAddEntry has been called ~~~ +++");
        try {
    ...
    public void btnOperation(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperation in bANDPageProjectAddEntry has been called ~~~ +++");
        try {
    ...
    public void textOperation(AndroidDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperation in bANDPageProjectAddEntry has been called ~~~ +++");
        try {
    ...
    public String getElementContent(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The getElementContent in bANDPageProjectAddEntry has been called ~~~ +++");
        try {
    ...
    public String textOperationWithSaveInput(AndroidDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperationWithSaveInput in bANDPageProjectAddEntry has been called ~~~ +++");
        ...
        try {
            ...
            if (tempDefaultValue != null) {
                if (tempDefaultValue.contains("amount")) {
                    //  String newPara = finicalCheckAddZero(para1);
            ...
            System.out.println(logSpace4thisPage + "In bANDPageProjectAddEntry . textOperationWithSaveInput , Other Error appear : " + e.getCause());
            e.printStackTrace();
        } finally {
            return result;
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            bANDPageProjectAddEntry x = new bANDPageProjectAddEntry("/PageXML/AND/bProfileEditPublication.xml", driver, null);

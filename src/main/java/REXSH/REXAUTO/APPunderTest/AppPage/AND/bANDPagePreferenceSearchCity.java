 ...
 */
public class bANDPagePreferenceSearchCity extends bANDPageTemplate {
    protected String fileName = "bPreferenceSearchCity.json";
    String autoOSType = readProperity.getProValue("autoRunningOSType");
    private String contentFilePath = "\\PageXML\\And\\Preference\\";
    ...
    private static String logSpace4thisPage = " --- bANDPagePreferenceEdit --";
    ...
    public bANDPagePreferenceSearchCity(AndroidDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public bANDPagePreferenceSearchCity(AndroidDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public bANDPagePreferenceSearchCity(String theFile, AndroidDriver theD, Log theLogger) throws Exception {
    ...
    public String btnOperationRoute(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperationRoute in bANDPagePreferenceEdit has been called ~~~ +++");
        try {
    ...
    public String calendarOperation(AndroidDriver driver, String eleName) throws Exception {
        ...
        System.out.println("    +++ ~~~ The calendarOperation in bANDPagePreferenceEdit has been called ~~~ +++");
        try {
    ...
    public String calendarOperationDate(AndroidDriver driver, String eleName, String tDate) throws Exception {
        String result = null;
        System.out.println("    +++ ~~~ The calendarOperationDate in bANDPagePreferenceEdit has been called ~~~ +++");
        try {
    ...
    public String dropDownListOperation(AndroidDriver driver, String eleName) throws Exception {  //TODO
        ...
        System.out.println("    +++ ~~~ The dropDownListOperation in bANDPagePreferenceEdit has been called ~~~ +++");
        try {
    ...
    public String searchOperation(AndroidDriver driver, String eleName, String extPara) throws Exception {  //TODO
        String defaultText = null;
        String selectItemValue = null;
        System.out.println("    +++ ~~~ The searchOperation in bANDPageProfileEditSkill has been called ~~~ +++");
        System.out.println(" this time we want to choose the " + extPara + " item ");
        ...
        try {
            ...
            defaultText = super.searchStart(driver, eleName, this.byMap, this.eleContentMap, this.path4Log, tempDefaultValue, extPara, false);
            selectItemValue = super.selectItem(driver, defaultText, this.byMap, this.eleContentMap, this.path4Log, extPara);
            Thread.sleep(1000);
            if (selectItemValue != null && selectItemValue != "") {
                // super.btnOperation(driver, "doneBtn", this.byMap);
                return selectItemValue;
            } else {
                System.out.println("Error appear with searchOperation IN bANDPageProfileEditSkill");
                throw new REXException("Error appear with searchOperation IN bANDPageProfileEditSkill");
            }
        } catch (Exception e) {
            throw e;
        }
    ...
    public void btnOperation(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperation in bANDPagePreferenceEdit has been called ~~~ +++");
        try {
    ...
    public void textOperation(AndroidDriver driver, String eleName, String para1) throws Exception {
        try {
            System.out.println("    +++ ~~~ The textOperation in bANDPagePreferenceEdit has been called ~~~ +++");
    ...
    public String getElementContent(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The getElementContent in bANDPagePreferenceEdit has been called ~~~ +++");
        try {
            return super.getElementContentWithSearch(driver, eleName, this.byMap, this.eleContentMap);
        } catch (Exception e) {
            throw e;
        }
    }
    ...
    public String textOperationWithSaveInput(AndroidDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperationWithSaveInput in bANDPagePreferenceEdit has been called ~~~ +++");
        String tempDefaultValue = null;
        String result = null;
        try {
            for (Iterator it = this.content.getContentMap().entrySet().iterator(); it.hasNext(); ) {
            ...
            System.out.println(logSpace4thisPage + "In bANDPagePreferenceEdit . textOperationWithSaveInput , Other Error appear : " + e.getCause());
            e.printStackTrace();
        } finally {
            return result;
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            bANDPagePreferenceSearchCity x = new bANDPagePreferenceSearchCity("/PageXML/AND/bProfileEditPublication.xml", driver, null);

 ...
 */
public class bANDPageAccChangeErrorWin extends bANDPageTemplate {
    protected String fileName = "bAccChangeErrorWin.json";
    ...
    private static String logSpace4thisPage = " --- bANDPageAccChangeErrorWin --";
    ...
    public bANDPageAccChangeErrorWin(AndroidDriver theD, String p4l) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public bANDPageAccChangeErrorWin(String theFile, AndroidDriver theD, Log theLogger) throws Exception {
    ...
    public String btnOperationRoute(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperationRoute in bANDPageAccChangeErrorWin has been called ~~~ +++");
        try {
    ...
    public String getElementContent(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The getElementContent in bANDPageAccChangeErrorWin has been called ~~~ +++");
        try {
    ...
    public void btnOperation(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperation in bANDPageAccChangeErrorWin has been called ~~~ +++");
        try {
    ...
    public void textOperation(AndroidDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperationn in bANDPageAccChangeErrorWin has been called ~~~ +++");
        try{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            bANDPageAccChangeErrorWin x = new bANDPageAccChangeErrorWin("/PageXML/AND/loginPage.xml", driver, null);

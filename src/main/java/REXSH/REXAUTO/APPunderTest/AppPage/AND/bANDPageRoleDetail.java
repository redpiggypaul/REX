 ...
 */
public class bANDPageRoleDetail extends bANDPageTemplate {
    protected String fileName = "bRoleDetail.json";
    ...
    private static String logSpace4thisPage = " --- bANDPageRoleDetail --";
    ...
    public bANDPageRoleDetail(AndroidDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public bANDPageRoleDetail(AndroidDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public bANDPageRoleDetail(String theFile, AndroidDriver theD, Log theLogger) throws Exception {
    ...
    public void btnOperation(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperation in bANDPageRoleDetail has been called ~~~ +++");
        try {
    ...
    public void textOperation(AndroidDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperationn in bANDPageRoleDetail has been called ~~~ +++");
        try {
            loadingJudgement(driver, this.eleContentMap);
    ...
    public String btnOperationRoute(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperationRoute in bANDPageRoleDetail has been called ~~~ +++");
        try {
            loadingJudgement(driver, this.eleContentMap);
    ...
    public String btnOperationRouteMayPresent(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperationRouteMayPresent in bANDPageRoleDetail has been called ~~~ +++");
        try {
            loadingJudgement(driver, this.eleContentMap);
            return super.btnOperation(driver, eleName, this.byMap, this.eleContentMap, this.path4Log);
        } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            bANDPageRoleDetail x = new bANDPageRoleDetail("/PageXML/AND/loginPage.xml", driver, null);

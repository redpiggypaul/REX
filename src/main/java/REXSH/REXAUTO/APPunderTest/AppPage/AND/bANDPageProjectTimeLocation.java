 ...
 */
public class bANDPageProjectTimeLocation extends bANDPageTemplate {
    protected String fileName = "bRoleTimeLocation.json";
    ...
    private static String logSpace4thisPage = " --- bANDPageProjectTimeLocatione --";
    ...
    public bANDPageProjectTimeLocation(AndroidDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public bANDPageProjectTimeLocation(AndroidDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public bANDPageProjectTimeLocation(String theFile, AndroidDriver theD, Log theLogger) throws Exception {
    ...
    public String btnOperationRoute(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperationRoute in bANDPageProjectTimeLocatione has been called ~~~ +++");
        try {
    ...
    public void btnOperation(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperation in bANDPageProjectTimeLocatione has been called ~~~ +++");
        try {
    ...
    public void textOperation(AndroidDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperation in bANDPageProjectTimeLocatione has been called ~~~ +++");
        try {
    ...
    public String getElementContent(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The getElementContent in bANDPageProjectTimeLocatione has been called ~~~ +++");
        try {
    ...
    public String textOperationWithSaveInput(AndroidDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperationWithSaveInput in bANDPageProjectTimeLocatione has been called ~~~ +++");
        ...
        try {
            ...
            System.out.println(logSpace4thisPage + "In bANDPageProjectTimeLocatione . textOperationWithSaveInput , Other Error appear : " + e.getCause());
            e.printStackTrace();
        } finally {
            return result;
        }
    ...
    public String searchOperation(AndroidDriver driver, String eleName, String extPara) throws Exception {  //TODO
        ...
        System.out.println("    +++ ~~~ The searchOperation in bANDPageProjectTimeLocatione has been called ~~~ +++");
        ...
        try {
            ...
            if (selectItemValue != null && selectItemValue != "") {
                ...
                System.out.println("Error appear with searchOperation IN bANDPageProjectTimeLocatione");
                throw new REXException("Error appear with searchOperation IN bANDPageProjectTimeLocatione");
            }
        } catch (Exception e) {
            throw e;
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            bANDPageProjectTimeLocation x = new bANDPageProjectTimeLocation("/PageXML/AND/bProfileEditPublication.xml", driver, null);

 ...
 */
public class bANDPageRateSetting extends bANDPageTemplate {
    protected String fileName = "bRateSetting.json";
    ...
    private static String logSpace4thisPage = " --- bANDPageRateSetting --";
    ...
    public bANDPageRateSetting(AndroidDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public bANDPageRateSetting(AndroidDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public bANDPageRateSetting(String theFile, AndroidDriver theD, Log theLogger) throws Exception {
    ...
    public void textOperation(AndroidDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperationn in bANDPageRateSetting has been called ~~~ +++");
        try {
    ...
    public void btnOperation(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperation in bANDPageRateSetting has been called ~~~ +++");
        try {
    ...
    public String btnOperationRoute(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperationRoute in bANDPageRateSetting has been called ~~~ +++");
        try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            bANDPageRateSetting x = new bANDPageRateSetting("/PageXML/AND/loginPage.xml", driver, null);

 ...
 */
public class bANDPageRateDoneWin extends bANDPageTemplate {
    protected String fileName = "bRateDoneWin.json";
    ...
    public bANDPageRateDoneWin(AndroidDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public bANDPageRateDoneWin(AndroidDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public bANDPageRateDoneWin(String theFile, AndroidDriver theD, Log theLogger) throws Exception {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            bANDPageRateDoneWin x = new bANDPageRateDoneWin("/PageXML/AND/loginPage.xml", driver, null);

 ...
 */
public class bANDPageDateWin extends bANDPageTemplate {
    protected String fileName = "bDateWin.json";
    ...
    private static String logSpace4thisPage = " --- bANDPageDateWin --";
    ...
    public bANDPageDateWin(AndroidDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public bANDPageDateWin(AndroidDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public bANDPageDateWin(String theFile, AndroidDriver theD, Log theLogger) throws Exception {
    ...
    public String btnOperationRoute(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperationRoute in bANDPageDateWin has been called ~~~ +++");
        try {
    ...
    public void btnOperation(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperation in bANDPageDateWin has been called ~~~ +++");
        try {
    ...
    public String getElementContent(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The getElementContent in bANDPageDateWin has been called ~~~ +++");
        try {
    ...
    public String saveDate(AndroidDriver theD, String theDay, String thePath) throws Exception {  // type4check : ready, loading, error, temp , etc.  , para4check: target element name, all element, title element
        ...
        try {
            final By tempBy = this.byMap.get("OKBtn");
            ...
            if (tempBy != null) {
                ...
                theRoute = super.checkTheNextPage("OKBtn", this.eleContentMap);
            } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            bANDPageDateWin x = new bANDPageDateWin("/PageXML/AND/bProfileEditPublication.xml", driver, null);

 ...
 */
public class bANDPageAccountConfirmWin extends bANDPageTemplate {
    protected String fileName = "bAccountConfirmWin.json";
    ...
    private static String logSpace4thisPage = " --- bANDPageAccountConfirmWin --";
    ...
    public bANDPageAccountConfirmWin(AndroidDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public bANDPageAccountConfirmWin(AndroidDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public bANDPageAccountConfirmWin(String theFile, AndroidDriver theD, Log theLogger) throws Exception {
    ...
    public String btnOperationRoute(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperationRoute in bANDPageAccountConfirmWin has been called ~~~ +++");
        try {
    ...
    public String getElementContent(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The getElementContent in bANDPageAccountConfirmWin has been called ~~~ +++");
        try {
    ...
    public void btnOperation(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperation in bANDPageAccountConfirmWin has been called ~~~ +++");
        try {
    ...
    public void textOperation(AndroidDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperationn in bANDPageAccountConfirmWin has been called ~~~ +++");
        try{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            bANDPageAccountConfirmWin x = new bANDPageAccountConfirmWin("/PageXML/AND/loginPage.xml", driver, null);

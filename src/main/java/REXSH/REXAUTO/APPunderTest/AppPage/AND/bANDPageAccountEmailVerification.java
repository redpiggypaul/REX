 ...
 */
public class bANDPageAccountEmailVerification extends bANDPageTemplate {
    protected String fileName = "bAccountEmailVerification.json";
    ...
    private static String logSpace4thisPage = " --- bANDPageAccountEmailVerification --";
    ...
    public bANDPageAccountEmailVerification(AndroidDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public bANDPageAccountEmailVerification(AndroidDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public bANDPageAccountEmailVerification(String theFile, AndroidDriver theD, Log theLogger) throws Exception {
    ...
    public String btnOperationRoute(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperationRoute in bANDPageAccountEmailVerification has been called ~~~ +++");
        try {
    ...
    public void btnOperation(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperation in bANDPageAccountEmailVerification has been called ~~~ +++");
        try {
    ...
    public void textOperation(AndroidDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperationn in bANDPageAccountEmailVerification has been called ~~~ +++");
        try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            bANDPageAccountEmailVerification x = new bANDPageAccountEmailVerification("/PageXML/AND/loginPage.xml", driver, null);

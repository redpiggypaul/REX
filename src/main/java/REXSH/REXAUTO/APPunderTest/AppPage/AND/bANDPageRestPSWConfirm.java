 ...
 */
public class bANDPageRestPSWConfirm extends bANDPageTemplate {
    ...
    private static String logSpace4thisPage = " --- bANDPageRestPSWConfirm --";
    ...
    public bANDPageRestPSWConfirm(AndroidDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public bANDPageRestPSWConfirm(AndroidDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public bANDPageRestPSWConfirm(String theFile, AndroidDriver theD, Log theLogger) throws Exception {
    ...
    public String btnOperationRoute(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperationRoute in bANDPageRestPSWConfirm has been called ~~~ +++");
        try {
    ...
    public String getElementContent(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The getElementContent in bANDPageRestPSWConfirm has been called ~~~ +++");
        try {
    ...
    public void btnOperation(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperation in bANDPageRestPSWConfirm has been called ~~~ +++");
        try {
    ...
    public void textOperation(AndroidDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperationn in bANDPageRestPSWConfirm has been called ~~~ +++");
        try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            bANDPageRestPSWConfirm x = new bANDPageRestPSWConfirm("/PageXML/AND/loginPage.xml", driver, null);

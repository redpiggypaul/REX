 ...
 */
public class bANDPageProfile extends bANDPageTemplate {
    protected String fileName = "bProfile.json";
    ...
    private static String logSpace4thisPage = " --- bANDPageProfile --";
    ...
    public bANDPageProfile(AndroidDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public bANDPageProfile(AndroidDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public bANDPageProfile(String theFile, AndroidDriver theD, Log theLogger) throws Exception {
    ...
    public String btnOperationRoute(AndroidDriver driver, String eleName) throws Exception { // elename may contains common 4 title, record 4 record under title
        System.out.println("    +++ ~~~ The btnOperationRoute in bANDPageProfile has been called ~~~ +++");
    ...
    public String getElementContent(AndroidDriver driver, String eleName) throws Exception { // elename may contains common 4 title, record 4 record under title
        if (!eleName.toLowerCase().contains("language") && !eleName.toLowerCase().contains("skill")) {
            System.out.println("    +++ ~~~ The getElementContent in bANDPageProfile has been called ~~~ +++");
    ...
    public void btnOperation(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperation in bANDPageProfile has been called ~~~ +++");
    ...
    public void textOperation(AndroidDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperation in bANDPageProfile has been called ~~~ +++");
    ...
    public String textOperationWithSaveInput(AndroidDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperationWithSaveInput in bANDPageProfile has been called ~~~ +++");
    ...
    public String dropDownListOperation(AndroidDriver driver, String eleName) throws Exception {  //TODO
        ...
        System.out.println("    +++ ~~~ The dropDownListOperation in bANDPageProfile has been called ~~~ +++");

 ...
 */
public class bANDPageProfileEditReferenceEdit extends bANDPageTemplate {
    protected String fileName = "bProfileEditReferenceEdit.json";
    ...
    private static String logSpace4thisPage = " --- bANDPageProfileEditReferenceEdit --";
    ...
    public bANDPageProfileEditReferenceEdit(AndroidDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public bANDPageProfileEditReferenceEdit(AndroidDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public bANDPageProfileEditReferenceEdit(String theFile, AndroidDriver theD, Log theLogger) throws Exception {
    ...
    public String btnOperationRoute(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperationRoute in bANDPageProfileEditReferenceEdit has been called ~~~ +++");
        try {
    ...
    public void btnOperation(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperation in bANDPageProfileEditReferenceEdit has been called ~~~ +++");
        try {
    ...
    public void textOperation(AndroidDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperation in bANDPageProfileEditReferenceEdit has been called ~~~ +++");
        try {
    ...
    public String getElementContent(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The getElementContent in bANDPageProfileEditReferenceEdit has been called ~~~ +++");
        try {
    ...
    public String textOperationWithSaveInput(AndroidDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperationWithSaveInput in bANDPageProfileEditReferenceEdit has been called ~~~ +++");
        String result = null;
        //   if (!eleName.toLowerCase().equals("refname")){
        try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            bANDPageProfileEditReferenceEdit x = new bANDPageProfileEditReferenceEdit("/PageXML/AND/bPageProfileEdit.xml", driver, null);

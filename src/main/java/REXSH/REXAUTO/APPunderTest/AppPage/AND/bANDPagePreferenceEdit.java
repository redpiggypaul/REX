 ...
 */
public class bANDPagePreferenceEdit extends bANDPageTemplate {
    protected String fileName = "bPreferenceEdit.json";
    ...
    public bANDPagePreferenceEdit(AndroidDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public bANDPagePreferenceEdit(AndroidDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public bANDPagePreferenceEdit(String theFile, AndroidDriver theD, Log theLogger) throws Exception {
    ...
    public boolean matchScreen(AndroidDriver driver, String eleName) throws Exception {
        ...
        System.out.println("    +++ ~~~ The matchScreen in bANDPagePreferenceEdit has been called ~~~ +++");
        try {
        ...
        try {
            ...
            if (tempDefaultValue != null) {
                ...
                if (autoOSType.equalsIgnoreCase("MAC")) {
                    return textOperationWithSaveInputSmartMAC(driver, eleName, para1, this.byMap, tempDefaultValue);
                } else {
                    return textOperationWithSaveInputWindows(driver, eleName, para1, this.byMap, tempDefaultValue);
                }
            } else {
    ...
    public String getPageContent(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The getPageContent in bANDPagePreferenceEdit has been called ~~~ +++");
        try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            bANDPagePreferenceEdit x = new bANDPagePreferenceEdit("/PageXML/AND/bProfileEditPublication.xml", driver, null);

 ...
 */
public class bANDPageProfileEditSearchCertification extends bANDPageTemplate {
    protected String fileName = "bProfileEditSearchCertification.json";
    ...
    private static String logSpace4thisPage = " --- bANDPageProfileEditSearchCertification --";
    ...
    public bANDPageProfileEditSearchCertification(AndroidDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public bANDPageProfileEditSearchCertification(AndroidDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public bANDPageProfileEditSearchCertification(String theFile, AndroidDriver theD, Log theLogger) throws Exception {
    ...
    public String btnOperationRoute(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperationRoute in bANDPageProfileEditSearchCertification has been called ~~~ +++");
        try {
    ...
    public void btnOperation(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperation in bANDPageProfileEditSearchCertification has been called ~~~ +++");
        try {
    ...
    public void textOperation(AndroidDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperation in bANDPageProfileEditSearchCertification has been called ~~~ +++");
        try {
    ...
    public String getElementContent(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The getElementContent in bANDPageProfileEditSearchCertification has been called ~~~ +++");
        try {
    ...
    public String textOperationWithSaveInput(AndroidDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperationWithSaveInput in bANDPageProfileEditSearchCertification has been called ~~~ +++");
        ...
        try {
            ...
            System.out.println(logSpace4thisPage + "In bANDPageProfileEditSearchCertification . textOperationWithSaveInput , Other Error appear : " + e.getCause());
            e.printStackTrace();
        } finally {
            return result;
        }
    ...
    public String searchOperation(AndroidDriver driver, String eleName, String extPara) throws Exception {  //TODO
        ...
        System.out.println("    +++ ~~~ The searchOperation in bANDPageProfileEditSearchCertification has been called ~~~ +++");
        ...
        try {
            ...
            if (selectItemValue != null && selectItemValue != "") {
                ...
                System.out.println("Error appear with searchOperation IN bANDPageProfileEditSearchCertification");
                throw new REXException("Error appear with searchOperation IN bANDPageProfileEditSearchCertification");
            }
        } catch (Exception e) {
            throw e;
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            bANDPageProfileEditSearchCertification x = new bANDPageProfileEditSearchCertification("/PageXML/AND/bProfileEditPublication.xml", driver, null);

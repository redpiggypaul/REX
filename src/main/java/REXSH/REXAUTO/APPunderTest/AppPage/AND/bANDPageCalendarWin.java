 ...
 */
public class bANDPageCalendarWin extends bANDPageTemplate {
    protected String fileName = "bCalendarWin.json";
    ...
    private static String logSpace4thisPage = " --- bANDPageCalendarWin --";
    ...
    public bANDPageCalendarWin(AndroidDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public bANDPageCalendarWin(String theFile, AndroidDriver theD, Log theLogger) throws Exception {
    ...
    public String btnOperationRoute(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperationRoute in bANDPageCalendarWin has been called ~~~ +++");
        try {
    ...
    public void btnOperation(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperation in bANDPageCalendarWin has been called ~~~ +++");
        try {
    ...
    public void textOperation(AndroidDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperation in bANDPageCalendarWin has been called ~~~ +++");
        try {
    ...
    public String getElementContent(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The getElementContent in bANDPageCalendarWin has been called ~~~ +++");
    ...
    public String textOperationWithSaveInput(AndroidDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperationWithSaveInput in bANDPageCalendarWin has been called ~~~ +++");
        ...
        try {
            ...
            System.out.println(logSpace4thisPage + "In bANDPageCalendarWin . textOperationWithSaveInput , Other Error appear : " + e.getCause());
            e.printStackTrace();
        } finally {
            return result;
        }
    ...
    public String saveDate(AndroidDriver theD, String theDay) throws Exception {  // type4check : ready, loading, error, temp , etc.  , para4check: target element name, all element, title element
        String targetDay = theDay;
            ...
            for (Iterator it = this.byMap.entrySet().iterator(); it.hasNext(); ) {
                ...
                if (tempContentEntry.getKey().toString().equalsIgnoreCase("OKBtn")) {
                    ...
                    if (!theRoute.equals("noRoute") && (theRoute != "") && (theRoute != null)) {
                        ...
                        ScreenShot(theD, "During_Switch_" + time + ".png", this.path4Log);
                    }
                }
            }
            return theRoute;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            bANDPageCalendarWin x = new bANDPageCalendarWin("/PageXML/AND/bProfileEditPublication.xml", driver, null);

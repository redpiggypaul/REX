 ...
 */
public class bANDPageProfileEditEducation extends bANDPageTemplate {
    protected String fileName = "bProfileEditEducation.json";
    ...
    private static String logSpace4thisPage = " --- bANDPageProfileEditEducation --";
    ...
    public bANDPageProfileEditEducation(AndroidDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public bANDPageProfileEditEducation(String theFile, AndroidDriver theD, Log theLogger) throws Exception {
    ...
    public String calendarOperation(AndroidDriver driver, String eleName) throws Exception {
        ...
        System.out.println("    +++ ~~~ The calendarOperation in bANDPageProfileEditEducation has been called ~~~ +++");
        try {
    ...
    public String calendarOperationDate(AndroidDriver driver, String eleName, String tDate) throws Exception {
        String result = null;
        System.out.println("    +++ ~~~ The calendarOperationDate in bANDPageProfileEditEducation has been called ~~~ +++");
        try {
    ...
    public String autoCompleteOperation(AndroidDriver driver, String eleName, String key) throws Exception {
        String result = null;
        System.out.println("    +++ ~~~ The autoCompleteOperation in bANDPageProfileEditEducation has been called ~~~ +++");
        try {
            result = super.autoCompleteOperationSuper(driver, eleName, this.byMap, this.eleContentMap, this.path4Log, key, autoCompWin);
            return result;
        } catch (Exception e) {
            throw e;
        }
    ...
    public void btnOperation(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperation in bANDPageProfileEditEducation has been called ~~~ +++");
        try {
    ...
    public String getElementContent(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The getElementContent in bANDPageProfileEditEducation has been called ~~~ +++");
        try {
    ...
    public void textOperation(AndroidDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperation in bANDPageProfileEditEducation has been called ~~~ +++");
        try {
    ...
    public String textOperationWithSaveInput(AndroidDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperationWithSaveInput in bANDPageProfileEditEducation has been called ~~~ +++");
        ...
        try {
            ...
            System.out.println(logSpace4thisPage + "In bANDPageProfileEditEducation . textOperationWithSaveInput , Other Error appear : " + e.getCause());
            e.printStackTrace();
        } finally {
            return result;
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            bANDPageProfileEditEducation x = new bANDPageProfileEditEducation("/PageXML/AND/bProfileEditPublication.xml", driver, null);

 ...
 */
public class bANDPageProjectViewExpense extends bANDPageTemplate {
    protected String fileName = "bViewExpense.json";
    ...
    private static String logSpace4thisPage = " --- bANDPageProjectViewExpense --";
    ...
    public bANDPageProjectViewExpense(AndroidDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public bANDPageProjectViewExpense(AndroidDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public bANDPageProjectViewExpense(String theFile, AndroidDriver theD, Log theLogger) throws Exception {
    ...
    public String btnOperationRoute(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperationRoute in bANDPageProjectViewExpense has been called ~~~ +++");
        try {
    ...
    public void btnOperation(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperation in bANDPageProjectViewExpense has been called ~~~ +++");
        try {
    ...
    public void textOperation(AndroidDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperation in bANDPageProjectViewExpense has been called ~~~ +++");
        String dValue = null;
        try {
            ...
            System.out.println(logSpace4thisPage + "In bANDPageProjectViewExpense . textOperation 4, Other Error appear : " + e.getCause());
            e.printStackTrace();
        }
    ...
    public String calendarOperation(AndroidDriver driver, String eleName) throws Exception {
        ...
        System.out.println("    +++ ~~~ The calendarOperation in bANDPageProjectViewExpense has been called ~~~ +++");
        try {
    ...
    public String calendarOperationDate(AndroidDriver driver, String eleName, String tDate) throws Exception {
        String result = null;
        System.out.println("    +++ ~~~ The calendarOperationDate in bANDPageProjectViewExpense has been called ~~~ +++");
        try {
    ...
    public String getElementContent(AndroidDriver driver, String eleName) throws Exception {
        String result = null;
        String temp = null;
        System.out.println("    +++ ~~~ The getElementContent in bANDPageProjectViewExpense has been called ~~~ +++");
        try {
            if (!eleName.contains("entryAmount")) {
    ...
    public String textOperationWithSaveInput(AndroidDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperationWithSaveInput in bANDPageProjectViewExpense has been called ~~~ +++");
        String result = null;
        String dValue = null;
        try {
            System.out.println("Some on called me with : " + para1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            bANDPageProjectViewExpense x = new bANDPageProjectViewExpense("/PageXML/AND/bProfileEditSkills.xml", driver, null);

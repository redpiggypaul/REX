 ...
 */
public class bANDPageRoleFilter extends bANDPageTemplate {
    protected String fileName = "bRoleFilter.json";
    ...
    private String autoCompWin = "LocationAutoComplete";
    ...
    private static String logSpace4thisPage = " --- bANDPageRoleFilter --";
    ...
    public bANDPageRoleFilter(AndroidDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public bANDPageRoleFilter(AndroidDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public bANDPageRoleFilter(String theFile, AndroidDriver theD, Log theLogger) throws Exception {
    ...
    public String btnOperationRoute(AndroidDriver driver, String eleName) throws Exception { // elename may contains common 4 title, record 4 record under title
        System.out.println("    +++ ~~~ The btnOperationRoute in bANDPageRoleFilter has been called ~~~ +++");
            ...
            if (!eleName.toLowerCase().contains("_record")) { // for title
                ...
                if (commonLocatorStr != null) {  //
                    ...
                    if ((commonType.equals("xpath")) && (titleTempType.equals("xpath") && titleTempLocatorStr.contains(":REXindex:"))) {
                        ...
                        /*
                        result = super.btnOperationSearch(driver, name4title, this.byMap, this.eleContentMap, this.path4Log, this.index4XPATH);
                        if (result.split("::").length > 1) {
                            index4XPATH = Integer.parseInt(result.split("::")[1]);
                        }
                        */
    ...
    public String getElementContent(AndroidDriver driver, String eleName) throws Exception { // elename may contains common 4 title, record 4 record under title
        try {
            if (!eleName.toLowerCase().contains("language") && !eleName.toLowerCase().contains("skill")) {
                System.out.println("    +++ ~~~ The getElementContent in bANDPageRoleFilter has been called ~~~ +++");
    ...
    public void btnOperation(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperation in bANDPageRoleFilter has been called ~~~ +++");
        try {
    ...
    public void textOperation(AndroidDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperation in bANDPageRoleFilter has been called ~~~ +++");
        try {
    ...
    public String textOperationWithSaveInput(AndroidDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperationWithSaveInput in bANDPageRoleFilter has been called ~~~ +++");
        try {
            if (!eleName.equals("zipAndState")) {
                ...
                if (para1.contains(" ")) {
                    ...
                    if(!shortCut.equalsIgnoreCase("")) {
                        temp = new String(temp + "_REX_" + shortCut);
                    }
                }
                return temp;
            }
    ...
    public String dropDownListOperation(AndroidDriver driver, String eleName) throws Exception {  //TODO
        ...
        System.out.println("    +++ ~~~ The dropDownListOperation in bANDPageRoleFilter has been called ~~~ +++");
        try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            bANDPageRoleFilter x = new bANDPageRoleFilter("/PageXML/AND/bPageProfileEdit.xml", driver, null);

 ...
 */
public class bANDPageAddExpense extends bANDPageTemplate {
    ...
    // protected ANDPageAttitude attitude = null;
    ...
    private static String logSpace4thisPage = " --- bANDPageAddExpense --";
    ...
    public bANDPageAddExpense(AndroidDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
        ...
        //   attitude = new ANDPageAttitude(tempName, osType);
    ...
    public bANDPageAddExpense(AndroidDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public bANDPageAddExpense(String theFile, AndroidDriver theD, Log theLogger) throws Exception {
  ...
  try{      return super.btnOperation(driver, eleName, this.byMap, this.eleContentMap, this.path4Log);
  } catch (Exception e) {
      throw e;
  }}
    ...
    public String getElementContent(AndroidDriver driver, String eleName) throws Exception {
      ...
      try{  return super.getElementContent(driver, eleName, this.byMap, this.eleContentMap);
      } catch (Exception e) {
          throw e;
      } }
    ...
    public void btnOperation(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperation in bANDPageAddExpense has been called ~~~ +++");
    ...
    public void textOperation(AndroidDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperation in bANDPageAddExpense has been called ~~~ +++");
       try{ super.textOperation(driver, eleName, para1, this.byMap, this.content.eleDefaultValueMap);
       } catch (Exception e) {
           throw e;
       }  }
    ...
    public String textOperationWithSaveInput(AndroidDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperationWithSaveInput in bANDPageAddExpense has been called ~~~ +++");
     try{   return super.textOperationWithSaveInput(driver, eleName, para1, this.byMap, this.content.eleDefaultValueMap);
     } catch (Exception e) {
         throw e;
     }    }
    ...
    public String dropDownListOperation(AndroidDriver driver, String eleName) throws Exception {  //TODO
        ...
        System.out.println("    +++ ~~~ The dropDownListOperation in bANDPageAddExpense has been called ~~~ +++");
   ...
   try{     defaultText = super.dropDownListShow(driver, eleName, this.byMap, this.eleContentMap, this.path4Log, this.content.eleDefaultValueMap);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            bANDPageAddExpense x = new bANDPageAddExpense("/PageXML/AND/bPageProfileEdit.xml", driver, null);

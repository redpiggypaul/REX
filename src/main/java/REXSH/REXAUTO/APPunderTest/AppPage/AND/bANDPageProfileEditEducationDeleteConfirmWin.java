 ...
 */
public class bANDPageProfileEditEducationDeleteConfirmWin extends bANDPageTemplate {
    protected String fileName = "bProfileEducationDeleteConfirmWin.json";
    ...
    private static String logSpace4thisPage = " --- bANDPageProfileEditEducationDeleteConfirmWin --";
    ...
    public bANDPageProfileEditEducationDeleteConfirmWin(AndroidDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public bANDPageProfileEditEducationDeleteConfirmWin(AndroidDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public bANDPageProfileEditEducationDeleteConfirmWin(String theFile, AndroidDriver theD, Log theLogger) throws Exception {
    ...
    public void btnOperation(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperation in bANDPageProfileEditEducationDeleteConfirmWin has been called ~~~ +++");
        try {
    ...
    public String btnOperationRoute(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperationRoute in bANDPageProfileEditEducationDeleteConfirmWin has been called ~~~ +++");
        try {
    ...
    public void textOperation(AndroidDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperationn in bANDPageProfileEditEducationDeleteConfirmWin has been called ~~~ +++");
        try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            bANDPageProfileEditEducationDeleteConfirmWin x = new bANDPageProfileEditEducationDeleteConfirmWin("/PageXML/AND/loginPage.xml", driver, null);

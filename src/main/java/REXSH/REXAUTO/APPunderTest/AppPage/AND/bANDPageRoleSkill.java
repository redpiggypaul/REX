 ...
 */
public class bANDPageRoleSkill extends bANDPageTemplate {
    protected String fileName = "bRoleSkill.json";
    String autoOSType = readProperity.getProValue("autoRunningOSType");
    private String contentFilePath = "\\PageXML\\And\\RoleFilter\\";
    ...
    private static String logSpace4thisPage = " --- bANDPageRoleSkilll --";
    ...
    public bANDPageRoleSkill(AndroidDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public bANDPageRoleSkill(AndroidDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public bANDPageRoleSkill(String theFile, AndroidDriver theD, Log theLogger) throws Exception {
    ...
    public String btnOperationRoute(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperationRoute in bANDPageRoleSkilll has been called ~~~ +++");
        try {
    ...
    public void btnOperation(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperation in bANDPageRoleSkilll has been called ~~~ +++");
        try {
    ...
    public void textOperation(AndroidDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperation in bANDPageRoleSkilll has been called ~~~ +++");
        try {
    ...
    public String getElementContent(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The getElementContent in bANDPageRoleSkilll has been called ~~~ +++");
        try {
    ...
    public String textOperationWithSaveInput(AndroidDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperationWithSaveInput in bANDPageRoleSkilll has been called ~~~ +++");
        ...
        try {
            ...
            System.out.println(logSpace4thisPage + "In bANDPageRoleSkilll . textOperationWithSaveInput , Other Error appear : " + e.getCause());
            e.printStackTrace();
        } finally {
            return result;
        }
    ...
    public String searchOperation(AndroidDriver driver, String eleName, String extPara) throws Exception {  //TODO
        ...
        System.out.println("    +++ ~~~ The searchOperation in bANDPageRoleSkilll has been called ~~~ +++");
        ...
        try {
            ...
            if (selectItemValue != null && selectItemValue != "") {
                ...
                System.out.println("Error appear with searchOperation IN bANDPageRoleSkilll");
                throw new REXException("Error appear with searchOperation IN bANDPageRoleSkilll");
            }
        } catch (Exception e) {
            throw e;
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            bANDPageRoleSkill x = new bANDPageRoleSkill("/PageXML/AND/bProfileEditPublication.xml", driver, null);

 ...
 */
public class bANDPageDeleteAccCompleteWin extends bANDPageTemplate {
    protected String fileName = "bDeleteAccCompleteWin.json";
    ...
    private static String logSpace4thisPage = " --- bANDPageDeleteAccCompleteWin --";
    ...
    public bANDPageDeleteAccCompleteWin(AndroidDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public bANDPageDeleteAccCompleteWin(AndroidDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public bANDPageDeleteAccCompleteWin(String theFile, AndroidDriver theD, Log theLogger) throws Exception {
    ...
    public String btnOperationRoute(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperationRoute in bANDPageDeleteAccCompleteWin has been called ~~~ +++");
        try {
    ...
    public String getElementContent(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The getElementContent in bANDPageDeleteAccCompleteWin has been called ~~~ +++");
        try {
    ...
    public void btnOperation(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperation in bANDPageDeleteAccCompleteWin has been called ~~~ +++");
        try {
    ...
    public String checkAbnormalElement(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The checkAbnormalElement in bANDPageDeleteAccCompleteWin has been called ~~~ +++");
        try {
    ...
    public void textOperation(AndroidDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperationn in bANDPageDeleteAccCompleteWin has been called ~~~ +++");
        try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            bANDPageDeleteAccCompleteWin x = new bANDPageDeleteAccCompleteWin("/PageXML/AND/loginPage.xml", driver, null);

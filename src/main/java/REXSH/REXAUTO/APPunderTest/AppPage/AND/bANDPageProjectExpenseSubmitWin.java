 ...
 */
public class bANDPageProjectExpenseSubmitWin extends bANDPageTemplate {
    protected String fileName = "bExpenseSubmit.json";
    ...
    private static String logSpace4thisPage = " --- bANDPageProjectExpenseSubmitWin --";
    ...
    public bANDPageProjectExpenseSubmitWin(AndroidDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public bANDPageProjectExpenseSubmitWin(AndroidDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public bANDPageProjectExpenseSubmitWin(String theFile, AndroidDriver theD, Log theLogger) throws Exception {
    ...
    public String btnOperationRoute(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperationRoute in bANDPageProjectExpenseSubmitWin has been called ~~~ +++");
        try {
    ...
    public void btnOperation(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperation in bANDPageProjectExpenseSubmitWin has been called ~~~ +++");
        try {
    ...
    public void textOperation(AndroidDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperation in bANDPageProjectExpenseSubmitWin has been called ~~~ +++");
        try {
    ...
    public String getElementContent(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The getElementContent in bANDPageProjectExpenseSubmitWin has been called ~~~ +++");
        try {
    ...
    public String textOperationWithSaveInput(AndroidDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperationWithSaveInput in bANDPageProjectExpenseSubmitWin has been called ~~~ +++");
        ...
        try {
            ...
            System.out.println(logSpace4thisPage + "In bANDPageProjectExpenseSubmitWin . textOperationWithSaveInput , Other Error appear : " + e.getCause());
            e.printStackTrace();
        } finally {
            return result;
        }
    ...
    public String calendarOperation(AndroidDriver driver, String eleName) throws Exception {
        ...
        System.out.println("    +++ ~~~ The calendarOperation in bANDPageProjectExpenseSubmitWin has been called ~~~ +++");
        try {
    ...
    public String calendarOperationDate(AndroidDriver driver, String eleName, String tDate) throws Exception {
        String result = null;
        System.out.println("    +++ ~~~ The calendarOperationDate in bANDPageProjectExpenseSubmitWin has been called ~~~ +++");
        try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            bANDPageProjectExpenseSubmitWin x = new bANDPageProjectExpenseSubmitWin("/PageXML/AND/bProfileEditPublication.xml", driver, null);

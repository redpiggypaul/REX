 ...
 */
public class bANDPageConfirmInterest extends bANDPageTemplate {
    ...
    private static String logSpace4thisPage = " --- bANDPageConfirmInterest --";
    ...
    public bANDPageConfirmInterest(AndroidDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public bANDPageConfirmInterest(AndroidDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public bANDPageConfirmInterest(String theFile, AndroidDriver theD, Log theLogger) throws Exception {
    ...
    public String btnOperationRoute(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperationRoute in bANDPageConfirmInterest has been called ~~~ +++");
    ...
    public void btnOperation(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperation in bANDPageConfirmInterest has been called ~~~ +++");
  try{      super.btnOperation(driver, eleName, this.byMap);
    ...
    public void testOperation(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperation in bANDPageConfirmInterest has been called ~~~ +++");
   try{     super.testOperation(driver, eleName);
   } catch (Exception e) {
       throw e;
   }}

    public void textOperation(AndroidDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperationn in bANDPageConfirmInterest has been called ~~~ +++");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            bANDPageConfirmInterest x = new bANDPageConfirmInterest("/PageXML/AND/loginPage.xml", driver, null);

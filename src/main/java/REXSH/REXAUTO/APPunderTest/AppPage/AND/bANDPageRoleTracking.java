 ...
 */
public class bANDPageRoleTracking extends bANDPageTemplate {
    protected String fileName = "bRoleTracking.json";
    ...
    private static String logSpace4thisPage = " --- bANDPageRoleTracking --";
    ...
    public bANDPageRoleTracking(AndroidDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public bANDPageRoleTracking(AndroidDriver theD, String p4l) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public bANDPageRoleTracking(String theFile, AndroidDriver theD, Log theLogger) throws Exception {
    ...
    public void textOperation(AndroidDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperationn in bANDPageRoleTracking has been called ~~~ +++");
        try {
    ...
    public void btnOperation(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperation in bANDPageRoleTracking has been called ~~~ +++");
        try {
    ...
    public String btnOperationRoute(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperationRoute in bANDPageRoleTracking has been called ~~~ +++");
        try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            bANDPageRoleTracking x = new bANDPageRoleTracking("/PageXML/AND/loginPage.xml", driver, null);

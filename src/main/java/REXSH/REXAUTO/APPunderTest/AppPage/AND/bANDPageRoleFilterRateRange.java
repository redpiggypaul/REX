 ...
 */
public class bANDPageRoleFilterRateRange extends bANDPageTemplate {
    protected String fileName = "bRoleRate.json";
    ...
    private static String logSpace4thisPage = " --- bANDPageRoleFilterRateRange --";
    ...
    public bANDPageRoleFilterRateRange(AndroidDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public bANDPageRoleFilterRateRange(AndroidDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public bANDPageRoleFilterRateRange(String theFile, AndroidDriver theD, Log theLogger) throws Exception {
    ...
    public String btnOperationRoute(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperationRoute in bANDPageRoleFilterRateRange has been called ~~~ +++");
        try {
    ...
    public void btnOperation(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperation in bANDPageRoleFilterRateRange has been called ~~~ +++");
        try {
    ...
    public void textOperation(AndroidDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperation in bANDPageRoleFilterRateRange has been called ~~~ +++");
        try {
    ...
    public String getElementContent(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The getElementContent in bANDPageRoleFilterRateRange has been called ~~~ +++");
        try {
    ...
    public String textOperationWithSaveInput(AndroidDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperationWithSaveInput in bANDPageRoleFilterRateRange has been called ~~~ +++");
        ...
        try {
            ...
            System.out.println(logSpace4thisPage + "In bANDPageRoleFilterRateRange . textOperationWithSaveInput , Other Error appear : " + e.getCause());
            e.printStackTrace();
        } finally {
            return result;
        }
    ...
    public String comPageCheck(AndroidDriver theD, String type4check, String para4check) throws Exception {
        // type4check : ready, loading, error, temp , etc.  , para4check: target element name, all element, title element
        String result = null;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            bANDPageRoleFilterRateRange x = new bANDPageRoleFilterRateRange("/PageXML/AND/bProfileEditPublication.xml", driver, null);

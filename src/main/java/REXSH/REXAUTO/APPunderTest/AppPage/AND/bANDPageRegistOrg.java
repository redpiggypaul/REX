 ...
 */
public class bANDPageRegistOrg extends bANDPageTemplate {
    ...
    private static String logSpace4thisPage = " --- bANDPageRegistOrg --";
    ...
    public bANDPageRegistOrg(AndroidDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public bANDPageRegistOrg(AndroidDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public bANDPageRegistOrg(String theFile, AndroidDriver theD, Log theLogger) throws Exception {
    ...
    public String btnOperationRoute(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperationRoute in bANDPageRegistOrg has been called ~~~ +++");
    ...
    public void btnOperation(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperation in bANDPageRegistOrg has been called ~~~ +++");
    ...
    public void textOperation(AndroidDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperationn in bANDPageRegistOrg has been called ~~~ +++");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            bANDPageRegistOrg x = new bANDPageRegistOrg("/PageXML/AND/loginPage.xml", driver, null);

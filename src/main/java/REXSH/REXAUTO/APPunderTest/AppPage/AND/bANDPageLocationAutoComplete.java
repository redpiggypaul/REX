 ...
 */
public class bANDPageLocationAutoComplete extends bANDPageTemplate {
    protected String fileName = "bANDPageLocationAutoComplete.json";
    ...
    private static String logSpace4thisPage = " --- bANDPageLocationAutoComplete --";
    ...
    public bANDPageLocationAutoComplete(AndroidDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public bANDPageLocationAutoComplete(AndroidDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public bANDPageLocationAutoComplete(String theFile, AndroidDriver theD, Log theLogger) throws Exception {
    ...
    public String btnOperationRoute(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperationRoute in bANDPageLocationAutoComplete has been called ~~~ +++");
        try {
    ...
    public void btnOperation(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperation in bANDPageLocationAutoComplete has been called ~~~ +++");
        try {
    ...
    public void textOperation(AndroidDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperation in bANDPageLocationAutoComplete has been called ~~~ +++");
        try {
    ...
    public String getElementContent(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The getElementContent in bANDPageLocationAutoComplete has been called ~~~ +++");
        try {
    ...
    public String textOperationWithSaveInput(AndroidDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperationWithSaveInput in bANDPageLocationAutoComplete has been called ~~~ +++");
        ...
        try {
            ...
            System.out.println(logSpace4thisPage + "In bANDPageLocationAutoComplete . textOperationWithSaveInput , Other Error appear : " + e.getCause());
            e.printStackTrace();
        } finally {
            return result;
        }
    ...
    public String autoCompleteOperation(AndroidDriver driver, String eleName, String extPara) throws Exception {  //TODO
        String defaultText = null;
        String selectItemValue = null;
        System.out.println("    +++ ~~~ The autoCompleteOperation in bANDPageLocationAutoComplete has been called ~~~ +++");
        ...
        try {
            ...
            defaultText = super.searchStart(driver, eleName, this.byMap, this.eleContentMap, this.path4Log, tempDefaultValue, extPara, true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            bANDPageLocationAutoComplete x = new bANDPageLocationAutoComplete("/PageXML/AND/bProfileEditPublication.xml", driver, null);

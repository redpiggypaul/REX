 ...
 */
public class bANDPageAccountDeleteConfirmWin extends bANDPageTemplate {
    protected String fileName = "bAccountDeleteConfirmWin.json";
    ...
    private static String logSpace4thisPage = " --- bANDPageAccountDeleteConfirmWin --";
    ...
    public boolean titleCheck(AndroidDriver driver) throws Exception {
        ...
        return super.titleCheckTe(driver, "confirmMessage", this.byMap, this.eleContentMap, this.content.eleTextContentMap, this.path4Log);
    }
    public bANDPageAccountDeleteConfirmWin(AndroidDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public bANDPageAccountDeleteConfirmWin(AndroidDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public bANDPageAccountDeleteConfirmWin(String theFile, AndroidDriver theD, Log theLogger) throws Exception {
    ...
    public String btnOperationRoute(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperationRoute in bANDPageAccountDeleteConfirmWin has been called ~~~ +++");
    ...
    public String getElementContent(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The getElementContent in bANDPageAccountDeleteConfirmWin has been called ~~~ +++");
    ...
    public void btnOperation(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperation in bANDPageAccountDeleteConfirmWin has been called ~~~ +++");
        super.btnOperation(driver, eleName, this.byMap);

    }

    public String checkAbnormalElement(AndroidDriver driver, String eleName) throws REXException {
        System.out.println("    +++ ~~~ The checkAbnormalElement in bANDPageAccountDeleteConfirmWin has been called ~~~ +++");
    ...
    public void textOperation(AndroidDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperationn in bANDPageAccountDeleteConfirmWin has been called ~~~ +++");
        ...
        try {
            if (type4check.equals("ready")) {       // ready mode
                ...
                } else if (para4check.equals("title")) // check title for ready mode
                {
                    ...
                    String[] temp = this.content.getContentNameList4name(this.eleContentMap, para4check);
                    if (temp.length != 1) {
                        flag = false;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            bANDPageAccountDeleteConfirmWin x = new bANDPageAccountDeleteConfirmWin("/PageXML/AND/loginPage.xml", driver, null);

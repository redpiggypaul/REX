 ...
 */
public class bANDPageAccDelErrorWin extends bANDPageTemplate {
    protected String fileName = "bAccDelErrorWin.json";
    ...
    public bANDPageAccDelErrorWin(AndroidDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public bANDPageAccDelErrorWin(AndroidDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public bANDPageAccDelErrorWin(String theFile, AndroidDriver theD, Log theLogger) throws Exception {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            bANDPageAccDelErrorWin x = new bANDPageAccDelErrorWin("/PageXML/AND/loginPage.xml", driver, null);

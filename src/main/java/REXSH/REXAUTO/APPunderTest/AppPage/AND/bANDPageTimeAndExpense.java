 ...
 */
public class bANDPageTimeAndExpense extends bANDPageTemplate {
    protected String fileName = "bTimeAndExpense.json";
    ...
    private static String logSpace4thisPage = " --- bANDPageTimeAndExpense --";
    ...
    public bANDPageTimeAndExpense(AndroidDriver theD) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public bANDPageTimeAndExpense(AndroidDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
        if (!autoOSType.toLowerCase().contains("windows")) {
            contentFilePath = new String(contentFilePath.replaceAll("\\\\", File.separator));
    ...
    public bANDPageTimeAndExpense(String theFile, AndroidDriver theD, Log theLogger) throws Exception {
    ...
    public String btnOperationRoute(AndroidDriver driver, String eleName) throws Exception { // elename may contains common 4 title, record 4 record under title
        System.out.println("    +++ ~~~ The btnOperationRoute in bANDPageTimeAndExpense has been called ~~~ +++");
    ...
    public String btnOperationRoute(AndroidDriver driver, String eleName, String key) throws Exception { // elename may contains common 4 title, record 4 record under title
        System.out.println("    +++ ~~~ The btnOperationRoute in bANDPageTimeAndExpense has been called ~~~ +++");
        String tempLocatorStr = null;
        String tempType = null;
        String result = null;
        ...
        try {
            ...
            if (!tempLocatorStr.contains(":REX")) {
                ...
                if (eleName.toLowerCase().contains("_record") && (recordType != null && recordLocatorStr != null) && (commonType != null && commonLocatorStr != null)) {  // 4 record
                    ...
                    if (commonType.equalsIgnoreCase("id") && recordType.equalsIgnoreCase("id")) {
                        keyMatchInTable = super.tableMatch(driver, eleName, this.byMap, this.eleContentMap, this.path4Log, index4XPATH, this.content.eleWaitStepMap, key, By.id(commonLocatorStr), By.id(recordLocatorStr));
    ...
    public String getElementContent(AndroidDriver driver, String eleName) throws Exception { // elename may contains common 4 title, record 4 record under title
        System.out.println("    +++ ~~~ The getElementContent in bANDPageTimeAndExpense has been called ~~~ +++");
        try {
    ...
    public String getElementContent(AndroidDriver driver, String eleName, String key) throws Exception { // elename may contains common 4 title, record 4 record under title
        try {
    ...
    public void btnOperation(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperation in bANDPageTimeAndExpense has been called ~~~ +++");
        try {
    ...
    public void textOperation(AndroidDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperation in bANDPageTimeAndExpense has been called ~~~ +++");
        try {
    ...
    public String textOperationWithSaveInput(AndroidDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperationWithSaveInput in bANDPageTimeAndExpense has been called ~~~ +++");
        try {
    ...
    public String dropDownListOperation(AndroidDriver driver, String eleName) throws Exception {  //TODO
        ...
        System.out.println("    +++ ~~~ The dropDownListOperation in bANDPageTimeAndExpense has been called ~~~ +++");
        try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            bANDPageTimeAndExpense x = new bANDPageTimeAndExpense("/PageXML/AND/bPageProfileEdit.xml", driver, null);

 ...
 */
public class bANDPageWithDrawInterest extends bANDPageTemplate {
    ...
    private static String logSpace4thisPage = " --- bANDPageWithDrawInterest --";
    ...
    public bANDPageWithDrawInterest(AndroidDriver theD, String p4L) throws Exception {
        super(theD);
        this.dr = theD;
    ...
    public bANDPageWithDrawInterest(String theFile, AndroidDriver theD, Log theLogger) throws Exception {
    ...
    public String btnOperationRoute(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperationRoute in bANDPageWithDrawInterest has been called ~~~ +++");
        try {
    ...
    public String calendarOperationTomorrow(AndroidDriver driver, String eleName) throws Exception {
        String result = null;
        String calendarValue = null;
        System.out.println("    +++ ~~~ The calendarOperationTomorrow in bANDPageWithDrawInterest has been called ~~~ +++");
        try {
            ...
            if (((String) comPageCheckResult).equals("pass")) {
                ...
                if (Integer.parseInt(defaultDay) != lastDayInt) {
                    ...
                    backMethod.invoke(tempIns, driver, "forwardBtn");
                    String tDayStr = this.tomorrow;
                    Object selectDateResult = chooseMethod.invoke(tempIns, driver, tDayStr); // chooseDateItem
                    if (selectDateResult.toString().equalsIgnoreCase("true")) {
                        Method saveMethod = tempClassType.getDeclaredMethod("saveDate", new Class[]{AndroidDriver.class, String.class, String.class});
    ...
    public String calendarOperation(AndroidDriver driver, String eleName) throws Exception {
        String result = null;
        String calendarValue = null;
        System.out.println("    +++ ~~~ The calendarOperation in bANDPageWithDrawInterest has been called ~~~ +++");
        try {
    ...
    public String calendarOperationDate(AndroidDriver driver, String eleName, String tDate) throws Exception {
        String result = null;
        System.out.println("    +++ ~~~ The calendarOperationDate in bANDPageWithDrawInterest has been called ~~~ +++");
        try {
    ...
    public String dropDownListOperation(AndroidDriver driver, String eleName) throws Exception {  //TODO
        ...
        System.out.println("    +++ ~~~ The dropDownListOperation in bANDPageWithDrawInterest has been called ~~~ +++");
        try {
    ...
    public void btnOperation(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The btnOperation in bANDPageWithDrawInterest has been called ~~~ +++");
        try {
    ...
    public void textOperation(AndroidDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperation in bANDPageWithDrawInterest has been called ~~~ +++");
        try {
    ...
    public String getElementContent(AndroidDriver driver, String eleName) throws Exception {
        System.out.println("    +++ ~~~ The getElementContent in bANDPageWithDrawInterest has been called ~~~ +++");
        try {
    ...
    public String textOperationWithSaveInput(AndroidDriver driver, String eleName, String para1) throws Exception {
        System.out.println("    +++ ~~~ The textOperationWithSaveInput in bANDPageWithDrawInterest has been called ~~~ +++");
        ...
        try {
            ...
            System.out.println(logSpace4thisPage + "In bANDPageWithDrawInterest . textOperationWithSaveInput , Other Error appear : " + e.getCause());
            e.printStackTrace();
        } finally {
            return result;
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            bANDPageWithDrawInterest x = new bANDPageWithDrawInterest("/PageXML/AND/bProfileEditPublication.xml", driver, null);

 ...
 */
public class AppTestShowInterestDrawOther extends AppTestTemplate {
    ...
    String[] TestStepList_RoleFilter_Interest_drawOther = new String[]{"login", "switch2SearchRole","Role_Filte_Interest", "Role_WithDraw_Interest"};
    ...
    public AppTestShowInterestDrawOther() throws FileNotFoundException {
    }

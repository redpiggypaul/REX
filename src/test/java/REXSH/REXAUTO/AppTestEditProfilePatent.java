 ...
 */
public class AppTestEditProfilePatent extends AppTestTemplate {
    ...
    String[] actionSeq_OnlyName = new String[]{"login", "switch2Profile", "clearProfile", "addPatentOnly_Name", "patent_profileSaveback2Profile", "addPatentOnly_Name_Check"};
    String[] actionSeq_OnlyNumber = new String[]{"login", "switch2Profile", "clearProfile", "addPatentOnly_Number", "patent_profileSaveback2Profile", "addPatentOnly_Number_Check"};
    String[] actionSeq_OnlyDate = new String[]{"login", "switch2Profile", "clearProfile", "addPatentOnly_Date", "patent_profileSaveback2Profile", "addPatentOnly_Date_Check"};
    String[] actionSeq_FocusName = new String[]{"login", "switch2Profile", "clearProfile", "addPatentFocus_Name", "patent_profileSaveback2Profile", "addPatentFocus_Name_Check"};
    String[] actionSeq_FocusNumber = new String[]{"login", "switch2Profile", "clearProfile", "addPatentFocus_Number", "patent_profileSaveback2Profile", "addPatentFocus_Number_Check"};
    ...
    @DataProvider
    public Object[][] profileEditPatentAll() {
        return new Object[][]{
                {this.accontFromXls, this.accontPSWFromXls, "abc::sample1", "regular", ""},
                {this.accontFromXls, this.accontPSWFromXls, "12313131312::nnnn", "regular", ""},

        };
    }

    public AppTestEditProfilePatent() throws FileNotFoundException {
    }
    ...
    public void addPatentOnlyName(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
    ...
    @Test(dataProvider = "profileEditPatent")
    public void addPatentOnlyNumber(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
        ...
        try {
            ...
            BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);  // 2nd para is for os type, last para is the excepted result str
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.actionSeq_OnlyNumber, para4Action);   // 2nd para is the action sequence
            }else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.actionSeq_OnlyNumber, para4Action, mobileOS);     // 2nd para is the action sequence
            }
            Thread.sleep(1000);
            System.out.println("Here is the result for this case : " + theAction.getExeResult());
    ...
    @Test(dataProvider = "profileEditPatent")
    public void addPatentOnlyDate(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
        ...
        try {
            ...
            BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);  // 2nd para is for os type, last para is the excepted result str
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.actionSeq_OnlyDate, para4Action);   // 2nd para is the action sequence
            }else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.actionSeq_OnlyDate, para4Action, mobileOS);     // 2nd para is the action sequence
            }
            Thread.sleep(1000);
            System.out.println("Here is the result for this case : " + theAction.getExeResult());
    ...
    @Test(dataProvider = "profileEditPatentAll")
    public void addPatentFocusName(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
        date = new Date();
    ...
    @Test(dataProvider = "profileEditPatentAll")
    public void addPatentFocusNumber(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
        date = new Date();
        ...
        try {
            ...
            BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);  // 2nd para is for os type, last para is the excepted result str
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.actionSeq_FocusNumber, para4Action);   // 2nd para is the action sequence
            }else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.actionSeq_FocusNumber, para4Action, mobileOS);     // 2nd para is the action sequence
            }
            Thread.sleep(1000);
            System.out.println("Here is the result for this case : " + theAction.getExeResult());

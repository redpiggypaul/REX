 ...
 */
public class BasicResetPSW extends AppTestTemplate {
    ...
    String[] TestStepList_Normal_PSW_Check = new String[]{"IOSchangePSW", "IOSchangePSWConfirm"};
    String[] TestStepList_Normal_PSW_CheckNotice = new String[]{"IOSchangePSWnotice", "IOSchangePSWConfirmNotice"};
    String[] TestStepList_Normal_Regist = new String[]{"IOSregist", "IOSregistConfirm"};

    public BasicResetPSW() throws FileNotFoundException {
    }
    ...
    @DataProvider
    public Object[][] normalPSW_notice() {
        return new Object[][]{
                {"email" + shortTStr + "@good.com::Pwcwelcome1::Pwcwelcome1", "regular", "Don't see the email?::Check your spam folder or resend after 5 minutes."},
        };
    }

    @DataProvider
    public Object[][] normalPSW() {
        return new Object[][]{
                {"email" + shortTStr + "@good.com::Pwcwelcome1::Pwcwelcome1", "regular", ""},
        };
    }
    ...
    public void accountLogout(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        ...
        try {
            ...
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.TestStepList_Account_logout, para4Action);
    ...
    @Test(dataProvider = "normalPSW", dependsOnMethods = {"accountLogout"})
    public void normalChangePSW(String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
        ...
        try {
            ...
            BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);  // 2nd para is for os type, last para is the excepted result str
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.TestStepList_Normal_PSW_Check, para4Action); // 2nd para is the action sequence
            } else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.TestStepList_Normal_PSW_Check, para4Action, mobileOS);     // 2nd para is the action sequence
            }
            Thread.sleep(2000);
            System.out.println("Here is the result for this case : " + theAction.getExeResult());
    ...
    @Test(dataProvider = "normalPSW_notice", dependsOnMethods = {"accountLogout"})
    public void normalChangePSW_notice(String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
        ...
        try {
            ...
            BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);  // 2nd para is for os type, last para is the excepted result str
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.TestStepList_Normal_PSW_CheckNotice, para4Action); // 2nd para is the action sequence
            } else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.TestStepList_Normal_PSW_CheckNotice, para4Action, mobileOS);     // 2nd para is the action sequence
            }
            Thread.sleep(2000);
            System.out.println("Here is the result for this case : " + theAction.getExeResult());

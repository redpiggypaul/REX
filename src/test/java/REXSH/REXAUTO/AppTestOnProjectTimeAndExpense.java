 ...
 */
public class AppTestOnProjectTimeAndExpense extends AppTestTemplate {
    ...
    String[] TestStepList_addMoreCarRentalExpense = new String[]{"login", "addMoreExpense", "addExpense", "addExpenseEntry", "addExpenseEntry_Check"};
    ...
    public AppTestOnProjectTimeAndExpense() throws FileNotFoundException {
    }

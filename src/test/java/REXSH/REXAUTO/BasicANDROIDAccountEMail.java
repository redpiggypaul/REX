 ...
 */
public class BasicANDROIDAccountEMail extends AppTestTemplate {
    ...
    public BasicANDROIDAccountEMail() throws FileNotFoundException {
    }
    ...
    public Object[][] accountEmail() {
        return new Object[][]{
                {this.accontFromXls, this.accontPSWFromXls, "try163.com", "invalid", ""},
                {this.accontFromXls, this.accontPSWFromXls, "try@163.com", "emptycontent", ""},
                {this.accontFromXls, this.accontPSWFromXls, this.accontFromXls, "emptycontent", ""},
        };
    }

 ...
 */
public class BasicEditProfileCertificationANDlicense extends AppTestTemplate {
    ...
    public Object[][] profileEditCertificationAll() {
        return new Object[][]{
                ...
                {this.accontFromXls, this.accontPSWFromXls, "12313131312::sql", "regular", ""},
    ...
    public Object[][] profileEditCertificationAllsearch() {
        return new Object[][]{
                ...
                {this.accontFromXls, this.accontPSWFromXls, "sql::uSD", "regular", ""},

        };
    }

    public BasicEditProfileCertificationANDlicense() throws FileNotFoundException {
    }

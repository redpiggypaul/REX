 ...
 */
public class BasicEditProfileAward extends AppTestTemplate {
    ...
    @DataProvider
    public Object[][] profileEditAwardAlldate() {
        return new Object[][]{
                {this.accontFromXls, this.accontPSWFromXls, "abc::sample1::22", "regular", "" },
                {this.accontFromXls, this.accontPSWFromXls, "12313131312:::uuu#$%::22", "regular", "" },

        };
    }

    public BasicEditProfileAward() throws FileNotFoundException {
    }

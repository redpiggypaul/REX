 ...
 */
public class BasicAndroidResetPSW extends AppTestTemplate {
    ...
    public BasicAndroidResetPSW() throws FileNotFoundException {
    }
    ...
    public void normalChangePSW(String paraGroup, String targetResult, String expectResult) throws Exception {
        ...
        try {
            ...
            if (mobileOS.equalsIgnoreCase("Android")) {
                ...
                throw new REXException("This method is ONLY for Android");  // 2nd para is the action sequence
            }
            Thread.sleep(2000);

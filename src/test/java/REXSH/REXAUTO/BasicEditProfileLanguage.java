 ...
 */
public class BasicEditProfileLanguage extends AppTestTemplate {
    ...
    @DataProvider
    public Object[][] profileEditLanguage() {
        return new Object[][]{
                {this.accontFromXls, this.accontPSWFromXls, "Japanese", "regular", ""},
                {this.accontFromXls, this.accontPSWFromXls, "java", "regular", ""},
                {this.accontFromXls, this.accontPSWFromXls, "german", "regular", ""},
        };
    }


    public BasicEditProfileLanguage() throws FileNotFoundException {
    }
    ...
    @Test(dataProvider = "profileEditLanguage")
    public void addLanguage(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;

 ...
 */
public class AppTestEditProfileSummaryNew extends AppTestTemplate {
    ...
    String[] actionSeq_All_Summary = new String[]{"login", "switch2Profile", "clearProfile", "editProfileSummary"};

    @DataProvider
    public Object[][] profileEditGroup() {
        return new Object[][]{
                ...
                //     {this.extResumeAccount, this.extResumeAccountPSW, "abc 123 $%@$", "regular", ""},                                        //
                //    {this.extResumeAccount, this.extResumeAccountPSW, "~!@#$%^&*()_+{}|:\"<>?,./;'[]\\\\-=", "regular", ""},                 //
                //    {this.extResumeAccount, this.extResumeAccountPSW, "你好", "regular", ""},                                                //
                //    {this.extResumeAccount, this.extResumeAccountPSW, "你好 阿斯顿", "regular", ""},                                          //
                //     {this.extResumeAccount, this.extResumeAccountPSW, "你好 saf &^Z*7234&%()", "regular", ""},                               //
                //    {this.extResumeAccount, this.extResumeAccountPSW, "1ad \n 12dasd", "regular", ""},                                      //
                //    {this.extResumeAccount, this.extResumeAccountPSW, "just4cleanText", "regular", ""},
                //    {this.extResumeAccount, this.extResumeAccountPSW, "daag \n \n", "err"},                                         //
                //  {this.extResumeAccount, this.extResumeAccountPSW, "just4cleanText", "regular", ""},
                //    {this.extResumeAccount, this.extResumeAccountPSW, "daag \n \n    123ad", "regular", ""},
                {this.accontFromXls, this.accontPSWFromXls, "512chars___end", "regular", ""},   // 512 chars

                //{this.extResumeAccount, this.extResumeAccountPSW, "256chars__ppoiuytrewqasdfghjklmnbvcxz1qazxsw23edcvf1234567890poiuytrewqasdfghjklmnbvcxz1qazxsw23edcvf1234567890poiuytrewqasdfghjklmnbvcxz1qazxsw23edcvf1234567890poiuytrewqasdfghjklmnbvcxz1qazxsw23edcvf1234567890poiuytrewqasdfghjklmnbvcxz1qazxsw23edcvf123456", "regular", ""},   // 256 chars
              //  {this.extResumeAccount, this.extResumeAccountPSW, "500chars__", "regular", ""},   // 500 chars
        };
    }


    public AppTestEditProfileSummaryNew() throws FileNotFoundException {
    }
    ...
    @Test(dataProvider = "profileEditGroup")
    public void actionSeq_All_Summary(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        ...
        try {
            ...
            //  theAction.comOperationInAND(driver, actionSeq_All_Summary, para4Action);
            ...
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.actionSeq_All_Summary, para4Action);   // 2nd para is the action sequence
            }else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.actionSeq_All_Summary, para4Action, mobileOS);    // 2nd para is the action sequence
            }
            Thread.sleep(2000);

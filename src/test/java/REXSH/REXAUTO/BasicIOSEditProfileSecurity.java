 ...
 */
public class BasicIOSEditProfileSecurity extends AppTestTemplate {
    ...
    //String[] TestStepList_set_Security = new String[]{"login", "switch2Profile","Security_Check"};
    String[] TestStepList_set_Security = new String[]{"login", "switch2Profile", "clearProfile", "addSecurity", "profileSaveback2Profile", "Security_Check"};

    public BasicIOSEditProfileSecurity() throws FileNotFoundException {
    }

    @DataProvider
    public Object[][] accountEmail() {
        return new Object[][]{
                {this.accontFromXls, this.accontPSWFromXls, "Public Trust Position", "regular", ""},
        };
    }
    ...
    public void change_security(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        ...
        try {
            ...
            if (mobileOS.equalsIgnoreCase("Android")) {
                ...
                theAction.comOperationInIOS((IOSDriver) driver, this.TestStepList_set_Security, para4Action, mobileOS);     // 2nd para is the action sequence
            }
            Thread.sleep(2000);

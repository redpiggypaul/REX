 ...
 */
public class AppTestEditProfileLanguage extends AppTestTemplate {
    ...
    public Object[][] profileEditLanguage() {
        return new Object[][]{
                {this.accontFromXls, this.accontPSWFromXls, "Ja", "regular", ""},
                {this.accontFromXls, this.accontPSWFromXls, "java", "regular", ""},
                {this.accontFromXls, this.accontPSWFromXls, "g", "regular", ""},
        };
    }


    public AppTestEditProfileLanguage() throws FileNotFoundException {
    }

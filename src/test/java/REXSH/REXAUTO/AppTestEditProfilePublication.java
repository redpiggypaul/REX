 ...
 */
public class AppTestEditProfilePublication extends AppTestTemplate {
    ...
    String[] actionSeq_OnlyTitle = new String[]{"login", "switch2Profile", "clearProfile", "addPublicationOnlyTitle", "publication_profileSaveback2Profile", "addPublicationOnlyTitleCheck"};
    String[] actionSeq_OnlyName = new String[]{"login", "switch2Profile", "clearProfile", "addPublicationOnly_Name", "publication_profileSaveback2Profile", "addPublicationOnly_Name_Check"};
    String[] actionSeq_OnlyURL = new String[]{"login", "switch2Profile", "clearProfile", "addPublicationOnly_URL", "publication_profileSaveback2Profile", "addPublicationOnly_URL_Check"};
    String[] actionSeq_FocusTitle = new String[]{"login", "switch2Profile", "clearProfile", "addPublicationFocus_Title", "publication_profileSaveback2Profile", "addPublicationFocus_Title_Check"};
    String[] actionSeq_FocusName = new String[]{"login", "switch2Profile", "clearProfile", "addPublicationFocus_Name", "publication_profileSaveback2Profile", "addPublicationFocus_Name_Check"};
    String[] actionSeq_FocusURL = new String[]{"login", "switch2Profile", "clearProfile", "addPublicationFocus_URL", "publication_profileSaveback2Profile", "addPublicationFocus_URL_Check"};
    String[] actionSeq_All_FocusTitle = new String[]{"login", "switch2Profile", "clearProfile", "addPublication_CheckAll_Focus_Title", "publication_profileSaveback2Profile", "addPublication_CheckAll_Focus_Title_Check"};
    String[] actionSeq_All_FocusName = new String[]{"login", "switch2Profile", "clearProfile", "addPublication_CheckAll_Focus_Name", "publication_profileSaveback2Profile", "addPublication_CheckAll_Focus_Name_Check"};
    String[] actionSeq_All_FocusURL = new String[]{"login", "switch2Profile", "clearProfile", "addPublication_CheckAll_Focus_URL", "publication_profileSaveback2Profile", "addPublication_CheckAll_Focus_URL_Check"};
    String[] actionSeq_All_FocusDesc = new String[]{"login", "switch2Profile", "clearProfile", "addPublication_CheckAll_Focus_Desc", "publication_profileSaveback2Profile", "addPublication_CheckAll_Focus_Desc_Check"};

    @DataProvider
    public Object[][] profileEditPublication() {
        return new Object[][]{
    ...
    @DataProvider
    public Object[][] profileEditPublicationAll() {
        return new Object[][]{
                {this.accontFromXls, this.accontPSWFromXls, "abc::sample1::sample2::des", "regular", ""},
                {this.accontFromXls, this.accontPSWFromXls, "12313131312::nnnn::uuurl/asdf#$!FSD#$%::des13#$%^&*()*&^$%{}|}|:<>>?>!@~", "regular", ""},

        };
    }

    public AppTestEditProfilePublication() throws FileNotFoundException {
    }
    ...
    @Test(dataProvider = "profileEditPublication")
    public void addPublicationOnlyTitle(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
    ...
    @Test(dataProvider = "profileEditPublication")
    public void addPublicationOnlyName(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
        ...
        try {
            ...
            BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);  // 2nd para is for os type, last para is the excepted result str
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.actionSeq_OnlyName, para4Action);   // 2nd para is the action sequence
            }else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.actionSeq_OnlyName, para4Action, mobileOS);     // 2nd para is the action sequence
            }
            Thread.sleep(1000);
            System.out.println("Here is the result for this case : " + theAction.getExeResult());
    ...
    @Test(dataProvider = "profileEditPublication")
    public void addPublicationOnlyURL(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
        ...
        try {
            //   BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);
            //   theAction.comOperationInAND(driver, actionSeq_OnlyURL, para4Action);
            BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);  // 2nd para is for os type, last para is the excepted result str
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.actionSeq_OnlyURL, para4Action);   // 2nd para is the action sequence
            }else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.actionSeq_OnlyURL, para4Action, mobileOS);    // 2nd para is the action sequence
            }
            Thread.sleep(1000);
            System.out.println("Here is the result for this case : " + theAction.getExeResult());
    ...
    @Test(dataProvider = "profileEditPublicationAll")
    public void addPublicationFocusTitle(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
        date = new Date();
    ...
    @Test(dataProvider = "profileEditPublicationAll")
    public void addPublicationFocusName(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
        date = new Date();
        ...
        try {
            ...
            BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);  // 2nd para is for os type, last para is the excepted result str
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.actionSeq_FocusName, para4Action);   // 2nd para is the action sequence
            }else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.actionSeq_FocusName, para4Action, mobileOS);     // 2nd para is the action sequence
            }
            Thread.sleep(1000);
            System.out.println("Here is the result for this case : " + theAction.getExeResult());
    ...
    @Test(dataProvider = "profileEditPublicationAll")
    public void addPublicationFocusURL(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
        date = new Date();
        ...
        try {
            //   BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);
            //   theAction.comOperationInAND(driver, actionSeq_FocusURL, para4Action);
            BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);  // 2nd para is for os type, last para is the excepted result str
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.actionSeq_FocusURL, para4Action);   // 2nd para is the action sequence
            }else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.actionSeq_FocusURL, para4Action, mobileOS);      // 2nd para is the action sequence
            }
            Thread.sleep(1000);
            System.out.println("Here is the result for this case : " + theAction.getExeResult());
    ...
    @Test(dataProvider = "profileEditPublicationAll")
    public void addPublicationAllFocusTitle(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
        date = new Date();
    ...
    @Test(dataProvider = "profileEditPublicationAll")
    public void addPublicationAllFocusName(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
        date = new Date();
        ...
        try {
            ...
            BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);  // 2nd para is for os type, last para is the excepted result str
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.actionSeq_All_FocusName, para4Action);   // 2nd para is the action sequence
            }else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.actionSeq_All_FocusName, para4Action, mobileOS);     // 2nd para is the action sequence
            }
            Thread.sleep(1000);
            System.out.println("Here is the result for this case : " + theAction.getExeResult());
    ...
    @Test(dataProvider = "profileEditPublicationAll")
    public void addPublicationAllFocusURL(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
        date = new Date();
        ...
        try {
            //  BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);
            //  theAction.comOperationInAND(driver, actionSeq_All_FocusURL, para4Action);
            BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);  // 2nd para is for os type, last para is the excepted result str
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.actionSeq_All_FocusURL, para4Action);   // 2nd para is the action sequence
            }else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.actionSeq_All_FocusURL, para4Action, mobileOS);     // 2nd para is the action sequence
            }
            Thread.sleep(1000);
            System.out.println("Here is the result for this case : " + theAction.getExeResult());
    ...
    @Test(dataProvider = "profileEditPublicationAll")
    public void addPublicationAllFocusDesc(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
        date = new Date();
        ...
        try {
            //  BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);
            //  theAction.comOperationInAND(driver, actionSeq_All_FocusDesc, para4Action);
            BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);  // 2nd para is for os type, last para is the excepted result str
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.actionSeq_All_FocusDesc, para4Action);   // 2nd para is the action sequence
            }else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.actionSeq_All_FocusDesc, para4Action, mobileOS);    // 2nd para is the action sequence
            }
            Thread.sleep(1000);
            System.out.println("Here is the result for this case : " + theAction.getExeResult());

 ...
 */
public class BasicEditProfilePublication extends AppTestTemplate {
    ...
    String[] actionSeq_All_withdate = new String[]{"login", "switch2Profile", "clearProfile", "addPublication_CheckAll_Focus_Desc", "publication_profileSaveback2Profile", "addPublication_CheckAll_Focus_Desc_Check"};
    ...
    public Object[][] profileEditPublicationAll() {
        return new Object[][]{
                ...
                {this.accontFromXls, this.accontPSWFromXls, "12313131312::nnnn::uuurl/asdf#$ !F!SD#$%::des13#$%^&*()*&^$%{}|}|:?!@~", "regular", ""},

        };
    }

    @DataProvider
    public Object[][] profileEditPublicationAllwithDate() {
        return new Object[][]{
                {this.accontFromXls, this.accontPSWFromXls, "abc::sample1::sample2::des::" + this.startdate, "regular", ""},
                {this.accontFromXls, this.accontPSWFromXls, "12313131312::nnnn::uuurl/asdf#$!FSD#$%::des13#$%::" + this.startdate, "regular", ""},

        };
    }

    public BasicEditProfilePublication() throws FileNotFoundException {
    }
    ...
    @Test(dataProvider = "profileEditPublicationAllwithDate")
    public void addPublicationAllwithDate(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;

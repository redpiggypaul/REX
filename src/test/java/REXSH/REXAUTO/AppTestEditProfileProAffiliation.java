 ...
 */
public class AppTestEditProfileProAffiliation extends AppTestTemplate {
    ...
    String[] actionSeq_OnlyName = new String[]{"login", "switch2Profile", "clearProfile", "addProAffiliationOnly_Name", "proAffiliation_profileSaveback2Profile", "addProAffiliationOnly_Name_Check" };
    String[] actionSeq_OnlyPosition = new String[]{"login", "switch2Profile", "clearProfile", "addProAffiliationOnly_Position", "proAffiliation_profileSaveback2Profile", "addProAffiliationOnly_Position_Check" };
    String[] actionSeq_FocusName = new String[]{"login", "switch2Profile", "clearProfile", "addProAffiliationFocus_Name", "proAffiliation_profileSaveback2Profile", "addProAffiliationFocus_Name_Check" };
    String[] actionSeq_FocusPosition = new String[]{"login", "switch2Profile", "clearProfile", "addProAffiliationFocus_Position", "proAffiliation_profileSaveback2Profile", "addProAffiliationFocus_Position_Check" };
    String[] actionSeq_All_FocusName = new String[]{"login", "switch2Profile", "clearProfile", "addProAffiliation_CheckAll_Focus_Name", "proAffiliation_profileSaveback2Profile", "addProAffiliation_CheckAll_Focus_Name_Check" };
    ...
    String[] actionSeq_All_WrongDate = new String[]{"login", "switch2Profile", "clearProfile", "addProAffiliation_FillAll_WrongDate", "proAffiliation_profileSaveback2Profile", "addProAffiliation_FillAll_WrongDate_Check" };

    @DataProvider
    public Object[][]
    profileEditProAWrongDate() {
        return new Object[][]{
                {this.accontFromXls, this.accontPSWFromXls, "name::info::" + this.ab_startdate + "::" + this.ab_enddate, "step save error page proaff", "" },
                {this.accontFromXls, this.accontPSWFromXls, "name::info::" + this.startdate + "::" + this.enddate, "regular", "" },
    ...
    @DataProvider
    public Object[][] profileEditProAff() {
        return new Object[][]{
    ...
    @DataProvider
    public Object[][] profileEditProAffAll() {
        return new Object[][]{
                {this.accontFromXls, this.accontPSWFromXls, "abc::sample1", "regular", "" },
                {this.accontFromXls, this.accontPSWFromXls, "12313131312::nnn", "regular", "" },

        };
    }

    public AppTestEditProfileProAffiliation() throws FileNotFoundException {
    }
    ...
    @Test(dataProvider = "profileEditProAWrongDate")
    public void addProAffiliationCheckDate(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        ...
        try {
            ...
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.actionSeq_All_WrongDate, para4Action);   // 2nd para is the action sequence
            }else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.actionSeq_All_WrongDate, para4Action, mobileOS);    // 2nd para is the action sequence
            }
            ;
            Thread.sleep(2000);
    ...
    //@Test(dataProvider = "profileEditProAff")
    public void addProAffiliationOnlyName(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
    ...
    //@Test(dataProvider = "profileEditProAff")
    public void addProAffiliationOnlyPosition(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
        ...
        try {
            //       BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);
            //       theAction.comOperationInAND(driver, actionSeq_OnlyPosition, para4Action);
            BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);  // 2nd para is for os type, last para is the excepted result str
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.actionSeq_OnlyPosition, para4Action);   // 2nd para is the action sequence
            }else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.actionSeq_OnlyPosition, para4Action, mobileOS);    // 2nd para is the action sequence
            }
            Thread.sleep(1000);
            System.out.println("Here is the result for this case : " + theAction.getExeResult());
    ...
    //@Test(dataProvider = "profileEditProAffAll")
    public void addProAffiliationFocusName(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
    ...
    //@Test(dataProvider = "profileEditProAffAll")
    public void addProAffiliationFocusPosition(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
        date = new Date();
        ...
        try {
            //     BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);
            //     theAction.comOperationInAND(driver, actionSeq_FocusPosition, para4Action);
            BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);  // 2nd para is for os type, last para is the excepted result str
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.actionSeq_FocusPosition, para4Action);   // 2nd para is the action sequence
            }else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.actionSeq_FocusPosition, para4Action, mobileOS);    // 2nd para is the action sequence
            }
            Thread.sleep(1000);
            System.out.println("Here is the result for this case : " + theAction.getExeResult());
    ...
    //@Test(dataProvider = "profileEditProAffAll")
    public void addProAffiliationAllFocusName(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
        date = new Date();
    ...
    //@Test(dataProvider = "profileEditProAffAll")
    public void addProAffiliationAllFocusPosition(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
        date = new Date();
        ...
        try {
            //   BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);
            //    theAction.comOperationInAND(driver, actionSeq_All_FocusPosition, para4Action);
            BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);  // 2nd para is for os type, last para is the excepted result str
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.actionSeq_All_FocusPosition, para4Action);   // 2nd para is the action sequence
            }else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.actionSeq_All_FocusPosition, para4Action, mobileOS);     // 2nd para is the action sequence
            }
            Thread.sleep(1000);
            System.out.println("Here is the result for this case : " + theAction.getExeResult());

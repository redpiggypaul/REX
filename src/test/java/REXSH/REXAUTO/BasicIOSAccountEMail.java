 ...
 */
public class BasicIOSAccountEMail extends AppTestTemplate {
    ...
    public BasicIOSAccountEMail() throws FileNotFoundException {
    }

    @DataProvider
    public Object[][] accountEmail() {
        return new Object[][]{
                {this.accontFromXls, this.accontPSWFromXls, "trASDy@163.com", "regular", ""},
                {this.accontFromXls, this.accontPSWFromXls, "trASDy163.com", "Invalid", ""},
        };
    }

 ...
 */
public class AppTestShowInterestDrawOtherCom extends AppTestTemplate {
    ...
    String[] TestStepList_RoleFilter_Interest_drawOther = new String[]{"login", "switch2SearchRole", "Role_Filte_Interest", "Role_WithDraw_InterestOtherComments"};
    ...
    public Object[][] emptyResult() {
        return new Object[][]{
                {this.accontFromXls, this.accontPSWFromXls, "Other::comasd asf213", "regular", ""},
        };
    ...
    public AppTestShowInterestDrawOtherCom() throws FileNotFoundException {
    }
    ...
    public void searchRoleInterest(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        ...
        try {
            ...
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.TestStepList_RoleFilter_Interest_drawOther, para4Action);   // 2nd para is the action sequence
            } else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.TestStepList_RoleFilter_Interest_drawOther, para4Action, mobileOS);     // 2nd para is the action sequence
            }
            Thread.sleep(1000);

 ...
 */
public class BasicEditProfileLinkURL extends AppTestTemplate {
    ...
    String[] actionSeq_Sample = new String[]{"login", "switch2Profile", "clearProfile", "addLink", "linkURL_profileSaveback2Profile", "addLink_Check"};
    String[] actionSeq_Sample_ios = new String[]{"login", "switch2Profile", "clearProfile", "ios_addLink", "linkURL_profileSaveback2Profile", "addLink_Check"};
    String[] UI_pageCheck = new String[]{"login", "switch2Profile", "clearProfile", "addLink", "linkURL_profileSaveback2Profile", "addLink_Check"};

    @DataProvider
    public Object[][] profileEditLinkURL() {
        return new Object[][]{
                {this.accontFromXls, this.accontPSWFromXls, "httpwww.link.com", "regular", ""},
    ...
    public BasicEditProfileLinkURL() throws FileNotFoundException {
    }
    ...
    @Test(dataProvider = "profileEditLinkURL")
    public void profileEditLinkURL(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        ...
        try {
            ...
            if (mobileOS.equalsIgnoreCase("Android")) {
                ...
                System.out.println("This case is blocked by org.openqa.selenium.WebDriverException: Cannot set value on invalid element ");   // 2nd para is the action sequence
            }
            Thread.sleep(2000);

 ...
 */
public class BasicEditProfileWorkExp extends AppTestTemplate {
    ...
    profileEditWorkWrongDate() {
        return new Object[][]{
                {this.accontFromXls, this.accontPSWFromXls, "com::maj::loc::" + this.ab_startdate + "::" + this.ab_enddate + "::desc", "step savebtn ProfileEditWorkExp", "" },
                {this.accontFromXls, this.accontPSWFromXls, "com::maj::loc::" + this.startdate + "::" + this.enddate + "::desc", "regular", "" },
    ...
    public BasicEditProfileWorkExp() throws FileNotFoundException {
    }
    ...
    public void addWorkWrongDate(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        ...
        try {
            ...
            if (mobileOS.equalsIgnoreCase("Android")) {
                ...
                throw new REXException("This method is ONLY for Android");
            }
            Thread.sleep(2000);

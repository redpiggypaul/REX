 ...
 */
public class AppTestEditProfileTitleNew extends AppTestTemplate {
    ...
    String[] actionSeq_All_Title = new String[]{"login", "switch2Profile", "clearProfile", "editProfileTitle"};
    ...
    public Object[][] profileEditGroup() {
        return new Object[][]{
                ...
                //  {this.extResumeAccount, this.extResumeAccountPSW, "just4cleanText", "regular", ""},
                //    {this.extResumeAccount, this.extResumeAccountPSW, "daag \n \n    123ad", "regular", ""},
                {this.accontFromXls, this.accontPSWFromXls, "250chars__ppoiuytrewqasdfghjklmnbvcxz1qazxsw23edcvf1234567890poiuytrewqasdfghjklmnbvcxz1qazxsw23edcvf1234567890poiuytrewqasdfghjklmnbvcxz1qazxsw23edcvf1234567890poiuytrewqasdfghjklmnbvcxz1qazxsw23edcvf1234567890poiuytrewqasdfghjklmnbvcxz1qazxsw23_end", "regular", ""},   // 250 chars

                //    {this.extResumeAccount, this.extResumeAccountPSW, "255chars__ppoiuytrewqasdfghjklmnbvcxz1qazxsw23edcvf1234567890poiuytrewqasdfghjklmnbvcxz1qazxsw23edcvf1234567890poiuytrewqasdfghjklmnbvcxz1qazxsw23edcvf1234567890poiuytrewqasdfghjklmnbvcxz1qazxsw23edcvf1234567890poiuytrewqasdfghjklmnbvcxz1qazxsw23edcvf12345", "regular", ""},   // 255 chars
    ...
    public AppTestEditProfileTitleNew() throws FileNotFoundException {
    }
    ...
    public void actionSeq_All_Title(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        ...
        try {
            ...
            //  theAction.comOperationInAND(driver, actionSeq_All_Title, para4Action);
            ...
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.actionSeq_All_Title, para4Action);   // 2nd para is the action sequence
            }else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.actionSeq_All_Title, para4Action, mobileOS);   // 2nd para is the action sequence
            }
            Thread.sleep(2000);

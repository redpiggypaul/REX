 ...
 */
public class BasicEditProfileMilitary extends AppTestTemplate {
    ...
    @DataProvider
    public Object[][] profileMilitaryDate() {
        return new Object[][]{
                {this.accontFromXls, this.accontPSWFromXls, "lut::Army::"+this.startdate+"::"+this.enddate, "regular", ""},
                {this.accontFromXls, this.accontPSWFromXls, "cap::Navy::"+this.startdate+"::"+this.enddate, "regular", ""},
        };
    }

    @DataProvider
    public Object[][] profileMilitaryWrongDate() {
        return new Object[][]{
                {this.accontFromXls, this.accontPSWFromXls, "lut::Army::"+this.ab_startdate+"::"+this.ab_enddate, "savebtn error, test failed profileeditmilitaryservice", ""},
        };
    }

    @DataProvider
    public Object[][] profileMilitaryWrongDate_Present() {
        return new Object[][]{
                {this.accontFromXls, this.accontPSWFromXls, "lut::Army::"+this.ab_startdate+"::"+this.ab_enddate, "regular", ""},
                {this.accontFromXls, this.accontPSWFromXls, "cap::Navy::"+this.startdate+"::"+this.enddate, "regular", ""},
        };
    }

    public BasicEditProfileMilitary() throws FileNotFoundException {
    }

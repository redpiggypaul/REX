 ...
 */
public class BasicEditProfileReference extends AppTestTemplate {
    ...
    String[] addReference_CheckAll_Focus_Name_remove = new String[]{"login", "switch2Profile", "clearProfile", "addReferenceOnly_Company", "reference_profileSaveback2Profile", "addReferenceOnly_Company_Check", "reference_profileDelete"};


    public BasicEditProfileReference() throws FileNotFoundException {
    }
    ...
    public Object[][] profileEditRef() {
        return new Object[][]{
                ...
                //   {this.extResumeAccount, this.extResumeAccountPSW, "abc", "Step:NaviBarBtn Error, Test failed at page:bandpagehome", ""},
    ...
    public void addReference_CheckAll_Focus_Name_delete(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        ...
        try {
            ...
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.addReference_CheckAll_Focus_Name_remove, para4Action);   // 2nd para is the action sequence
            }else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.addReference_CheckAll_Focus_Name_remove, para4Action, mobileOS);     // 2nd para is the action sequence
            }
            Thread.sleep(6000);

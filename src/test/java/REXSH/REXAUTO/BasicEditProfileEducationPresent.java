 ...
 */
public class BasicEditProfileEducationPresent extends AppTestTemplate {
    ...
    String[] actionSeq_FillAll_WrongDate_add1timePresent = new String[]{"login", "switch2Profile", "clearProfile", "addEducation_FillAll_WrongDate", "addEducation_1time_Present", "education_profileSaveback2Profile", "addEducation_FillAll_WrongDate_Check"};
    String[] actionSeq_FillAll_WrongDate_add2timePresent = new String[]{"login", "switch2Profile", "clearProfile", "addEducation_FillAll_WrongDate", "addEducation_2time_Present", "education_profileSaveback2Profile", "addEducation_FillAll_WrongDate_Check"};
    String[] actionSeq_FillAll_WrongDate_add3timePresent = new String[]{"login", "switch2Profile", "clearProfile", "addEducation_FillAll_WrongDate", "addEducation_3time_Present", "education_profileSaveback2Profile", "addEducation_FillAll_WrongDate_Check"};


    String[] actionSeq_FillAll_WrongDate_present_add1timePresent = new String[]{"login", "switch2Profile", "clearProfile", "addEducation_FillAll_WrongDate_Present", "addEducation_1time_Present", "education_profileSaveback2Profile", "addEducation_FillAll_WrongDate_Present_Check"};
    String[] actionSeq_FillAll_WrongDate_present_add2timePresent = new String[]{"login", "switch2Profile", "clearProfile", "addEducation_FillAll_WrongDate_Present", "addEducation_2time_Present", "education_profileSaveback2Profile", "addEducation_FillAll_WrongDate_Present_Check"};
    String[] actionSeq_FillAll_WrongDate_present_add3timePresent = new String[]{"login", "switch2Profile", "clearProfile", "addEducation_FillAll_WrongDate_Present", "addEducation_3time_Present", "education_profileSaveback2Profile", "addEducation_FillAll_WrongDate_Present_Check"};

    @DataProvider
    public Object[][]
    profileEditEducationWrongDate() {
        return new Object[][]{
                {this.accontFromXls, this.accontPSWFromXls, "sc::maj::loc::" + this.ab_startdate + "::" + this.ab_enddate, "save error ", ""},
    ...
    @DataProvider
    public Object[][]
    profileEditEducationWrongDateadd1present() {
        return new Object[][]{
                {this.accontFromXls, this.accontPSWFromXls, "sc::maj::loc::" + this.ab_startdate + "::" + this.ab_enddate, "regular", ""},
                {this.accontFromXls, this.accontPSWFromXls, "sc::maj::loc::" + this.startdate + "::" + this.enddate, "regular", ""},
        };
    }
    ...
    public Object[][] profileEditEducationAll() {
        return new Object[][]{
                ...
                {this.accontFromXls, this.accontPSWFromXls, "12313131312::nnnn::uuurl/asdf#::Associates::A.A.S", "regular", ""},
        };
    }
    ...
    public Object[][] profileEditEducationAllDate() {
        return new Object[][]{
                {this.accontFromXls, this.accontPSWFromXls, "12313131312::nnnn::uuurl/asdf#$!FS ! D# $ % ::" + this.startdate + "::" + this.enddate, "regular", ""},
                {this.accontFromXls, this.accontPSWFromXls, "abc::sample1::sample2::" + this.startdate + "::" + this.enddate, "regular", ""},
        };
    }

    @DataProvider
    public Object[][] profileEditEducationWrongDatepresent() {
        return new Object[][]{
                {this.accontFromXls, this.accontPSWFromXls, "sss::" + this.startdate + "::" + this.enddate, "regular", ""},
                {this.accontFromXls, this.accontPSWFromXls, "err::" + this.ab_startdate + "::" + this.ab_enddate, "regular", ""},
        };
    }

    @DataProvider
    public Object[][] profileEditEducationWrongDatepresent1timepresent() {
        return new Object[][]{
                {this.accontFromXls, this.accontPSWFromXls, "sss::" + this.startdate + "::" + this.enddate, "regular", ""},
                {this.accontFromXls, this.accontPSWFromXls, "err::" + this.ab_startdate + "::" + this.ab_enddate, "save error ", ""},
        };
    }

    public BasicEditProfileEducationPresent() throws FileNotFoundException {
    }
    ...
    @Test(dataProvider = "profileEditEducationWrongDateadd1present")
    public void EducationWrongDate_add1timePresent(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        ...
        try {
            ...
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.actionSeq_FillAll_WrongDate_add1timePresent, para4Action);   // 2nd para is the action sequence
            } else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.actionSeq_FillAll_WrongDate_add1timePresent, para4Action, mobileOS);      // 2nd para is the action sequence
            }
            Thread.sleep(1000);
    ...
    public void EducationWrongDate_add2timePresent(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
        date = new Date();
        ...
        try {
            BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);  // 2nd para is for os type, last para is the excepted result str
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.actionSeq_FillAll_WrongDate_add2timePresent, para4Action);   // 2nd para is the action sequence
            } else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.actionSeq_FillAll_WrongDate_add2timePresent, para4Action, mobileOS);      // 2nd para is the action sequence
            }
            Thread.sleep(1000);
            System.out.println("Here is the result for this case : " + theAction.getExeResult());
    ...
    @Test(dataProvider = "profileEditEducationWrongDateadd3present")
    public void EducationWrongDate_add3timePresent(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
        date = new Date();
        ...
        try {
            BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);  // 2nd para is for os type, last para is the excepted result str
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.actionSeq_FillAll_WrongDate_add3timePresent, para4Action);   // 2nd para is the action sequence
            } else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.actionSeq_FillAll_WrongDate_add3timePresent, para4Action, mobileOS);      // 2nd para is the action sequence
            }
            Thread.sleep(1000);
            System.out.println("Here is the result for this case : " + theAction.getExeResult());
    ...
    @Test(dataProvider = "profileEditEducationWrongDatepresent1timepresent")
    public void EduWrongDatepresent_add1timepresent(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
        date = new Date();
        ...
        try {
            ...
            BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);  // 2nd para is for os type, last para is the excepted result str
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.actionSeq_FillAll_WrongDate_present_add1timePresent, para4Action);   // 2nd para is the action sequence
            } else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.actionSeq_FillAll_WrongDate_present_add1timePresent, para4Action, mobileOS);      // 2nd para is the action sequence
            }
            Thread.sleep(1000);
            System.out.println("Here is the result for this case : " + theAction.getExeResult());
    ...
    @Test(dataProvider = "profileEditEducationWrongDatepresent")
    public void EduWrongDatepresent_add2timepresent(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
        date = new Date();
        ...
        try {
            ...
            BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);  // 2nd para is for os type, last para is the excepted result str
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.actionSeq_FillAll_WrongDate_present_add2timePresent, para4Action);   // 2nd para is the action sequence
            } else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.actionSeq_FillAll_WrongDate_present_add2timePresent, para4Action, mobileOS);      // 2nd para is the action sequence
            }
            Thread.sleep(1000);
            System.out.println("Here is the result for this case : " + theAction.getExeResult());
    ...
    @Test(dataProvider = "profileEditEducationWrongDatepresent1timepresent")
    public void EduWrongDatepresent_add3timepresent(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
        date = new Date();
        ...
        try {
            ...
            BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);  // 2nd para is for os type, last para is the excepted result str
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.actionSeq_FillAll_WrongDate_present_add3timePresent, para4Action);   // 2nd para is the action sequence
            } else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.actionSeq_FillAll_WrongDate_present_add3timePresent, para4Action, mobileOS);      // 2nd para is the action sequence
            }
            Thread.sleep(1000);
            System.out.println("Here is the result for this case : " + theAction.getExeResult());

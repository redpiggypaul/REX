 ...
 */
public class BasicEditProfileEducationDegreeName extends AppTestTemplate {
    ...
    String[] actionSeq_FillAll_DegreeNameFirst = new String[]{"login", "switch2Profile", "clearProfile", "addEducation_All_degreeNameFirst", "education_profileSaveback2Profile", "addEducation_All_degreeNameFirst_Check"};
    ...
    public Object[][] profileEditEducationAll() {
        return new Object[][]{
                {this.accontFromXls, this.accontPSWFromXls, "abc::sample1::sample2::A.D.N", "regular", ""},
                {this.accontFromXls, this.accontPSWFromXls, "ss143ds::adsf2::sam2::A.S", "regular", ""},
        };
    }

    public BasicEditProfileEducationDegreeName() throws FileNotFoundException {
    }
    ...
    public void addEducationDegreeNameFirst(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        ...
        try {
            ...
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.actionSeq_FillAll_DegreeNameFirst, para4Action);   // 2nd para is the action sequence
            } else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.actionSeq_FillAll_DegreeNameFirst, para4Action, mobileOS);     // 2nd para is the action sequence
            }
            Thread.sleep(1000);

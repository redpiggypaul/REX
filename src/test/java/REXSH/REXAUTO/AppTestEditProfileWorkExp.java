 ...
 */
public class AppTestEditProfileWorkExp extends AppTestTemplate {
    ...
    profileEditWorkWrongDate() {
        return new Object[][]{
                {this.accontFromXls, this.accontPSWFromXls, "com::maj::loc::" + this.ab_startdate + "::" + this.ab_enddate + "::desc", "step savebtn error page profileedit", "" },
                {this.accontFromXls, this.accontPSWFromXls, "com::maj::loc::" + this.startdate + "::" + this.enddate + "::desc", "regular", "" },

        };
    }

    public AppTestEditProfileWorkExp() throws FileNotFoundException {
    }

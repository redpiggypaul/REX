 ...
 */
public class BasicEditProfileProAffiliationPresent extends AppTestTemplate {
    ...
    String[] actionSeq_All_WrongDate_present = new String[]{"login", "switch2Profile", "clearProfile", "addProAffiliation_FillAll_WrongDate_Present", "proAffiliation_profileSaveback2Profile", "addProAffiliation_FillAll_WrongDate_Present_Check"};

    String[] actionSeq_All_WrongDate_presentadd1 = new String[]{"login", "switch2Profile", "clearProfile", "addProAffiliation_FillAll_WrongDate_Present", "addProAff_1time_Present", "proAffiliation_profileSaveback2Profile", "addProAffiliation_FillAll_WrongDate_Present_Check"};
    String[] actionSeq_All_WrongDate_presentadd2 = new String[]{"login", "switch2Profile", "clearProfile", "addProAffiliation_FillAll_WrongDate_Present", "addProAff_2time_Present", "proAffiliation_profileSaveback2Profile", "addProAffiliation_FillAll_WrongDate_Present_Check"};
    String[] actionSeq_All_WrongDate_presentadd3 = new String[]{"login", "switch2Profile", "clearProfile", "addProAffiliation_FillAll_WrongDate_Present", "addProAff_3time_Present", "proAffiliation_profileSaveback2Profile", "addProAffiliation_FillAll_WrongDate_Present_Check"};

    @DataProvider
    public Object[][]
    profileEditProAWrongDate() {
        return new Object[][]{
                {this.accontFromXls, this.accontPSWFromXls, "name::info::" + this.ab_startdate + "::" + this.ab_enddate, "save error", ""},
    ...
    @DataProvider
    public Object[][]
    profileEditProAWrongDate_present() {
        return new Object[][]{
                {this.accontFromXls, this.accontPSWFromXls, "name::info::" + this.ab_startdate + "::" + this.ab_enddate, "regular", ""},
                {this.accontFromXls, this.accontPSWFromXls, "name::info::" + this.startdate + "::" + this.enddate, "regular", ""},
    ...
    public BasicEditProfileProAffiliationPresent() throws FileNotFoundException {
    }
    ...
    @Test(dataProvider = "profileEditProAWrongDate_present")
    public void addProAffiliation_wrongDate_present(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
    ...
    public void addProAffiliation_wrongDate_presentadd1(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
        ...
        try {
            ...
            //    BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);  // 2nd para is for os type, last para is the excepted result str
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.actionSeq_All_WrongDate_presentadd1, para4Action);   // 2nd para is the action sequence
            } else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.actionSeq_All_WrongDate_presentadd1, para4Action, mobileOS);    // 2nd para is the action sequence
            }
            ;
            Thread.sleep(2000);
            System.out.println("Here is the result for this case : " + theAction.getExeResult());
    ...
    @Test(dataProvider = "profileEditProAWrongDate_present")
    public void addProAffiliation_wrongDate_presentadd2(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
        ...
        try {
            ...
            //    BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);  // 2nd para is for os type, last para is the excepted result str
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.actionSeq_All_WrongDate_presentadd2, para4Action);   // 2nd para is the action sequence
            } else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.actionSeq_All_WrongDate_presentadd2, para4Action, mobileOS);    // 2nd para is the action sequence
            }
            ;
            Thread.sleep(2000);
            System.out.println("Here is the result for this case : " + theAction.getExeResult());
    ...
    @Test(dataProvider = "profileEditProAWrongDate")
    public void addProAffiliation_wrongDate_presentadd3(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
        ...
        try {
            ...
            //    BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);  // 2nd para is for os type, last para is the excepted result str
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.actionSeq_All_WrongDate_presentadd3, para4Action);   // 2nd para is the action sequence
            } else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.actionSeq_All_WrongDate_presentadd3, para4Action, mobileOS);    // 2nd para is the action sequence
            }
            ;
            Thread.sleep(2000);
            System.out.println("Here is the result for this case : " + theAction.getExeResult());

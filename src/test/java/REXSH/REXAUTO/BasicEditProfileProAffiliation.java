 ...
 */
public class BasicEditProfileProAffiliation extends AppTestTemplate {
    ...
    public BasicEditProfileProAffiliation() throws FileNotFoundException {
    }
    ...
    public void addProAffiliationWrongDate(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;

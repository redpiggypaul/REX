 ...
 */
public class BasicIOSAccountChangePSW extends AppTestTemplate {
    ...
    public BasicIOSAccountChangePSW() throws FileNotFoundException {
    }
    @DataProvider
    public  Object[][] logout() {
        return new Object[][]{
                {this.accontFromXls, "Pwcwelcome1", "", "regular", ""},
        };
    }

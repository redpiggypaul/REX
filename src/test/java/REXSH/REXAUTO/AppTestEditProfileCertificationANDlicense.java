 ...
 */
public class AppTestEditProfileCertificationANDlicense extends AppTestTemplate {
    ...
    String[] actionSeq_OnlyName = new String[]{"login",
            "switch2Profile",
            "clearProfile",
            "addCertificationsOnly_Name", "certification_profileSaveback2Profile", "addCertificationsOnly_Name_Check"};
    String[] actionSeq_OnlyID = new String[]{"login", "switch2Profile", "clearProfile", "addCertificationsOnly_ID", "certification_profileSaveback2Profile", "addCertificationsOnly_ID_Check"};
    String[] actionSeq_FocusName = new String[]{"login", "switch2Profile", "clearProfile", "addCertificationsFocus_Name", "certification_profileSaveback2Profile", "addCertificationsFocus_Name_Check"};
    String[] actionSeq_FocusID = new String[]{"login", "switch2Profile", "clearProfile", "addCertificationsFocus_ID", "certification_profileSaveback2Profile", "addCertificationsFocus_ID_Check"};
    String[] actionSeq_All_FocusName = new String[]{"login", "switch2Profile", "clearProfile", "addCertifications_CheckAll_Focus_Name", "certification_profileSaveback2Profile", "addCertifications_CheckAll_Focus_Name_Check"};
    String[] actionSeq_All_FocusID = new String[]{"login", "switch2Profile", "clearProfile", "addCertifications_CheckAll_Focus_ID", "certification_profileSaveback2Profile", "addCertifications_CheckAll_Focus_ID_Check"};

    @DataProvider
    public Object[][] profileEditCertification() {
        return new Object[][]{
    ...
    @DataProvider
    public Object[][] profileEditCertificationAll() {
        return new Object[][]{
                {this.accontFromXls, this.accontPSWFromXls, "abc::or", "regular", ""},
                {this.accontFromXls, this.accontPSWFromXls, "12313131312::uSD#$%", "regular", ""},

        };
    }

    @DataProvider
    public Object[][] profileEditCertificationAllsearch() {
        return new Object[][]{
                {this.accontFromXls, this.accontPSWFromXls, "java::asd", "regular", ""},
                {this.accontFromXls, this.accontPSWFromXls, "12313131312::uSD#$%", "regular", ""},

        };
    }

    public AppTestEditProfileCertificationANDlicense() throws FileNotFoundException {
    }
    ...
    @Test(dataProvider = "profileEditCertification")
    public void addCertificationOnlyName(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
    ...
    @Test(dataProvider = "profileEditCertification")
    public void addCertificationOnlyID(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
        ...
        try {
            //  BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);
            //   theAction.comOperationInAND(driver, actionSeq_OnlyID, para4Action);
            BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);  // 2nd para is for os type, last para is the excepted result str
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.actionSeq_OnlyID, para4Action);   // 2nd para is the action sequence
            }else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.actionSeq_OnlyID, para4Action, mobileOS);     // 2nd para is the action sequence
            }
            Thread.sleep(1000);
            System.out.println("Here is the result for this case : " + theAction.getExeResult());
    ...
    @Test(dataProvider = "profileEditCertification")
    public void addCertificationFocusName(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
    ...
    @Test(dataProvider = "profileEditCertification")
    public void addCertificationFocusID(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
        date = new Date();
        ...
        try {
            //   BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);
            //   theAction.comOperationInAND(driver, actionSeq_FocusID, para4Action);
            BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);  // 2nd para is for os type, last para is the excepted result str
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.actionSeq_FocusID, para4Action);   // 2nd para is the action sequence
            }else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.actionSeq_FocusID, para4Action, mobileOS);    // 2nd para is the action sequence
            }
            Thread.sleep(1000);
            System.out.println("Here is the result for this case : " + theAction.getExeResult());
    ...
    @Test(dataProvider = "profileEditCertificationAllsearch")
    public void addCertificationAllFocusName(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
        date = new Date();
    ...
    @Test(dataProvider = "profileEditCertificationAll")
    public void addCertificationAllFocusID(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
        date = new Date();
        ...
        try {
            //   BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);
            //    theAction.comOperationInAND(driver, actionSeq_All_FocusID, para4Action);
            BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);  // 2nd para is for os type, last para is the excepted result str
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.actionSeq_All_FocusID, para4Action);   // 2nd para is the action sequence
            }else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.actionSeq_All_FocusID, para4Action, mobileOS);     // 2nd para is the action sequence
            }
            Thread.sleep(1000);
            System.out.println("Here is the result for this case : " + theAction.getExeResult());

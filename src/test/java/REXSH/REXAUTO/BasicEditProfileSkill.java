 ...
 */
public class BasicEditProfileSkill extends AppTestTemplate {
    ...
    String[] actionSeq_Sample = new String[]{"login", "switch2Profile", "clearProfile", "addSkillOnly", "skill_profileSaveback2Profile", "addSkillOnly_Check"};

    @DataProvider
    public Object[][] profileEditSkill() {
        return new Object[][]{
                {this.accontFromXls, this.accontPSWFromXls, "JAVA", "regular", ""},
                {this.accontFromXls, this.accontPSWFromXls, "C++", "regular", ""},
        };
    }


    public BasicEditProfileSkill() throws FileNotFoundException {
    }

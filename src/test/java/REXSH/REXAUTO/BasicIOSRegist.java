 ...
 */
public class BasicIOSRegist extends AppTestTemplate {
    ...
    String rowTStr = String.valueOf(currentTimeSt);
    String shortTStr = rowTStr.substring(rowTStr.length() - 4, rowTStr.length());
    String shortTStr2 = shortTStr + "1";
    String shortTStr3 = shortTStr + "0";
    String[] TestStepList_Account_logout = new String[]{"login", "homeLogout"};
    String[] TestStepList_Normal_Regist = new String[]{"IOSregist", "IOSregistConfirm"};
    String[] TestStepList_Normal_PWCRegist = new String[]{"IOSregInfo", "IOSregistPWC", "IOSregistConfirm"};

    String[] TestStepList_Normal_Regist_CheckNotice = new String[]{"IOSregist4notice", "IOSregistConfirmNotice"};



    public BasicIOSRegist() throws FileNotFoundException {
    }
    ...
    @DataProvider
    public Object[][] normalRegist_notice() {
        return new Object[][]{
                {"firstn" + shortTStr3 + "::lastn" + shortTStr3 + "::email" + shortTStr3 + "@good.com::Pwcwelcome1::Pwcwelcome1", "regular", "Don’t see the email?::Check your spam folder or resend after 5 minutes."},
        };
    }

    @DataProvider
    public Object[][] normalRegist() {
        return new Object[][]{
                {"firstn" + shortTStr + "::lastn" + shortTStr + "::email" + shortTStr + "@good.com::Pwcwelcome1::Pwcwelcome1", "regular", ""},
        };
    }

    @DataProvider
    public Object[][] PWCRegist() {
        return new Object[][]{
                {"firstn" + shortTStr2 + "::lastn" + shortTStr2 + "::email" + shortTStr2 + "@good.com::Pwcwelcome1::Pwcwelcome1::Yes::mFirstN::mLastN::Tax", "regular", ""},
        };
    }
    ...
    public void accountLogout(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        ...
        try {
            ...
            if (mobileOS.equalsIgnoreCase("Android")) {
                ...
                theAction.comOperationInIOS((IOSDriver) driver, this.TestStepList_Account_logout, para4Action, mobileOS);    // 2nd para is the action sequence
            }
            Thread.sleep(2000);
    ...
    @Test(dataProvider = "normalRegist", dependsOnMethods = {"accountLogout"})
    public void normalRegist(String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
        ...
        String[] para4Action = preapareActionParameter(extPara);  // for action
        String cMethodPath = this.cPath + File.separator + nameOfMethod + "_" + preRoleName + "_" + time.replaceAll(":", "_"); // for screen
        list4result.add(nameOfMethod + "#" + time + "#" + preRoleName + "#" + targetResult + "#" + "JustStart" + "#" + "waiting4result");
        try {
            ...
            BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);  // 2nd para is for os type, last para is the excepted result str
            if (mobileOS.equalsIgnoreCase("Android")) {
                throw new REXException("This method is ONLY for IOS"); // 2nd para is the action sequence
            } else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.TestStepList_Normal_Regist, para4Action, mobileOS);     // 2nd para is the action sequence
            }
            Thread.sleep(2000);
            System.out.println("Here is the result for this case : " + theAction.getExeResult());
    ...
    @Test(dataProvider = "normalRegist_notice", dependsOnMethods = {"normalRegist"})
    public void normalRegist_notice(String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
        ...
        try {
            ...
            if (mobileOS.equalsIgnoreCase("Android")) {
                ...
                theAction.comOperationInIOS((IOSDriver) driver, this.TestStepList_Normal_Regist_CheckNotice, para4Action, mobileOS);     // 2nd para is the action sequence
            }
            Thread.sleep(2000);
            System.out.println("Here is the result for this case : " + theAction.getExeResult());
    ...
    @Test(dataProvider = "PWCRegist", dependsOnMethods = {"normalRegist"})
    public void PWCRegist(String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
        ...
        try {
            ...
            if (mobileOS.equalsIgnoreCase("Android")) {
                ...
                theAction.comOperationInIOS((IOSDriver) driver, this.TestStepList_Normal_PWCRegist, para4Action, mobileOS);     // 2nd para is the action sequence
            }
            Thread.sleep(2000);
            System.out.println("Here is the result for this case : " + theAction.getExeResult());

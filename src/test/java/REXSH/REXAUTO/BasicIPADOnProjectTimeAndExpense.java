 ...
 */
public class BasicIPADOnProjectTimeAndExpense extends AppTestTemplate {
    ...
    String[] TestStepList_addMoreExpense = new String[]{"login", "ipadAddMoreExpense", "ipadAddExpense", "ipadAddTaxiExpenseEntry", "ipadExpenseEntry_Check"};
    ...
    public Object[][] addTime() {
        return new Object[][]{
                {this.accontFromXls, this.accontPSWFromXls, "SUN::3.5::SUN", "regular", ""},
                {this.accontFromXls, this.accontPSWFromXls, "006::205::SUN::1.5::SUN", "regular", ""},
        };
    }

    @DataProvider
    public Object[][] addTaxiExpense() {
        return new Object[][]{
                {this.accontFromXls, this.accontPSWFromXls, "00883939001::task FOR OT IN REX::purpose 4 a::Taxi::description::67", "regular", ""}, //purpose 4 a::task FOR OT IN REX::Meals::description::67
                {this.accontFromXls, this.accontPSWFromXls, "00883939001::task FOR OT IN REX::purpose 4 a::Meals::description::17", "regular", ""}, //purpose 4 a::task FOR OT IN REX::Meals::description::67
                {this.accontFromXls, this.accontPSWFromXls, "00883939001::task FOR OT IN REX::purpose 4 a::Airfare::description::17", "regular", ""},
                {this.accontFromXls, this.accontPSWFromXls, "00883939001::task FOR OT IN REX::purpose 4 a::Car Rental::description::17", "regular", ""},
                {this.accontFromXls, this.accontPSWFromXls, "00883939001::task FOR OT IN REX::purpose 4 a::Rail::description::17", "regular", ""},
                {this.accontFromXls, this.accontPSWFromXls, "00883939001::task FOR OT IN REX::purpose 4 a::Per Diem::description::17", "regular", ""},
                {this.accontFromXls, this.accontPSWFromXls, "00883939001::task FOR OT IN REX::purpose 4 a::Other::description::17", "regular", ""},
                {this.accontFromXls, this.accontPSWFromXls, "00883939001::task FOR OT IN REX::purpose 4 a::Mileage::description::17", "regular", ""},
                {this.accontFromXls, this.accontPSWFromXls, "00883939001::task FOR OT IN REX::purpose 4 a::Lodging::description::17", "regular", ""},
        };
    }
    ...
    public Object[][] createFirstExpense() {
        return new Object[][]{
                {this.accontFromXls, this.accontPSWFromXls, "006::purpose123asd::task342043::TAXI::description::341", "regular", ""},
        };
    }

    public BasicIPADOnProjectTimeAndExpense() throws FileNotFoundException {
    }
    ...
    @Test(dataProvider = "addTaxiExpense") // , dependsOnMethods = { "addFirstExpense" }) //, alwaysRun = true)
    public void addTaxiExpense(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOFmethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
  ...
  // 2nd para is the action sequence
            } else if (mobileOS.toLowerCase().startsWith("ios")) {

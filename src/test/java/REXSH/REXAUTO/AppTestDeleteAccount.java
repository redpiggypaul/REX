 ...
 */
public class AppTestDeleteAccount extends AppTestTemplate {
    ...
    String[] TestStepList_Account_del_with_reason = new String[]{"login", "switch2AccountSetting", "delAccountWithReason"};

    String[] TestStepList_Account_del_with_platform = new String[]{"login", "switch2AccountSetting", "delAccountOtherPlatform"};

    public AppTestDeleteAccount() throws FileNotFoundException {
    }
    ...
    @DataProvider
    public Object[][] accountDELWithReason() {
        return new Object[][]{
                {this.accontFromXls, this.accontPSWFromXls, "the platform is hard to use", "regular", ""},
        };
    }

    @DataProvider
    public Object[][] accountDELWithPlatform() {
        return new Object[][]{
                {this.accontFromXls, this.accontPSWFromXls, "Aquent", "regular", ""},
                //         {this.accontFromXls, this.accontPSWFromXls, "BTG", "regular", ""},
                //        {this.accontFromXls, this.accontPSWFromXls, "Freelancers Union", "regular", ""},
                //        {this.accontFromXls, this.accontPSWFromXls, "Freelancer", "regular", ""},
                //        {this.accontFromXls, this.accontPSWFromXls, "Indeed", "regular", ""},
                //       {this.accontFromXls, this.accontPSWFromXls, "LinkedIn", "regular", ""},
                //      {this.accontFromXls, this.accontPSWFromXls, "Monster", "regular", ""},
                //     {this.accontFromXls, this.accontPSWFromXls, "Upwork", "regular", ""},
    ...
    @Test(dataProvider = "accountDELWithReason")
    public void accountDELwithReason(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
        date = new Date();
        ...
        try {
            BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);  // 2nd para is for os type, last para is the excepted result str
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.TestStepList_Account_del_with_reason, para4Action);   // 2nd para is the action sequence
            } else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.iosTestStepList_Account_del, para4Action, mobileOS);     // 2nd para is the action sequence
            }
            Thread.sleep(2000);
    ...
    //      TestStepList_Account_del_with_platform
    @Test(dataProvider = "accountDELWithPlatform")
    public void accountDELwithPlatform(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
        date = new Date();
        ...
        try {
            BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);  // 2nd para is for os type, last para is the excepted result str
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.TestStepList_Account_del_with_platform, para4Action);   // 2nd para is the action sequence
            } else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.TestStepList_Account_del_with_platform, para4Action, mobileOS);     // 2nd para is the action sequence
            }
            Thread.sleep(2000);
            System.out.println("Here is the result for this case : " + theAction.getExeResult());

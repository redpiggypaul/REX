 ...
 */
public class AppTestPreference extends AppTestTemplate {
    ...
    String[] testStepList_checkView = new String[]{"login", "switch2Profile", "ReferencePageCheck"};
    String[] testStepList_checkView2 = new String[]{"login", "switch2Profile", "ReferencePageCheck_2"};
    ...
    String[] testStepList_travel = new String[]{"login", "switch2Profile", "editPreferencecOnly_TravelAmount", "preference_profileSaveback2Profile", "editPreferencecOnly_TravelAmount_Check"};
    String[] testStepList_location = new String[]{"login", "switch2Profile", "editPreferencecOnly_Location", "preference_profileSaveback2Profile", "editPreferencecOnly_Location_Check"};


    @DataProvider
    public Object[][] preferenceOTno() {
        return new Object[][]{
                {this.accontFromXls, this.accontPSWFromXls, "no", "regular", "I am not willing to work more than a standard 40 hour work week."},
        };
    }

    @DataProvider
    public Object[][] preferenceOTyes() {
        return new Object[][]{
                {this.accontFromXls, this.accontPSWFromXls, "yes", "regular", "I am willing to work more than a standard 40 hour work week."},
        };
    }

    @DataProvider
    public Object[][] preferenceTravel() {
        return new Object[][]{
                {this.accontFromXls, this.accontPSWFromXls, "20", "regular", ""},
        };
    }

    @DataProvider
    public Object[][] preferenceLocation() {
        return new Object[][]{
                {this.accontFromXls, this.accontPSWFromXls, "new york::12345::D.C", "regular", ""},
        };
    }

    @DataProvider
    public Object[][] preferencePageCheck() {
        return new Object[][]{
                {this.accontFromXls, this.accontPSWFromXls, "", "regular",
                        "contact methods;" +
                                "Please let us know a few ways to contact you. The more you provide the more options we'll have to communicate smoothly during roles.;" +
                                "email;" +
                                //  "phone;"+
                                "skype;" +
                                "wechat;" +
                                "whatsapp;" +
                                "Let us know your bill rate.;" +
                                "USD Per Hour;"  // +
                        //   "working hours;"+
                        //  "Are you willing to work more than a standard 40 hour work week?;"
    ...
    @DataProvider
    public Object[][] preferencePageCheck2() {
        return new Object[][]{
                {this.accontFromXls, this.accontPSWFromXls, "", "regular",
                        "working hours;" +
                                "Are you willing to work more than a standard 40 hour work week?;" +
    ...
    public AppTestPreference() throws FileNotFoundException {
    }
    ...
    @Test(dataProvider = "preferenceOTno")
    public void preferenceOTno(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        ...
        try {
            ...
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.testStepList_OT, para4Action);   // 2nd para is the action sequence
            } else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.testStepList_OT, para4Action, mobileOS);    // 2nd para is the action sequence
            }
            Thread.sleep(1000);
    ...
    @Test(dataProvider = "preferenceOTyes")
    public void preferenceOTyes(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
        date = new Date();
    ...
    @Test(dataProvider = "preferenceTravel")
    public void preferenceTravel(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
        date = new Date();
        ...
        try {
            BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);  // 2nd para is for os type, last para is the excepted result str
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.testStepList_travel, para4Action);   // 2nd para is the action sequence
            } else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.testStepList_travel, para4Action, mobileOS);    // 2nd para is the action sequence
            }
            Thread.sleep(1000);
            System.out.println("Here is the result for this case : " + theAction.getExeResult());
   ...
   // @Test(dataProvider = "preferenceLocation")
    public void preferenceLocation(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
        date = new Date();
        ...
        try {
            BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);  // 2nd para is for os type, last para is the excepted result str
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.testStepList_location, para4Action);   // 2nd para is the action sequence
            } else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.testStepList_location, para4Action, mobileOS);     // 2nd para is the action sequence
            }
            Thread.sleep(1000);
            System.out.println("Here is the result for this case : " + theAction.getExeResult());
            date = new Date();
    ...
    @Test(dataProvider = "preferencePageCheck")
    public void preferencePagecheck(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
        date = new Date();
        ...
        try {
            BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);  // 2nd para is for os type, last para is the excepted result str
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.testStepList_checkView, para4Action);   // 2nd para is the action sequence
            } else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.testStepList_checkView, para4Action, mobileOS);     // 2nd para is the action sequence
            }
            Thread.sleep(1000);
            System.out.println("Here is the result for this case : " + theAction.getExeResult());
            date = new Date();
    ...
    @Test(dataProvider = "preferencePageCheck2")
    public void preferencePagecheck2(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
        date = new Date();
        ...
        try {
            BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);  // 2nd para is for os type, last para is the excepted result str
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.testStepList_checkView2, para4Action);   // 2nd para is the action sequence
            } else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.testStepList_checkView2, para4Action, mobileOS);     // 2nd para is the action sequence
            }
            Thread.sleep(1000);
            System.out.println("Here is the result for this case : " + theAction.getExeResult());
            date = new Date();

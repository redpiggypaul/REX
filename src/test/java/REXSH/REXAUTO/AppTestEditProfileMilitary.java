 ...
 */
public class AppTestEditProfileMilitary extends AppTestTemplate {
    ...
    String[] actionSeq_Only_Rank = new String[]{"login", "switch2Profile", "clearProfile", "addMilitaryOnly_Rank", "military_profileSaveback2Profile", "addMilitaryOnly_Rank_Check"};
    String[] actionSeq_All_Focus_Rank = new String[]{"login", "switch2Profile", "clearProfile", "addMilitaryService_CheckAll_Focus_Rank", "military_profileSaveback2Profile", "addMilitaryService_CheckAll_Focus_Rank_Check"};
    String[] actionSeq_All_withdate = new String[]{"login", "switch2Profile", "clearProfile", "addMilitaryService_CheckAll_withDate", "military_profileSaveback2Profile", "addMilitaryService_CheckAll_Focus_Rank_Check"};
    String[] actionSeq_All_wrongDate = new String[]{"login", "switch2Profile", "clearProfile", "addMilitaryService_CheckAll_wrongDate", "military_profileSaveback2Profile", "addMilitaryService_CheckAll_Focus_Rank_Check"};
    String[] actionSeq_All_wrongDate_Present = new String[]{"login", "switch2Profile", "clearProfile", "addMilitaryService_CheckAll_wrongDate_present", "military_profileSaveback2Profile", "addMilitaryService_CheckAll_Focus_Rank_Check"};

    @DataProvider
    public Object[][] profileMilitary() {
        return new Object[][]{
                {this.accontFromXls, this.accontPSWFromXls, "cap::Navy", "regular", ""},

        };
    }

    @DataProvider
    public Object[][] profileMilitaryAll() {
        return new Object[][]{
                {this.accontFromXls, this.accontPSWFromXls, "lut::Army", "regular", ""},

        };
    }


    public AppTestEditProfileMilitary() throws FileNotFoundException {
    }
    ...
    @Test(dataProvider = "profileMilitary")
    public void addMilitaryOnlyRank(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        ...
        if (extPara.length != 0) {
            if (extPara[extPara.length - 1].length() > 10) {//如果长度大于10则截取
                ...
                preRoleName = super.filter4space(preRoleName);
            } else {
                preRoleName = extPara[extPara.length - 1];
            }
        }
        String[] para4Action = super.preapareActionParameter(new String[]{theUserPara, thePSW}, extPara);  // for action
        ...
        try {
            ...
            //  theAction.comOperationInAND(driver, actionSeq_Only_Rank, para4Action);
            ...
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.actionSeq_Only_Rank, para4Action);   // 2nd para is the action sequence
            }else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.actionSeq_Only_Rank, para4Action, mobileOS);    // 2nd para is the action sequence
            }
            Thread.sleep(2000);
            ...
            date = new Date();
            time = format.format(date);
            boolean boolean4assert = super.assertTestResult(theAction.getExeResult().toString(), targetResult); // for judge
    ...
    @Test(dataProvider = "profileMilitary")
    public void addMilitaryAllFocusRank(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
        ...
        try {
            //  BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);
            //  theAction.comOperationInAND(driver, actionSeq_All_Focus_Rank, para4Action);
            BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);  // 2nd para is for os type, last para is the excepted result str
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.actionSeq_All_Focus_Rank, para4Action);   // 2nd para is the action sequence
            }else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.actionSeq_All_Focus_Rank, para4Action, mobileOS);     // 2nd para is the action sequence
            }
            Thread.sleep(2000);
            System.out.println("Here is the result for this case : " + theAction.getExeResult());
    ...
    @Test(dataProvider = "profileMilitaryDate")
    public void addMilitaryAll_withDate(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
        ...
        try {
            ...
            BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);  // 2nd para is for os type, last para is the excepted result str
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.actionSeq_All_withdate, para4Action);   // 2nd para is the action sequence
            }else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.actionSeq_All_withdate, para4Action, mobileOS);     // 2nd para is the action sequence
            }
            Thread.sleep(2000);
            System.out.println("Here is the result for this case : " + theAction.getExeResult());
    ...
    //@Test(dataProvider = "profileMilitaryWrongDate")
    public void addMilitaryAll_wrongDate(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
    ...
    //@Test(dataProvider = "profileMilitaryWrongDate_Present")
    public void addMilitaryAll_wrongDate_Present(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
        ...
        try {
            ...
            BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);  // 2nd para is for os type, last para is the excepted result str
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.actionSeq_All_wrongDate_Present, para4Action);   // 2nd para is the action sequence
            }else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.actionSeq_All_wrongDate_Present, para4Action, mobileOS);     // 2nd para is the action sequence
            }
            Thread.sleep(2000);
            System.out.println("Here is the result for this case : " + theAction.getExeResult());

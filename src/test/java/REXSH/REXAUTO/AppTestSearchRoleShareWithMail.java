 ...
 */
public class AppTestSearchRoleShareWithMail extends AppTestTemplate {
    ...
    String tomorrow = readProperity.getProValue(this.getClass().getSimpleName() + "tomorrow");
    ...
    String[] TestStepList_RoleFilter_sendInterest = new String[]{"login", "switch2SearchRole", "Role_Share_Mail"};

    String[] TestStepList_checkContent = new String[]{"login", "switch2SearchRole", "Role_Share_Mail_CheckContent"};
    String[] TestStepList_checkEditable = new String[]{"login", "switch2SearchRole", "Role_Share_Mail_setvalue"};
    String[] TestStepList_checkSubject = new String[]{"login", "switch2SearchRole", "Role_Share_Mail_subject"};
    String[] TestStepList_checkReadOnly_From = new String[]{"login", "switch2SearchRole", "Role_Share_Mail_from"};


    @DataProvider
    public Object[][] searchRoleSendInterest() {
        return new Object[][]{
                {this.accontFromXls, this.accontPSWFromXls, "target@themail.com", "regular", ""},
        };
    }
    ...
    public Object[][] checkContent() {
        return new Object[][]{
                {this.accontFromXls, this.accontPSWFromXls, "", "regular", "Check out this role on PwC's Talent Exchange::I came across this role on PwC's Talent Exchange and thought of you. The Talent Exchange is a marketplace that connects independent talent with exciting opportunities at PwC."},
        };
    }
    ...
    public Object[][] setValue() {
        return new Object[][]{
                {this.accontFromXls, this.accontPSWFromXls, "target@themail.com::Please input your comments", "regular", ""},
        };
    }

    @DataProvider
    public Object[][] setSubject() {
        return new Object[][]{
                {this.accontFromXls, this.accontPSWFromXls, "target@themail.com::new subject", "regular", ""},
        };
    }

    @DataProvider
    public Object[][] checkFrom() {
        return new Object[][]{
                {this.accontFromXls, this.accontPSWFromXls, "target@themail.com", "regular", this.accontFromXls},
        };
    }

    public AppTestSearchRoleShareWithMail() throws FileNotFoundException {
    }
    ...
    @Test(dataProvider = "searchRoleSendInterest")
    public void searchRoleSendInterest(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        ...
        try {
            ...
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.TestStepList_RoleFilter_sendInterest, para4Action);   // 2nd para is the action sequence
            } else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.TestStepList_RoleFilter_sendInterest, para4Action, mobileOS);     // 2nd para is the action sequence
            }
            Thread.sleep(1000);
    ...
    @Test(dataProvider = "checkContent")
    public void checkContent(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
        date = new Date();
        ...
        try {
            BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);  // 2nd para is for os type, last para is the excepted result str
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.TestStepList_checkContent, para4Action);   // 2nd para is the action sequence
            } else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.TestStepList_checkContent, para4Action, mobileOS);     // 2nd para is the action sequence
            }
            Thread.sleep(1000);
            System.out.println("Here is the result for this case : " + theAction.getExeResult());
    ...
    public void setValue(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
        date = new Date();
        ...
        try {
            BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);  // 2nd para is for os type, last para is the excepted result str
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.TestStepList_checkEditable, para4Action);   // 2nd para is the action sequence
            } else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.TestStepList_checkEditable, para4Action, mobileOS);     // 2nd para is the action sequence
            }
            Thread.sleep(1000);
            System.out.println("Here is the result for this case : " + theAction.getExeResult());
    ...
    @Test(dataProvider = "setSubject")
    public void setSubject(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
        date = new Date();
        ...
        try {
            BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);  // 2nd para is for os type, last para is the excepted result str
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.TestStepList_checkSubject, para4Action);   // 2nd para is the action sequence
            } else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.TestStepList_checkSubject, para4Action, mobileOS);     // 2nd para is the action sequence
            }
            Thread.sleep(1000);
            System.out.println("Here is the result for this case : " + theAction.getExeResult());
    ...
    @Test(dataProvider = "checkFrom")
    public void checkFrom(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
        date = new Date();
        ...
        try {
            BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);  // 2nd para is for os type, last para is the excepted result str
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.TestStepList_checkReadOnly_From, para4Action);   // 2nd para is the action sequence
            } else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.TestStepList_checkReadOnly_From, para4Action, mobileOS);     // 2nd para is the action sequence
            }
            Thread.sleep(1000);
            System.out.println("Here is the result for this case : " + theAction.getExeResult());

 ...
 */
public class BasicEditProfileWorkExpPresent extends AppTestTemplate {
    ...
    String startdate = readProperity.getProValue("normal_startmonth");
    String enddate = readProperity.getProValue("normal_endmonth");
    String ab_startdate = readProperity.getProValue("abnormal_startmonth");
    String ab_enddate = readProperity.getProValue("abnormal_endmonth");
    ...
    String[] actionSeq_FillAll_WrongDate_presentadd1 = new String[]{"login", "switch2Profile", "clearProfile", "addWorkExp_FillAll_WrongDate_Present", "addWorkExp_1time_Present", "work_profileSaveback2Profile", "addWorkExp_FillAll_WrongDate_Present_Check"};
    String[] actionSeq_FillAll_WrongDate_presentadd2 = new String[]{"login", "switch2Profile", "clearProfile", "addWorkExp_FillAll_WrongDate_Present", "addWorkExp_2time_Present", "work_profileSaveback2Profile", "addWorkExp_FillAll_WrongDate_Present_Check"};
    String[] actionSeq_FillAll_WrongDate_presentadd3 = new String[]{"login", "switch2Profile", "clearProfile", "addWorkExp_FillAll_WrongDate_Present", "addWorkExp_3time_Present", "work_profileSaveback2Profile", "addWorkExp_FillAll_WrongDate_Present_Check"};

    @DataProvider
    public Object[][]
    profileEditWorkWrongDate_present() {
        return new Object[][]{
                {this.accontFromXls, this.accontPSWFromXls, "com::" + this.ab_startdate + "::" + this.ab_enddate, "regular", ""},
                {this.accontFromXls, this.accontPSWFromXls, "com::" + this.startdate + "::" + this.enddate, "regular", ""},
        };
    }
    ...
    @DataProvider
    public Object[][]
    profileEditWorkWrongDate_presentadd1() {
        return new Object[][]{
                {this.accontFromXls, this.accontPSWFromXls, "com::" + this.ab_startdate + "::" + this.ab_enddate, "step save error ", ""},
                {this.accontFromXls, this.accontPSWFromXls, "com::" + this.startdate + "::" + this.enddate, "regular", ""},
        };
    }

    public BasicEditProfileWorkExpPresent() throws FileNotFoundException {
    }
    ...
    public void addWorkWrongDate_present(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        ...
        try {
            ...
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.actionSeq_FillAll_WrongDate_present, para4Action);   // 2nd para is the action sequence
    ...
    @Test(dataProvider = "profileEditWorkWrongDate_presentadd1")
    public void addWorkWrongDate_presentadd1time(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
        ...
        try {
            ...
            BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);  // 2nd para is for os type, last para is the excepted result str
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.actionSeq_FillAll_WrongDate_presentadd1, para4Action);   // 2nd para is the action sequence
            } else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.actionSeq_FillAll_WrongDate_presentadd1, para4Action, mobileOS);    // 2nd para is the action sequence
            }
            Thread.sleep(2000);
            System.out.println("Here is the result for this case : " + theAction.getExeResult());
    ...
    @Test(dataProvider = "profileEditWorkWrongDate_present")
    public void addWorkWrongDate_presentadd2(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
        ...
        try {
            ...
            BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);  // 2nd para is for os type, last para is the excepted result str
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.actionSeq_FillAll_WrongDate_presentadd2, para4Action);   // 2nd para is the action sequence
            } else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.actionSeq_FillAll_WrongDate_presentadd2, para4Action, mobileOS);    // 2nd para is the action sequence
            }
            Thread.sleep(2000);
            System.out.println("Here is the result for this case : " + theAction.getExeResult());
    ...
    @Test(dataProvider = "profileEditWorkWrongDate_presentadd1")
    public void addWorkWrongDate_presentadd3time(String theUserPara, String thePSW, String paraGroup, String targetResult, String expectResult) throws Exception {
        String nameOfMethod = Thread.currentThread().getStackTrace()[1].getMethodName();
        globalRowId++;
        String result4XLSX = "Failed";
        ...
        try {
            ...
            BaseAction theAction = new BaseAction(driver, null, 1, para4Action, cMethodPath, expectResult);  // 2nd para is for os type, last para is the excepted result str
            if (mobileOS.equalsIgnoreCase("Android")) {
                theAction.comOperationInAND((AndroidDriver) driver, this.actionSeq_FillAll_WrongDate_presentadd3, para4Action);   // 2nd para is the action sequence
            } else if (mobileOS.startsWith("ios")) {
                theAction.comOperationInIOS((IOSDriver) driver, this.actionSeq_FillAll_WrongDate_presentadd3, para4Action, mobileOS);    // 2nd para is the action sequence
            }
            Thread.sleep(2000);
            System.out.println("Here is the result for this case : " + theAction.getExeResult());
